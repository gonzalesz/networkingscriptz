...
localip = "172.30.112.214"    #ที่อยู่ IP ของเซิร์ฟเวอร์ Syslog ของคุณ (สำหรับฟังก์ชัน 'Debugging')
...
def loginjumphost():
    ...
    try:
        ...
        tkMessageBox.showinfo('ข้อผิดพลาด', 'หมดเวลาการเชื่อมต่อ; ไม่สามารถเชื่อมต่อกับอุปกรณ์')
        quit()

        
    print "การเชื่อมต่อที่ประสบความสำเร็จ", jumphostip
    sleep(0.5)
...
def login():
    ...
    print "การเชื่อมต่อที่ประสบความสำเร็จ", ip
...
def defaultpage():
    ...
    Negateanyframe=LabelFrame(window,text=" ลบล้าง ",font=('verdana', 8, 'bold'),padx=30,pady=7,width=100,height=100)
    ...
    bifacemain=LabelFrame(window,text=" อินเทอร์เฟซ (จำเป็นสำหรับ * เป็นทางเลือกสำหรับ **) ",font=('verdana', 8, 'bold'),padx=122,pady=10,width=100,height=100)
    ...
    biface=LabelFrame(window,text=" การกำหนดค่าอินเตอร์เฟซ ",font=('verdana', 8, 'bold'),padx=17,pady=0,width=100,height=100)
    biface.grid(row=1,column=0, sticky=("nsew"))


    chk_state_sec = BooleanVar()
    chk_state_sec.set(False)
    chk = Checkbutton(biface, text='IP รอง', variable=chk_state_sec)
    chk.grid(column=2, row=2)

    chk_state_nosh = BooleanVar()
    chk_state_nosh.set(True)
    chk1 = Checkbutton(biface, text='เปิดใช้งาน', variable=chk_state_nosh)
    chk1.grid(column=3, row=2)




    lbl = Label(biface, text="ตั้งค่า IP และซับเน็ตมาสก์:")
    lbl.grid(column=0, row=3)
    ipaddr = Entry(biface, bg='white', width=17, fg='grey')
    ipaddr.grid(column=1, row=3)
    ipaddr.insert(0, "IP. 'del' เพื่อลบ.")
    def handle_focus_in(_):
    ...
    ipmask.insert(0, "Mask. 'del' เพื่อลบ.")
    def handle_focus_in(_):
    ...
    tundst.insert(0, "Dst IP. 'del' เพื่อลบ.")
    def handle_focus_in(_):
    ...
    def setinterfaceipclick():
        ...
        if getiface.get() == "" or getiface.get() == "e.g. fa0/0, fa0/0.2, vlan1, tun0, bvi1, po1 ..":
            tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดเลือกอินเทอร์เฟซ.')
        else:
            if ((ipaddr.get() != "" and ipaddr.get().encode('utf-8') != "IP. 'del' เพื่อลบ.") and (ipmask.get() == "" or ipmask.get().encode('utf-8') == "Mask. 'del' เพื่อลบ."))\
               or ((ipaddr.get() == "" or ipaddr.get().encode('utf-8') == "IP. 'del' เพื่อลบ.") and (ipmask.get() != "" and ipmask.get().encode('utf-8') != "Mask. 'del' เพื่อลบ.")):
                tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนทั้ง IP และซับเน็ตมาสก์เพื่อกำหนดค่า IP')
            elif chk_state_neg.get() == False and (getiface.get()[:2] == "tu") and ((tunsrc.get() != "" and tunsrc.get().encode('utf-8') != "Src IP. 'del' เพื่อลบ.") or\
                 (tundst.get() != "" and tundst.get().encode('utf-8') != "Dst IP. 'del' เพื่อลบ.")) and tunmode.get().encode("utf-8") == 'โหมด':
                tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดเลือกโหมดอุโมงค์')
            elif chk_state_neg.get() == False and (ipaddr.get() == "del" or ipmask.get() == "del" or tunsrc.get() == "del" or tundst.get() == "del"):
                tkMessageBox.showinfo('ข้อผิดพลาด', 'เลือก "ลบล้าง" เพื่อระบุ "del" สำหรับการลบที่อยู่ IP')
            else:
                if chk_state_neg.get() == False:
...
##                        pass
                    ...
                    if 'Invalid input' in stripp:
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'อินเทอร์เฟซ ' + getiface.get() + ' does not exist... การยกเลิก หาก BVI ตรวจสอบให้แน่ใจว่าได้สร้าง Bridge Group ก่อน')
                        return
                    else:
                        pass
                    
                    tuntxt = ""
                    if (getiface.get()[:2] == "tu") and ((tunsrc.get() != "" and tunsrc.get() != "Src IP. 'del' เพื่อลบ.") or\
                                                         (tundst.get() != "" and tundst.get() != "Dst IP. 'del' เพื่อลบ.")):
                        ...
                        sleep(0.3)
                        tuntxt = "กำหนดค่า IP Tunnel - อย่าลืมเพิ่มเส้นทางเพื่อผลักดันการจราจรผ่านอุโมงค์นี้ "                           
                    else:
                        pass
...
##                        if (ipaddr.get() != "" and ipaddr.get() != "IP. 'del' เพื่อลบ.") and (ipmask.get() != "" and \
##                            ipmask.get() != "Mask. 'del' เพื่อลบ."):
...
##                        pass
                    ...
                    if (ipaddr.get() != "" and ipaddr.get() != "IP. 'del' เพื่อลบ.") and (ipmask.get() != "" and \
                        ...
                        if chk_state_sec.get() == False:
                            ...
                            sleep(0.3)
                            IPtxt = "กำหนดค่า IP แล้ว "
                        else:
                            remote_conn.send(ipaddrcmd + " secondary \n")
                            sleep(0.3)
                            IPtxt = "กำหนดค่า IP รองแล้ว "
                    else:
                        pass
                    ...
                    if chk_state_nosh.get() == False:
                        ...
                        remote_conn.send("sh \n")
                        sleep(0.3)
                        Shutstatetxt = "อินเตอร์เฟซถูกปิดใช้งาน "
                    else:
                        sleep(0.3)
                        remote_conn.send("no sh \n")
                        sleep(0.3)
                        Shutstatetxt = "เปิดใช้งานอินเทอร์เฟซแล้ว "

                    sleep(0.2)    
                    remote_conn.send("exit \n")
                    sleep(0.2)
                    remote_conn.send("exit \n") 
                    tkMessageBox.showinfo('การกำหนดค่า IP', IPtxt + Shutstatetxt + tuntxt + bridgetxt)


                else:
                    if (ipaddr.get() == "" or ipaddr.get() == "IP. 'del' เพื่อลบ.") and (ipmask.get() == "" or ipmask.get() == "Mask. 'del' เพื่อลบ.") \
                       and (tunsrc.get() == "" or tunsrc.get() == "Src IP. 'del' เพื่อลบ.") and (tundst.get() == "" or tundst.get() == "Dst IP. 'del' เพื่อลบ."):
                        remote_conn.send("conf t \n")
                        sleep(0.3)
                        ...
                        remote_conn.send("exit \n")
                        sleep(0.2)
                        tkMessageBox.showinfo('การกำหนดค่า IP', 'ลบอินเทอร์เฟซแล้ว')
                    else:
                        remote_conn.send("sh ip int " + getiface.get() + " \n")
                        sleep(0.5)
                        output = remote_conn.recv(2048).decode("utf-8")
                        ...
                        sleep(0.2)
                        if 'Invalid input' in stripp:
                            tkMessageBox.showinfo('ข้อผิดพลาด', 'อินเทอร์เฟซ ' + getiface.get() + ' ไม่มีอยู่จริง ... กำลังยกเลิก')
                            return
                        else:
                            pass
                        ...
                        if (getiface.get()[:2] == "tu") and ((tunsrc.get() != "" and tunsrc.get() != "Src IP. 'del' เพื่อลบ") or\
                            ...
                            if tunsrc.get() == "del":
                                ...
                                sleep(0.3)
                                tuntxt = tuntxt + "IP ต้นทางของ Tunnel ถูกลบออก "
                            else:
                                pass
                            if tundst.get() == "del":
                                remote_conn.send("no tun dest \n")
                                sleep(0.3)
                                tuntxt = tuntxt + "IP ปลายทางของ Tunnel ถูกลบออก "
                            else:
                                pass
...
##                            pass
                        ...
                        if ipaddr.get() == "del" and ipmask.get() == "del":
                            if chk_state_sec.get() == False:
                                ...
                                IPtxt = "ลบที่อยู่ IP แล้ว "
                            else:
                                remote_conn.send("no ip addr sec \n")
                                IPtxt = "ลบที่อยู่ IP รองแล้ว "
                        elif (ipaddr.get() != "" or ipaddr.get() != "IP. 'del' เพื่อลบ.") and (ipmask.get() != "" or ipmask.get() != "Mask. 'del' เพื่อลบ."):
                            tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดใช้คีย์เวิร์ด "del" ในฟิลด์ IP และซับเน็ตมาสก์สำหรับการลบ IP')
                            sleep(0.2)   
                            remote_conn.send("exit \n")
                            sleep(0.2)   
                            remote_conn.send("exit \n")
...
##                            Shutstatetxt = "Interface is enabled. "
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n") 
                        tkMessageBox.showinfo('การกำหนดค่า IP', IPtxt + tuntxt)
            
    btn = Button(biface, text="*ใช้การ", bg="orange", command=setinterfaceipclick)
    ...
    lbl = Label(biface, text="ความเร็วและดูเพล็กซ์:").grid(column=0, row=6)
    OPTIONS = [
    "auto",        
    "10",        
    "100",
    ...
    def setspeedduplex():
        if getiface.get() == "" or getiface.get() == "e.g. fa0/0, fa0/0.2, vlan1, tun0, bvi1, po1 ..":
            ...
            tkMessageBox.showinfo('ข้อผิดพลาด', 'สามารถตั้งค่าความเร็วและดูเพล็กซ์สำหรับอินเทอร์เฟซทางกายภาพเท่านั้น')
        elif ("fa" in getiface.get() or "Fa" in getiface.get()) and spd.get() == "1000":
            tkMessageBox.showinfo('ข้อผิดพลาด', 'ความเร็วสำหรับ FastEthernet สามารถกำหนดค่าได้สูงสุด 100Mbps เท่านั้น')
        else:    
            remote_conn.send("conf t \n")
            sleep(0.5)
            remote_conn.send("int " + getiface.get() + "\n")
            ...
            if 'Invalid input' in stripp:
                sleep(0.3)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('ข้อผิดพลาด', 'อินเทอร์เฟซ ' + getiface.get() + ' ไม่มีอยู่จริง ... กำลังยกเลิก หาก BVI ตรวจสอบให้แน่ใจว่าได้สร้าง Bridge Group ก่อน')
                return
            else:
                pass
            ...
            sleep(0.5)
            remote_conn.send("exit \n")
            res = "ตั้งค่าความเร็วเป็น " + spd.get() + " และดูเพล็กซ์ " + dup.get() + " บน " + getiface.get()
            tkMessageBox.showinfo('ความเร็วและดูเพล็กซ์', res)
    btn = Button(biface, text="*ใช้การ", bg="orange", command=setspeedduplex)
    btn.grid(column=3, row=6)        

    blankdivider = Label(biface, text="").grid(column=0, row=8)
    
    lbl = Label(biface, text="การตั้งค่าอื่น ๆ:").grid(column=0, row=9)
            ...
            if chk_state_neg.get() == False:
                ...
                if otheroptn.get() == 'MAC address':
                    if otherinput.get() != "" and otherinput.get() != "xxxx.xxxx.xxxx":
                        ...
                        sleep(0.5)       
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'ที่อยู่ MAC ของอินเทอร์เฟซได้รับการกำหนดค่าแล้ว')
                    else:
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนที่อยู่ MAC เพื่อกำหนดค่าบนอินเทอร์เฟซ')
                elif otheroptn.get() == 'dot1q':
                    if "." not in getiface.get():
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'การห่อหุ้ม Dot1q สามารถใช้ได้กับซับอินเทอร์เฟซเท่านั้น')
                    elif otherinput.get() == "":
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อน VLAN ID เพื่อใช้กับอินเทอร์เฟซย่อย')
                    else:
                        sleep(0.5)
                        remote_conn.send("encap dot1Q " + otherinput.get() + "\n")
                        sleep(0.5)
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'Dot1q ได้รับการกำหนดค่าแล้ว.')
                    ...
                    output = remote_conn.recv(buff_size).decode("utf-8")
                    if otherinput.get() == "":
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อน VRF เพื่อใช้กับอินเทอร์เฟซ')
                    elif otherinput.get() not in output:
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดสร้าง VRF ก่อนจึงจะใช้งานได้')
                    else:
                        sleep(0.5)
                        remote_conn.send("ip vrf forwarding " + otherinput.get() + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'กำหนดค่า VRF หากได้สร้างไว้แล้ว')
                    ...
                    if 'tu' not in getiface.get():
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'สามารถใช้ fVRF กับอินเทอร์เฟซทันเนลเท่านั้น')
                    elif otherinput.get() == "":
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อน VRF เพื่อใช้กับอินเทอร์เฟซ')
                    elif otherinput.get() not in output:
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดสร้าง VRF ก่อนจึงจะใช้งานได้')
                    ...
                    sleep(0.5)       
                    tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'กำหนดค่าเป็นไคลเอ็นต์ DHCP ที่อยู่ IP ใด ๆ ที่มีอยู่ถูกลบออก.')
                elif otheroptn.get() == 'IP MTU(L3)':
                    if otherinput.get() != "" and otherinput.get() != "eg. 1400" and (68 <= int(otherinput.get()) <= 1500):
                        sleep(0.5)
                        remote_conn.send("ip mtu " + otherinput.get() + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'อินเตอร์เฟสแพ็คเก็ต MTU ได้รับการกำหนดค่า')
                    else:
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนค่า MTU (68-1500) เพื่อใช้กับอินเทอร์เฟซ')
                elif otheroptn.get() == 'MTU(L2)':
                    if otherinput.get() != "" and otherinput.get() != "eg. 1500" and (68 <= int(otherinput.get()) <= 1500):
                        sleep(0.5)
                        remote_conn.send("mtu " + otherinput.get() + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'กรอบอินเตอร์เฟส MTU ได้รับการกำหนดค่าแล้ว')
                    else:
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนค่า MTU (1500-1530) เพื่อใช้กับอินเทอร์เฟซ')                    
                elif otheroptn.get() == 'TCP MSS(L4)':
                    if otherinput.get() != "" and otherinput.get() != "eg. 1360" and (500 <= int(otherinput.get()) <= 1460):
                        ...
                        sleep(0.5)       
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'MSS ได้รับการกำหนดค่าแล้ว')
                    else:
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนค่า MSS (500-1460) เพื่อใช้กับอินเทอร์เฟซ')
                elif otheroptn.get() == 'VFR':
                    sleep(0.5)
                    remote_conn.send("ip virtual-reassembly \n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'เปิดใช้งาน IP Virtual Reassembly สำหรับแพ็กเก็ตที่แยกส่วน')
                elif otheroptn.get() == 'Add to bridge':
                    if otherinput.get() == "<bridge-grp no.>" or otherinput.get() == "":
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนหมายเลข Bridge Group')
                    else:
                        sleep(0.5)
                        remote_conn.send("int " + getiface.get() + " \n")
                        sleep(0.5)
                        remote_conn.send("bridge-group " + otherinput.get() + "\n")
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', getiface.get() + ' ถูกเพิ่มใน Bridge Group ' + otherinput.get())
                elif otheroptn.get() == 'tun key':
                    if getiface.get()[:2] != 'tu': 
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'คีย์ Tunnel สามารถใช้ได้กับอินเทอร์เฟซอุโมงค์เท่านั้น (เช่น tun0)')
                    elif otherinput.get() == "" or otherinput.get() == "eg. 1":
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนค่าคีย์ของช่องสัญญาณเพื่อใช้กับอินเทอร์เฟซ')
                    else:
                        remote_conn.send("tun key " + otherinput.get() + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'กำหนดค่าคีย์อุโมงค์แล้ว')                
                elif otheroptn.get() == 'keepalive':
                    if otherinput.get() == "" or otherinput.get() == "<secs> [<retries>]":
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนค่า Keepalive เพื่อใช้กับอินเทอร์เฟซ')
                    elif getiface.get()[:2] != 'tu':
                        findfirstdigits = re.search(r'\d+', otherinput.get()).group()
                        sleep(0.2)
                        remote_conn.send("keepalive " + findfirstdigits + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'กำหนดค่าอินเทอร์เฟซแบบ Keepalive')
                    else:
                        remote_conn.send("keepalive " + otherinput.get() + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'กำหนดค่าอินเทอร์เฟซ Tunnel ไว้แล้ว')
                elif otheroptn.get() == 'bandwidth':
                    if otherinput.get() == "" or otherinput.get() == "<kilobits>":
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนค่าแบนด์วิดท์เพื่อใช้กับอินเทอร์เฟซ')
                    else:
                        remote_conn.send("bandwidth " + otherinput.get() + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'กำหนดค่าแบนด์วิดท์ของอินเทอร์เฟซแล้ว')
                elif otheroptn.get() == 'IPSEC profile':
                    if getiface.get()[:2] != 'tu':
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดใช้โปรไฟล์ IPSEC กับอินเทอร์เฟซอุโมงค์ (เช่น tun0)')
                    elif otherinput.get() == "" or otherinput.get() == "<IPSec_prof_name>":
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนโปรไฟล์ IPSEC เพื่อใช้กับอินเทอร์เฟซ')
                    else:                    
                        remote_conn.send("tunnel protection ipsec profile " + otherinput.get() + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'กำหนดค่าโปรไฟล์ Tunnel IPSEC แล้ว')                    
                else:
                    remote_conn.send(otheroptn.get() + " " + otherinput.get() + "\n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'กำหนดค่าการหมดเวลาของ ARP แล้ว')
            else:
                remote_conn.send("conf t \n")
                sleep(0.5)
                remote_conn.send("int " + getiface.get() + "\n")            
                if otheroptn.get() == 'MAC address':
                    ...
                    sleep(0.5)
                    tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'รีเซ็ตที่อยู่ MAC ของอินเทอร์เฟซ')
                elif otheroptn.get() == 'dot1q':
                    if "." not in getiface.get():
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'ไม่ใช่อินเทอร์เฟซย่อย')
                    else:
                        sleep(0.5)
                        remote_conn.send("no encap dot1Q \n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'Dot1q ถูกลบออก')
                elif otheroptn.get() == 'VRF':
                    sleep(0.5)
                    remote_conn.send("no ip vrf forwarding \n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'VRF ถูกลบออก')
                elif otheroptn.get() == 'DHCP Client':
                    sleep(0.5)
                    remote_conn.send("no ip addr dhcp \n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'กำหนดค่าเป็นไคลเอ็นต์ DHCP')
                elif otheroptn.get() == 'IP MTU(L3)':
                    sleep(0.5)
                    remote_conn.send("no ip mtu \n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'อินเทอร์เฟซแพ็คเก็ต MTU ถูกรีเซ็ตเป็นค่าสูงสุดเริ่มต้น (1500B)')
                elif otheroptn.get() == 'MTU(L2)':
                    sleep(0.5)
                    remote_conn.send("no mtu \n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'เฟรมอินเตอร์เฟส MTU ถูกรีเซ็ตเป็นค่าสูงสุดเริ่มต้น (1500B)')                
                elif otheroptn.get() == 'TCP MSS(L4)':
                    sleep(0.5)
                    remote_conn.send("no ip tcp adjust-mss \n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'อินเทอร์เฟซ MSS ถูกรีเซ็ตเป็นค่าสูงสุดเริ่มต้น (1460B)')
                elif otheroptn.get() == 'VFR':
                    sleep(0.5)
                    remote_conn.send("no ip virtual-reassembly \n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'IP Virtual Reassembly สำหรับแพ็กเก็ตที่แยกส่วนถูกปิดใช้งาน')
                elif otheroptn.get() == 'Add to bridge':
                    sleep(0.5)
                    remote_conn.send("no bridge-group " + otherinput.get() + "\n")
                    tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', getiface.get() + ' ถูกลบออกจาก Bridge Group ' + otherinput.get())
                elif otheroptn.get() == 'tun key':
                    if getiface.get()[:2] != 'tu': 
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'ไม่ใช่อินเทอร์เฟซอุโมงค์')
                    else:
                        remote_conn.send("no tun key \n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'ลบคีย์อุโมงค์แล้ว')                
                    ...
                    if getiface.get()[:2] != 'tu':
                        ...
                        sleep(0.5)       
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'ของที่ระลึกในอุโมงค์ถูกลบออก')
                elif otheroptn.get() == 'bandwidth':
                        sleep(0.5)
                        remote_conn.send("no bandwidth \n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'รีเซ็ตแบนด์วิดท์ของอินเทอร์เฟซแล้ว')
                elif otheroptn.get() == 'IPSEC profile':
                    if getiface.get()[:2] != 'tu':
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดระบุอินเทอร์เฟซอุโมงค์ (เช่น tun0)')
                    elif otherinput.get() == "":
                        tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนโปรไฟล์ IPSEC เพื่อลบออกจากอินเทอร์เฟซ')
                    else:                    
                        remote_conn.send("no tunnel protection ipsec profile " + otherinput.get() + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'นำโปรไฟล์ Tunnel IPSEC ออก') 
                else:
                    sleep(0.5)
                    remote_conn.send("no " + otheroptn.get() + " " + otherinput.get() + "\n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('การตั้งค่าอินเทอร์เฟซอื่น ๆ', 'การหมดเวลาของ ARP ถูกรีเซ็ตเป็นค่าเริ่มต้น (4 ชั่วโมง)')
            remote_conn.send("exit \n")
            sleep(0.5)
            remote_conn.send("exit \n")                
    btn = Button(biface, text="*ใช้การ", bg="orange", command=setotherconf)
    ...
    def helpotherconf():
        res = 'VFR (Virtual Fragmentation Reassembly) - สามารถ' +\
              ' ตรวจจับและป้องกันการโจมตีแบบแยกส่วนได้ \n\nDot1q - การห่อหุ้มที่ใช้สำหรับ Trunking, Router on a Stick เป็นต้น' +\
              ' ค่าที่ถูกต้อง: 1-4094. กำหนดค่าบนอินเทอร์เฟซย่อยเท่านั้น. แพ็กเก็ตใด ๆ ที่กำหนดไว้ที่ที่อยู่ IP ของอินเทอร์เฟซทางกายภาพ (หากมีการกำหนดค่าไว้)' +\
              ' จะถูกแบล็คโฮ.' +\
              '\n\nVRF - ทำงานเหมือนเลเยอร์ 3 VLAN. ต้องสร้างก่อนจึงจะสามารถใช้งานได้\n\n' +\
              'IP รอง - คุณสามารถกำหนดค่า IP รองหลายรายการบนอินเทอร์เฟซ. หากไม่มีการกำหนดค่า IP หลัก IP รองจะ ' +\
              'ยังคงไม่ใช้งานและซ่อนไว้จนกว่าจะมีการกำหนดค่า IP หลัก' +\
              '\n\nเพื่อเชื่อมต่อพอร์ตเราเตอร์, \n 1. สร้าง Bridge Group,\n 2. สร้างอินเทอร์เฟซ bvi\n 3. การตั้งค่าอื่น ๆ > "Add to bridge"'
        tkMessageBox.showinfo('คำแนะนำการตั้งค่าอินเทอร์เฟซอื่น ๆ', res)
    btn = Button(biface, text="ความช่วยเหลือ", bg="yellow", command=helpotherconf)
    ...
    deviceconfframe=LabelFrame(window,text=" การกำหนดค่าอุปกรณ์และการปรับแต่ง ",font=('verdana', 8, 'bold'),padx=10,pady=8,width=100,height=100)
    deviceconfframe.grid(row=4,column=0, sticky=("nsew"))

    label = Label(deviceconfframe, text="สร้างรายการ ARP แบบคงที่: ").grid(column=0, row=1)
    ...
    def setarp():
        ...
        if chk_state_neg.get() == False:
            ...
            remote_conn.send("exit \n")
            sleep(0.5)
            tkMessageBox.showinfo('ARP', 'กำหนดค่า ARP แบบคงที่แล้ว')
        else:
            remote_conn.send("no arp " + getarpip.get() + " " + getarpmac.get() + " arpa \n")
            sleep(0.5)
            remote_conn.send("exit \n")
            sleep(0.5)
            tkMessageBox.showinfo('ARP', 'ARP ถูกลบออก')          
    btn = Button(deviceconfframe, text="ใช้การ", font=('helvetica', 8), bg="orange", command=setarp)
    btn.grid(column=3, row=1, padx=13)

    label = Label(deviceconfframe, text="สร้างรายการ MAC แบบคงที่: ").grid(column=0, row=2)
    ...
    def setmac():
        if getiface.get() == '' or getiface.get() == 'e.g. fa0/0, fa0/0.2, vlan1, tun0, bvi1, po1 ..':
            ...
            sleep(0.5)
            if chk_state_neg.get() == False:
                if getstvlan.get() == '' or getstvlan.get().encode('utf-8') == 'VLAN เสริม':
                    remote_conn.send("mac-address-table static " + getstmac.get() + " interface " + getiface.get() + " \n")
                    sleep(0.5)
                    remote_conn.send("exit \n")
                    sleep(0.5)
                    tkMessageBox.showinfo('MAC', 'กำหนดค่า MAC แบบคงที่แล้ว. การรับส่งข้อมูลเครือข่ายไปยังปลายทาง ' + getstmac.get() + ' จะถูกส่งต่อไปยัง ' + getiface.get())
                else:
                    remote_conn.send("mac-address-table static " + getstmac.get() + " interface " + getiface.get() + " vlan " + getstvlan.get() + " \n")
                    sleep(0.5)
                    remote_conn.send("exit \n")
                    sleep(0.5)
                    tkMessageBox.showinfo('MAC', 'กำหนดค่า MAC แบบคงที่แล้ว. การรับส่งข้อมูลเครือข่ายใน VLAN ' + getstvlan.get() +  ' ไปยังจุดหมายปลายทาง ' + getstmac.get() + \
                                          ' จะถูกส่งต่อไปยัง ' + getiface.get())
            else:
                if getstvlan.get() == '' or getstvlan.get().encode('utf-8') == 'VLAN เสริม':
                    ...
                    remote_conn.send("exit \n")
                    sleep(0.5)
                    tkMessageBox.showinfo('MAC', 'คงลบ MAC แล้ว')
                else:
                    ...
                    sleep(0.5)
                    tkMessageBox.showinfo('MAC', 'คงลบ MAC แล้ว')        
    btn = Button(deviceconfframe, text="*ใช้การ", font=('helvetica', 8), bg="orange", command=setmac)
    btn.grid(column=3, row=2, padx=13, pady=2) 


    def option_changed_arpmacopt(*args):
        if arpmacopt.get().encode('utf-8') == "ล้าง ARP (ทั้งหมด)" or arpmacopt.get().encode('utf-8') == "ล้าง MAC (ทั้งหมด)":
            text = 'ไม่จำเป็นต้องป้อนข้อมูล'
        ...
        elif arpmacopt.get().encode('utf-8') == "ล้าง ARP (อินเทอร์เฟซ)" or arpmacopt.get().encode('utf-8') == "ล้าง MAC (อินเทอร์เฟซ)":
            text = 'eg. fa0/0'
            getmacarp.delete(0, END)
            getmacarp.config(fg='grey')
            getmacarp.insert(0, text)
            ...
            getmacarp.bind("<FocusOut>", handle_focus_out)
            getmacarp.bind("<FocusIn>", handle_focus_in)
        elif arpmacopt.get().encode('utf-8') == "ล้าง ARP (ip)":
            text = 'eg. 1.2.3.4'
            getmacarp.delete(0, END)
            getmacarp.config(fg='grey')
            getmacarp.insert(0, text)
            ...
            getmacarp.bind("<FocusOut>", handle_focus_out)
            getmacarp.bind("<FocusIn>", handle_focus_in)
        elif arpmacopt.get().encode('utf-8') == "ล้าง MAC (ที่อยู่)":
            text = 'xxxx.xxxx.xxxx'
            getmacarp.delete(0, END)
            getmacarp.config(fg='grey')
            getmacarp.insert(0, text)
            ...
            getmacarp.bind("<FocusOut>", handle_focus_out)
            getmacarp.bind("<FocusIn>", handle_focus_in)
        elif arpmacopt.get().encode('utf-8') == "ล้าง MAC (vlan)":
            text = '<1-4094>'
            getmacarp.delete(0, END)
            getmacarp.config(fg='grey')
            getmacarp.insert(0, text)
    ...
    "ล้าง ARP (ทั้งหมด)",
    "ล้าง ARP (ip)",
    "ล้าง ARP (อินเทอร์เฟซ)",
    "ล้าง MAC (ทั้งหมด)",
    "ล้าง MAC (ที่อยู่)",
    "ล้าง MAC (vlan)",
    "ล้าง MAC (อินเทอร์เฟซ)",
    "ตั้งค่าอายุของ MAC"
    ]
    ...
    getmacarp.insert(0, "ไม่จำเป็นต้องป้อนข้อมูล")
    def handle_focus_in(_):
        if getmacarp.cget('fg') != 'black':
            getmacarp.delete(0, END)
            getmacarp.config(fg='black')
    ...
    def arpmacclearset():
        if arpmacopt.get().encode('utf-8') == "ล้าง ARP (ทั้งหมด)":
            remote_conn.send("clear arp \n")
            sleep(0.5)
            tkMessageBox.showinfo('ตาราง ARP', 'รายการตาราง ARP ทั้งหมดถูกล้าง')
        elif arpmacopt.get().encode('utf-8') == "ล้าง ARP (ip)":
            if getmacarp.get() != "" and ("." in getmacarp.get()):
                remote_conn.send("clear ip arp " + getmacarp.get() + "\n")
                sleep(0.5)
                tkMessageBox.showinfo('ตาราง ARP', 'รายการตาราง ARP ถูกล้างโดยระบุแอตทริบิวต์ IP')
            else:
                tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนที่อยู่ IP เพื่อล้างรายการ ARP ที่เกี่ยวข้อง')
        elif arpmacopt.get().encode('utf-8') == "ล้าง ARP (อินเทอร์เฟซ)":
            ...
            ("tun" in getmacarp.get()) or ("lo" in getmacarp.get())):
                ...
                sleep(0.5)
                tkMessageBox.showinfo('ตาราง ARP', 'รายการตาราง ARP ถูกล้างโดยระบุแอตทริบิวต์อินเตอร์เฟส')
            else:
                tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนอินเทอร์เฟซ (เฉพาะ fa / gi / te / tun / lo / bvi) เพื่อล้างรายการที่อยู่ ARP ที่เกี่ยวข้อง')
        elif arpmacopt.get().encode('utf-8') == "ล้าง MAC (ทั้งหมด)":
                remote_conn.send("clear mac-address-table \n")
                sleep(0.5)
                tkMessageBox.showinfo('ตาราง MAC', 'ล้างรายการตารางที่อยู่ MAC ทั้งหมดแล้ว')
        elif arpmacopt.get().encode('utf-8') == "ล้าง MAC (vlan)":
            if getmacarp.get() != "" and getmacarp.get().isdigit() == True:
                remote_conn.send("clear mac-address-table vlan " + getmacarp.get() + " \n")
                sleep(0.5)
                tkMessageBox.showinfo('ตาราง MAC', 'รายการตารางที่อยู่ MAC ทั้งหมดถูกล้างสำหรับ VLAN ' + getmacarp.get() + '.')
            else:
                tkMessageBox.showinfo('ข้อผิดพลาด', 'Please enter a VLAN ID to clear the associated MAC address entry.')
        elif arpmacopt.get().encode('utf-8') == "ล้าง MAC (ที่อยู่)":
            if getmacarp.get() != "" and ("." in getmacarp.get()):
                remote_conn.send("clear mac-address-table address " + getmacarp.get() + " \n")
                sleep(0.5)
                tkMessageBox.showinfo('ตาราง MAC', 'รายการตารางที่อยู่ MAC ถูกล้าง')
            else:
                tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนที่อยู่ MAC (XXXX.XXXX.XXXX) เพื่อล้างรายการที่อยู่ MAC ที่เกี่ยวข้อง')
        elif arpmacopt.get().encode('utf-8') == "ล้าง MAC (อินเทอร์เฟซ)":
            if getmacarp.get() != "":
                remote_conn.send("clear mac-address-table int " + getmacarp.get() + " \n")
                sleep(0.5)
                tkMessageBox.showinfo('ตาราง MAC', 'รายการตารางที่อยู่ MAC ถูกล้างสำหรับอินเทอร์เฟซ ' + getmacarp.get() + '.')
            else:
                tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนอินเทอร์เฟซ (เฉพาะ fa / gi / te / tun / lo / bvi) เพื่อล้างรายการที่อยู่ MAC ที่เกี่ยวข้อง')
        else:
            if chk_state_neg.get() == False:
                if getmacarp.get() != "" and getmacarp.get().isdigit() == True and (getmacarp.get() <= 1000000):
                    ...
                    tkMessageBox.showinfo('ตาราง MAC', 'กำหนดเวลาอายุของตารางที่อยู่ MAC แล้ว')
                else:
                    tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนเวลาอายุที่อยู่ MAC ที่เป็นตัวเลขที่ถูกต้อง')
            else:
                remote_conn.send("no mac-address-table aging \n")
                sleep(0.5)
                tkMessageBox.showinfo('ตาราง MAC', 'รีเซ็ตเวลาอายุตารางที่อยู่ MAC แล้ว')
    btn = Button(deviceconfframe, text="ใช้การ", font=('helvetica', 8), bg="orange", command=arpmacclearset)
        ...
        if chk_state_neg.get() == False:
            if TCPtuneopt.get() == "PMTUD":
                ...
                if getTCPtune.get() != "" and getTCPtune.get() != "[<2-20> (mins)]":
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('TCP', 'PMTUD กำหนดค่าด้วยการปรับเทียบ MTU ทุกๆ ' + getTCPtune.get() + ' นาที.')
                else:
                    remote_conn.send("ip tcp path-mtu-discovery \n")
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('TCP', 'กำหนดค่า PMTUD แล้ว')                 
            elif TCPtuneopt.get() == "TCP egress queue":
                if getTCPtune.get() != "" and getTCPtune.get() != "eg. 5 (segments)":
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('TCP', 'กำหนดค่าคิว TCP ขาออกแล้ว')
                else:
                    tkMessageBox.showinfo('ข้อผิดพลาด', 'กรุณาใส่ค่า')                    
            elif TCPtuneopt.get() == "SYNWAIT-time":
                if getTCPtune.get() != "" and getTCPtune.get() != "eg. 30 (secs)":
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('TCP', 'กำหนดค่า TCP SYNWAIT-time แล้ว')
                else:
                    tkMessageBox.showinfo('ข้อผิดพลาด', 'กรุณาใส่ค่า') 
            elif TCPtuneopt.get() == "TCP window-size":
                if getTCPtune.get() != "" and getTCPtune.get() != "eg. 65535": 
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('TCP', 'กำหนดขนาดหน้าต่าง TCP แล้ว')
                else:
                    tkMessageBox.showinfo('ข้อผิดพลาด', 'กรุณาใส่ค่า') 
                ...
                sleep(0.3)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('TCP', 'กำหนดคุณสมบัติการแจ้งเตือนความแออัดอย่างชัดเจนของ TCP หมายเหตุ: รีโมตเพียร์ต้องเปิดใช้งาน ECN เพื่อให้คุณสมบัตินี้ทำงานได้')
                ...
                sleep(0.3)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('TCP', 'กำหนดค่า TCP Selective-ACK (SACK) แล้ว')
            else:
                remote_conn.send("conf t \n")
                sleep(0.3)
                ...
                sleep(0.3)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('TCP', 'กำหนดค่าการประทับเวลา TCP แล้ว')
        else:
            if TCPtuneopt.get() == "PMTUD":
                remote_conn.send("conf t \n")
                sleep(0.3)
                ...
                sleep(0.3)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('TCP', 'TCP PMTUD ถูกปิดใช้งาน.') 
            elif TCPtuneopt.get() == "TCP egress queue":
                remote_conn.send("conf t \n")
                sleep(0.3)
                ...
                sleep(0.3)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('TCP', 'TCP egress-queue-max รีเซ็ตเป็นค่าเริ่มต้น.') 
            elif TCPtuneopt.get() == "SYNWAIT-time":
                remote_conn.send("conf t \n")
                sleep(0.3)
                ...
                sleep(0.3)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('TCP', 'TCP SYNWAIT-time รีเซ็ตเป็นค่าเริ่มต้น.') 
            elif TCPtuneopt.get() == "TCP window-size":
                remote_conn.send("conf t \n")
                sleep(0.3)
                ...
                sleep(0.3)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('TCP', 'TCP window-size รีเซ็ตเป็นค่าเริ่มต้น.') 
            elif TCPtuneopt.get() == "Enable ECN":
                remote_conn.send("conf t \n")
                sleep(0.3)
                ...
                sleep(0.3)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('TCP', 'TCP Explicit Congestion Notification ถูกปิดใช้งาน.') 
            elif TCPtuneopt.get() == "Enable Selective-ACK":
                remote_conn.send("conf t \n")
                sleep(0.3)
                ...
                sleep(0.3)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('TCP', 'TCP Selective-ACK ถูกปิดใช้งาน.')
            else:
                remote_conn.send("conf t \n")
                sleep(0.3)
                remote_conn.send("ip tcp timestamp \n")
                sleep(0.3)
                remote_conn.send("exit \n")                
            tkMessageBox.showinfo('TCP', 'TCP timestamp ถูกปิดใช้งาน.')
    btn = Button(deviceconfframe, text="ใช้การ", font=('helvetica', 8), bg="orange", command=TCPtune)
    ...
    chk = Checkbutton(deviceconfframe, text="การเรียนรู้ MAC", font=("TkDefaultFont", 8), variable=chk_MAClearn)
    chk.grid(column=1, row=6, sticky='e', columnspan=2, pady=(15,0))
    


    def option_changed_bridgefilter(*args):
        if bridgefilter.get().encode('utf-8') == "ไม่จำเป็น":
            text = ''
    ...
    btn = Button(deviceconfframe, text="ใช้การ", font=('helvetica', 8), bg="orange", command=createbridgeG)
    btn.grid(row=6, column=3, pady=(15,0)) 

    def bridgeGOpt():
        if createbridge.get() == "" or createbridge.get() == "eg. 5":
            tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดป้อนหมายเลข Bridge Group')
        elif bridgefilter.get().encode('utf-8') == "ไม่จำเป็น":
            tkMessageBox.showinfo('ข้อผิดพลาด', 'โปรดเลือกตัวเลือก')
        else:
            if chk_state_neg.get() == False:
                remote_conn.send("conf t \n")
                sleep(0.3)
    ...
    showconfframe=LabelFrame(window,text=" แสดงการกำหนดค่า ",font=('verdana', 8, 'bold'),padx=50,pady=8,width=100,height=100)
    ...
    def showintconf():
        if showintopt.get().encode('utf-8') == "สถิติอินเทอร์เฟซ":
            if getiface.get() == '' or getiface.get() == 'e.g. fa0/0, fa0/0.2, vlan1, tun0, bvi1, po1 ..':
                tkMessageBox.showinfo('ข้อผิดพลาด', 'ป้อนอินเทอร์เฟซด้านบนก่อน')
            else:
                buff_size = 16384
                sleep(0.5)
        ...
        elif showintopt.get().encode('utf-8') == "การกำหนดค่าอินเทอร์เฟซ":
            if getiface.get() == '' or getiface.get() == 'e.g. fa0/0, fa0/0.2, vlan1, tun0, bvi1, po1 ..':
                tkMessageBox.showinfo('ข้อผิดพลาด', 'ป้อนอินเทอร์เฟซด้านบนก่อน')
            else:
                rep = getiface.get()
                ...
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Current interface configuration', output)
        elif showintopt.get().encode('utf-8') == "สถิติอินเตอร์เฟส L3":
            if getiface.get() == '' or getiface.get() == 'e.g. fa0/0, fa0/0.2, vlan1, tun0, bvi1, po1 ..':
                tkMessageBox.showinfo('ข้อผิดพลาด', 'ป้อนอินเทอร์เฟซด้านบนก่อน')
            else:
                buff_size = 16384
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('การกำหนดค่าอินเทอร์เฟซปัจจุบัน', output)
        else:
            buff_size = 16384
            sleep(0.5)
            ...
            output = remote_conn.recv(buff_size).decode("utf-8")
            tkMessageBox.showinfo('การกำหนดค่าอินเทอร์เฟซปัจจุบัน', output)        
    btn = Button(showconfframe, text="แสดง", bg="orange", command=showintconf)
    btn.place(x=300, y=0)
    ...
    "CPU",
    "หน่วยความจำ",
    "ดูเพล็กซ์ / ความเร็ว (กำหนดค่า)",
    "ดูเพล็กซ์ / ความเร็ว (มีผลบังคับใช้)",
    "การเชื่อมต่อ TCP",
    "สถิติ TCP",
    "UDP",
    "พอร์ตการฟัง",
    ...
    def showintconf2():
        if showintopt2.get().encode('utf-8') == "ตาราง MAC":
            buff_size = 16384
            sleep(0.5)
            ...
            output = remote_conn.recv(buff_size).decode("utf-8")
            tkMessageBox.showinfo('Current interface configuration', output)
        elif showintopt2.get().encode('utf-8') == "ตาราง MAC (ผลรวม)":
            buff_size = 16384
            sleep(0.5)
            ...
            output = remote_conn.recv(buff_size).decode("utf-8")
            tkMessageBox.showinfo('Current interface configuration', output)
        elif showintopt2.get().encode('utf-8') == "ตาราง ARP":
            buff_size = 16384
            sleep(0.5)
            ...
            if showintopt2.get().encode('utf-8') == "สถานะฮาร์ดแวร์":
                cmd = "show env \n"
            elif showintopt2.get().encode('utf-8') == "สถานะฮาร์ดแวร์ (รายละเอียด)":
                cmd = "show env all \n"                
            elif showintopt2.get().encode('utf-8') == "ข้อมูลฮาร์ดแวร์":
                cmd = "show inv \n"
            elif showintopt2.get().encode('utf-8') == "สถานะ 'Buffer'":
                cmd = "show buff \n"
            elif showintopt2.get().encode('utf-8') == "นาฬิกา":
                cmd = "show clock \n"
            elif showintopt2.get().encode('utf-8') == "เวลาทำงาน":
                cmd = "show ver | i uptime | returned | restarted \n"
            elif showintopt2.get().encode('utf-8') == "เวอร์ชัน":
                cmd = "show ver | s IOS \n"
            elif showintopt2.get() == "CPU":
                cmd = "show proc cpu hist \n"
            elif showintopt2.get().encode('utf-8') == "หน่วยความจำ":
                cmd = "show proc mem \n"
            elif showintopt2.get().encode('utf-8') == "ดูเพล็กซ์ / ความเร็ว (กำหนดค่า)":
                cmd = "show run | i interface | duplex | speed \n"
            elif showintopt2.get().encode('utf-8') == "ดูเพล็กซ์ / ความเร็ว (มีผลบังคับใช้)":
                cmd = "show int | i dup| up \n"                
            elif showintopt2.get().encode('utf-8') == "การเชื่อมต่อ TCP":
                cmd = "show tcp brief nume \n"
            elif showintopt2.get().encode('utf-8') == "สถิติ TCP":
                cmd = "show tcp stat \n"
            elif showintopt2.get().encode('utf-8') == "พอร์ตการฟัง":
            ...
            output = remote_conn.recv(buff_size).decode("utf-8")
            tkMessageBox.showinfo('การกำหนดค่าอินเทอร์เฟซปัจจุบัน', output)      
    btn = Button(showconfframe, text="แสดง", bg="orange", command=showintconf2)
...
if __name__ == "__main__":
        ...
        main()
        window.withdraw()
        jumphostip = askstring("", "ป้อน Jumphost IP (ถ้าไม่มีให้พิมพ์ 'n'):")
        ip = askstring("", "ป้อนโฮสต์ IP:")
        if jumphostip == "" or ip == "":
            window.destroy()
