...
localip = "172.30.112.214"    #the ip address of this computer, used for Syslog svr (for the 'debugging' function)
...
def loginjumphost():
    jumphostip = "1.2.3.4"
    port = 1234
    jumphostusername = "my.user"
    jumphostpassword = "myjumphostpasswd"
    ciscorouterip = raw_input("Enter router ip: ")
    ciscoauthpassword = "myrouterpasswd"
    ...
    print "Successful connection", jumphostip
    sleep(0.5)
    remote_conn = ssh_client.invoke_shell()    
    remote_conn.send("ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no " + ciscorouterip + " \n")
    sleep(2)
...
def login():
    username = "cisco"
    password = "cisco123"
    enablepassword = "ciscoenable"
    ip = "192.168.128.5"        #ip address of router/switch to connect to
    port = 22    
    global remote_conn
    ssh_client = paramiko.SSHClient()
    ssh_client.set_missing_host_key_policy(paramiko.AutoAddPolicy())
    ssh_client.connect(hostname=ip, port=int(port), username=username, password=password)
    ...
    def route():
        ...
        def staticro():
            ...
            staticgw.get() == "gateway IP":
                tkMessageBox.showinfo('Error', 'Please input the minimum required information - IP, subnet mask and next hop gateway.')
            else:
                if chk_state_neg.get() == False:
                    if chk_state_mcast.get() == False:
                        if VRFopt.get() == "" or VRFopt.get() == "VRF":
                            ...
                            tkMessageBox.showinfo('IP route', 'Static IP route added.')
                            ...
                            sleep(0.5)
                            remote_conn.send("exit \n")
                            tkMessageBox.showinfo('IP route', 'Static IP (VRF) route added.')

           
                    else:
                        if (Trackopt.get() != "Track" and Trackopt.get() != "") or (Nameopt.get() != "Name" and Nameopt.get() != "")\
                           or (Tagopt.get() != "Tag" and Tagopt.get() != ""):
                            tkMessageBox.showinfo('Error', 'Track, name and tags cannot be used with multicast routes.')
                        else:                            
                            if VRFopt.get() == "" or VRFopt.get() == "VRF":
                                if Metricopt.get() != "" and Metricopt.get() != "Metric":
                                ...
                                sleep(0.5)
                                remote_conn.send("exit \n")
                                tkMessageBox.showinfo('IP route', 'Static IP multicast (RPF) route added.')
                            else:
                                if Metricopt.get() != "" and Metricopt.get() != "Metric":
                                ...
                                sleep(0.5)
                                remote_conn.send("exit \n")
                                tkMessageBox.showinfo('IP route', 'Static VRF IP multicast (RPF) route added.')                                
                else:
                    if chk_state_mcast.get() == False:
                        if VRFopt.get() == "" or VRFopt.get() == "VRF":
                            if Metricopt.get() != "" and Metricopt.get() != "Metric":
                            ...
                            sleep(0.5)
                            remote_conn.send("exit \n")
                            tkMessageBox.showinfo('IP route', 'Static IP route removed.')
                        else:
                            if Metricopt.get() != "" and Metricopt.get() != "Metric":
                            ...
                            sleep(0.5)
                            remote_conn.send("exit \n")
                            tkMessageBox.showinfo('IP route', 'Static IP (VRF) route removed.')
                        ...
                        if (Trackopt.get() != "Track" and Trackopt.get() != "") or (Nameopt.get() != "Name" and Nameopt.get() != "")\
                           or (Tagopt.get() != "Tag" and Tagopt.get() != ""):
                            ...
                            if VRFopt.get() == "" or VRFopt.get() == "VRF":
                                ...
                                sleep(0.5)
                                remote_conn.send("exit \n")
                                tkMessageBox.showinfo('IP route', 'Static IP multicast (RPF) route removed.')
                            else:
                                if Metricopt.get() != "" and Metricopt.get() != "Metric":
                                ...
                                sleep(0.5)
                                remote_conn.send("exit \n")
                                tkMessageBox.showinfo('IP route', 'Static VRF IP multicast (RPF) route removed.')                                    
        btn = Button(basicrouteframe, text="Apply", bg="orange", command=staticro)
        ...
        def enospf():
            ...
            if (a == '' or a == 'eg. 15(MyVRF)'):
                tkMessageBox.showinfo('Error', 'Please enter minimum required information.')
            else:
                if chk_state_neg.get() == False:
                    if (b == '') and (c == '') and (d == ''):
                        remote_conn.send("conf t\n")
                        ...
                        tkMessageBox.showinfo('OSPF ' + txtospfpid.get(), res)
                    elif (b != '') and (c != '')  and (d != ''):
                        remote_conn.send("conf t\n")
                        sleep(0.2)
                        if "(" not in txtospfpid.get():
                        ...
                        tkMessageBox.showinfo('Error', 'Please enter area, route and mask to advertise; else, leave all 3 blank to enable an OSPF process.')                        
                else:  
                    if b == '' and c == ''  and d == '':
                        remote_conn.send("conf t\n")
                        sleep(0.2)
                        ...
                        tkMessageBox.showinfo('Error', 'Please enter area, route and mask to unadvertise; else, leave all 3 blank to disable an OSPF process.')
        ...
        def ospfifaceopt():
            ...
            if ospfoptiface.get() == "" or ospfoptiface.get() == "eg. fa0/0":
                tkMessageBox.showinfo('Error', 'Please enter an interface first.')
            else:
                remote_conn.send("conf t \n")
                sleep(0.2)
                if chk_state_neg.get() == False:
                    if getOSPFoptiface.get() == "Hello timer":                        
                        ...
                        tkMessageBox.showinfo('OSPF Hello', 'Timer set.')
                    elif getOSPFoptiface.get() == "Dead timer":
                        remote_conn.send("int " + ospfoptiface.get() + " \n")
                        sleep(0.2)                
                        remote_conn.send("ip ospf dead-int " + ospfopt1.get() + " \n")
                        tkMessageBox.showinfo('OSPF Dead', 'Timer set.')
                    elif getOSPFoptiface.get() == "Passive int'face":
                        if txtospfpid.get() == "" or txtospfpid.get() == "eg. 15(MyVRF)":
                            tkMessageBox.showinfo('Error', 'Please also enter the OSPF process ID above.')
                        else:
                            if "(" not in txtospfpid.get():
                                remote_conn.send(defospfcmd)
                            else:
                            ...
                            tkMessageBox.showinfo('OSPF Passive', 'OSPF process disabled for interface ' + ospfoptiface.get() + '.')
                    elif getOSPFoptiface.get() == "Cost Metric":
                        remote_conn.send("int " + ospfoptiface.get() + " \n")
                        sleep(0.2)                
                        remote_conn.send("ip ospf cost " + ospfopt1.get() + " \n")
                        tkMessageBox.showinfo('OSPF Cost', 'OSPF cost modified.')
                    elif getOSPFoptiface.get() == "Link Priority":
                        remote_conn.send("int " + ospfoptiface.get() + " \n")
                        sleep(0.2)                
                        remote_conn.send("ip ospf prio " + ospfopt1.get() + " \n")
                        tkMessageBox.showinfo('OSPF Priority', 'OSPF priority modified.')
                    elif getOSPFoptiface.get() == "Network type":
                        remote_conn.send("int " + ospfoptiface.get() + " \n")
                        sleep(0.2)
                        remote_conn.send("ip ospf network " + ospfopt1.get() + " \n")
                        tkMessageBox.showinfo('OSPF Network type', 'OSPF network type modified.')
                    elif getOSPFoptiface.get() == "Authentication":
                        option = ospfopt1.get()
                        ...
                        tkMessageBox.showinfo('OSPF Authentication', 'OSPF md5 authentication enabled. REMEMBER to create the keychain.')
                    elif getOSPFoptiface.get() == "Set Area":
                        if txtospfpid.get() == "" or txtospfpid.get() == "eg. 15(MyVRF)" or txtospfarea.get() == "" or ("(" in txtospfpid.get()):
                            tkMessageBox.showinfo('Error', 'Please also enter both the OSPF process ID (non-VRF only) and area above.')
                        else:
                            remote_conn.send("int " + ospfoptiface.get() + " \n")
                            sleep(0.2)
                            remote_conn.send("ip ospf " + txtospfpid.get() + " area " + txtospfarea.get() + " \n")
                            tkMessageBox.showinfo('OSPF Area', 'This interface has been put into area ' + txtospfarea.get() + '.')
                    else:
                        remote_conn.send("int " + ospfoptiface.get() + " \n")
                        sleep(0.2)                
                        remote_conn.send("ip ospf bfd \n")
                        tkMessageBox.showinfo('BFD', 'BFD configured for this interface.')
                else:
                    if getOSPFoptiface.get() == "Hello timer":                        
                        remote_conn.send("int " + ospfoptiface.get() + " \n")
                        sleep(0.2)                
                        remote_conn.send("no ip ospf hello-int " + ospfopt1.get() + " \n")
                        tkMessageBox.showinfo('OSPF Hello', 'Timer reset.')
                    elif getOSPFoptiface.get() == "Dead timer":
                        remote_conn.send("int " + ospfoptiface.get() + " \n")
                        sleep(0.2)                
                        remote_conn.send("no ip ospf dead-int " + ospfopt1.get() + " \n")
                        tkMessageBox.showinfo('OSPF Dead', 'Timer reset.')
                    elif getOSPFoptiface.get() == "Passive int'face":
                        if txtospfpid.get() == "" or txtospfpid.get() == "eg. 15(MyVRF)":
                            tkMessageBox.showinfo('Error', 'Please also enter the OSPF process ID above.')
                        else:
                            ...
                            tkMessageBox.showinfo('OSPF Passive', 'OSPF process enabled for interface ' + ospfoptiface.get() + '.')
                    elif getOSPFoptiface.get() == "Cost Metric":
                        remote_conn.send("int " + ospfoptiface.get() + " \n")
                        sleep(0.2)                
                        remote_conn.send("no ip ospf cost " + ospfopt1.get() + " \n")
                        tkMessageBox.showinfo('OSPF Cost', 'OSPF cost reset.')
                    elif getOSPFoptiface.get() == "Link Priority":
                        remote_conn.send("int " + ospfoptiface.get() + " \n")
                        sleep(0.2)                
                        remote_conn.send("no ip ospf prio " + ospfopt1.get() + " \n")
                        tkMessageBox.showinfo('OSPF Priority', 'OSPF priority reset.')
                    elif getOSPFoptiface.get() == "Network type":
                        remote_conn.send("int " + ospfoptiface.get() + " \n")
                        sleep(0.2)
                        remote_conn.send("no ip ospf network " + ospfopt1.get() + " \n")
                        tkMessageBox.showinfo('OSPF Network type', 'OSPF network type reset.')
                    elif getOSPFoptiface.get() == "Authentication":
                        option = ospfopt1.get()
                        keynum = int(re.search(r'\d+', option).group())
                        md5str = option.split(" ",1)[1]
                        ...
                        if txtospfpid.get() == "" or txtospfpid.get() == "eg. 15(MyVRF)" or txtospfarea.get() == "" or ("(" in txtospfpid.get()):
                            ...
                            tkMessageBox.showinfo('OSPF Area', 'Interface ' + ospfoptiface.get() + ' has been removed from area ' + txtospfarea.get() + '.')
                    else:
                        remote_conn.send("int " + ospfoptiface.get() + " \n")
                        sleep(0.2)                
                ...
                sleep(0.2)
                remote_conn.send("exit \n")
        btn = Button(OSPFframe, text="Apply", bg="orange", command=ospfifaceopt)
            ...
            if txtospfpid.get() == "" or txtospfpid.get() == "eg. 15(MyVRF)":
                ...
                if chk_state_neg.get() == False:                
                    if getOSPFoptdevice.get() == "Router-ID":
                        ...
                        tkMessageBox.showinfo('OSPF', 'Rotuer-id has been set.')
                    elif getOSPFoptdevice.get() == "Static neighbor":
                        remote_conn.send("neighbor " + ospfopt2.get() + " \n")
                        tkMessageBox.showinfo('OSPF', 'Static neighbor has been set.')
                    elif getOSPFoptdevice.get() == "Propagate * route":
                        remote_conn.send("default-information originate " + ospfopt2.get() + " \n")
                        tkMessageBox.showinfo('OSPF', 'Default route has been propagated.')
                    elif getOSPFoptdevice.get() == "Stub type":
                        if txtospfarea.get() == "":
                            tkMessageBox.showinfo('Error', 'Please also enter an OSPF area above.')
                        else:
                            if ospfopt2.get() == "Stub":
                                remote_conn.send("area " + txtospfarea.get() + " stub \n")
                                tkMessageBox.showinfo('OSPF', 'Area ' + txtospfarea.get() + ' changed to stub area.')
                            elif ospfopt2.get() == "Total-Stub":
                                remote_conn.send("area " + txtospfarea.get() + " stub no-summ \n")
                                tkMessageBox.showinfo('OSPF', 'Area ' + txtospfarea.get() + ' changed to Total-stub area.')
                            elif ospfopt2.get() == "NSSA":
                                remote_conn.send("area " + txtospfarea.get() + " nssa \n")
                                tkMessageBox.showinfo('OSPF', 'Area ' + txtospfarea.get() + ' changed to NSSA area.')
                            elif ospfopt2.get() == "Total-NSSA":
                                remote_conn.send("area " + txtospfarea.get() + " nssa no-summ \n")
                                tkMessageBox.showinfo('OSPF', 'Area ' + txtospfarea.get() + ' changed to Total-NSSA area.')
                            else:
                                tkMessageBox.showinfo('Error', 'Please enter ONE stub type to configure the area.')
                    elif getOSPFoptdevice.get() == "Virt link":
                        if txtospfarea.get() == "":
                            tkMessageBox.showinfo('Error', 'Please also enter an OSPF area above.')
                        else:
                            remote_conn.send("area " + txtospfarea.get() + " virtual-l " + ospfopt2.get() + " \n")
                            tkMessageBox.showinfo('OSPF', 'Virtual link has been configured. NOTE: If this area is already a stub area, will not work.')
                    elif getOSPFoptdevice.get() == "Max paths":
                        remote_conn.send("maximum-paths " + ospfopt2.get() + " \n")
                        tkMessageBox.showinfo('OSPF', 'OSPF maximum paths configured.')
                    elif getOSPFoptdevice.get() == "Area auth":
                        if txtospfarea.get() == "":
                            tkMessageBox.showinfo('Error', 'Please also enter an OSPF area above.')
                        else:
                            remote_conn.send("area " + txtospfarea.get() + " authen message-d \n")
                            tkMessageBox.showinfo('OSPF', 'OSPF authentication configured. NOTE: you still need to configure the interface authentication cmd.')
                    elif getOSPFoptdevice.get() == "Cost reference":
                        remote_conn.send("auto-cost reference-bandw " + ospfopt2.get() + " \n")
                        tkMessageBox.showinfo('OSPF', 'OSPF reference bandwidth modified.')
                    elif getOSPFoptdevice.get() == "AD(all, per rte)":
                        remote_conn.send("distance " + ospfopt2.get() + " \n")
                        tkMessageBox.showinfo('OSPF', 'OSPF administrative distance modified.')
                    elif getOSPFoptdevice.get() == "AD(area type)":
                        ...
                        if txtospfarea.get() == "":
                            ...
                            tkMessageBox.showinfo('OSPF', 'OSPF inter-area filter configured.')
                    elif getOSPFoptdevice.get() == "Intra-area filter":
                        remote_conn.send("distribute-list prefix " + ospfopt2.get() + " \n")
                        tkMessageBox.showinfo('OSPF', 'OSPF intra-area filter configured.')
                    else:
                        remote_conn.send("summary-address " + ospfopt2.get() + " \n")
                        tkMessageBox.showinfo('OSPF', 'OSPF aggregate address configured.')
                else:
                    if getOSPFoptdevice.get() == "Router-ID":
                        remote_conn.send("no router-id " + ospfopt2.get() + " \n")
                        tkMessageBox.showinfo('OSPF', 'Router-id has been removed.')
                    elif getOSPFoptdevice.get() == "Static neighbor":
                        remote_conn.send("no neighbor " + ospfopt2.get() + " \n")
                        tkMessageBox.showinfo('OSPF', 'Static neighbor has been removed.')
                    elif getOSPFoptdevice.get() == "Propagate * route":
                        remote_conn.send("no default-information originate " + ospfopt2.get() + " \n")
                        tkMessageBox.showinfo('OSPF', 'Default route has been removed.')
                    elif getOSPFoptdevice.get() == "Stub area":
                        if txtospfarea.get() == "":
                            tkMessageBox.showinfo('Error', 'Please also enter an OSPF area above.')
                        else:
                            remote_conn.send("no area " + txtospfarea.get() + " stub " + ospfopt2.get() + " \n")
                            tkMessageBox.showinfo('OSPF', 'Area ' + txtospfarea.get() + ' no longer stub area.')
                    elif getOSPFoptdevice.get() == "Virt link":
                        if txtospfarea.get() == "":
                            tkMessageBox.showinfo('Error', 'Please also enter an OSPF area above.')
                        else:
                            remote_conn.send("no area " + txtospfarea.get() + " virtual-l " + ospfopt2.get() + " \n")
                            tkMessageBox.showinfo('OSPF', 'Virtual link has been removed.')
                    elif getOSPFoptdevice.get() == "Max paths":
                        remote_conn.send("no maximum-paths " + ospfopt2.get() + " \n")
                        tkMessageBox.showinfo('OSPF', 'OSPF maximum paths reset.')
                    elif getOSPFoptdevice.get() == "Area auth":
                        if txtospfarea.get() == "":
                            tkMessageBox.showinfo('Error', 'Please also enter an OSPF area above.')
                        else:
                            remote_conn.send("no area " + txtospfarea.get() + " authen message-d " + ospfopt2.get() + " \n")
                            tkMessageBox.showinfo('OSPF', 'OSPF authentication removed.')
                    elif getOSPFoptdevice.get() == "Cost reference":
                        remote_conn.send("no auto-cost reference-bandw " + ospfopt2.get() + " \n")
                        tkMessageBox.showinfo('OSPF', 'OSPF reference bandwidth reset.')
                    elif getOSPFoptdevice.get() == "AD(all, per rte)":
                        remote_conn.send("no distance " + ospfopt2.get() + " \n")
                        tkMessageBox.showinfo('OSPF', 'OSPF administrative distance reset.')
                    elif getOSPFoptdevice.get() == "AD(area type)":
                        ...
                        if txtospfarea.get() == "":
                            ...
                            tkMessageBox.showinfo('OSPF', 'OSPF inter-area filter removed.')
                    elif getOSPFoptdevice.get() == "Intra-area filter":
                        remote_conn.send("no distribute-list prefix " + ospfopt2.get() + " \n")
                        tkMessageBox.showinfo('OSPF', 'OSPF intra-area filter removed.')
                    else:
                        remote_conn.send("no summary-address " + ospfopt2.get() + " \n")
                        tkMessageBox.showinfo('OSPF', 'OSPF aggregate address removed.')                    
            sleep(0.2)
            remote_conn.send("exit \n")
            sleep(0.2)
            remote_conn.send("exit \n")
        btn = Button(OSPFframe, text="Apply", bg="orange", command=ospfotheropt)
        ...
        def ospfredistribute():
            ...
            vrffind2 = ospfredisttoprocnum.get()
            vrf2 = vrffind2[vrffind2.find("(")+1:vrffind2.find(")")]            
            redistcmd = "redistribute " + getOSPFoptredist.get() + " subnets "
            redistospfvrfcmd = "redistribute " + getOSPFoptredist.get() + " vrf " + vrf2 + " subnets "
            
            if chk_state_neg.get() == False:                
                if getOSPFoptredist.get() == "RIP" or getOSPFoptredist.get() == "EIGRP" or getOSPFoptredist.get() == "BGP":
                    if txtospfpid.get() == "" or txtospfpid.get() == "eg. 15(MyVRF)":
                        tkMessageBox.showinfo('Error', 'Please also enter the OSPF process ID above.')
                    else:
                        remote_conn.send("conf t \n")
                        ...
                        if ospfredistFilter.get() != "" and ospfredistFilter.get() != "r-map":
                            redistcmd = redistcmd + " route-map " + ospfredistFilter.get()
                        else:
                            pass
                        if ospfredistMetric.get() != "" and ospfredistMetric.get() != "Metric":
                            redistcmd = redistcmd + " metric " + ospfredistMetric.get()
                        else:
                            pass
                        if ospfredistTag.get() != "" and ospfredistTag.get() != "Tag":
                            redistcmd = redistcmd + " tag " + ospfredistTag.get()
                        else:
                            pass
                            remote_conn.send(redistcmd + "\n")
                            sleep(0.2)
                            tkMessageBox.showinfo('OSPF redistribution', 'Learned ' + getOSPFoptredist.get() + '.')
                else:
                    if txtospfpid.get() == "" or txtospfpid.get() == "eg. 15(MyVRF)":
                        tkMessageBox.showinfo('Error', 'Please also enter the OSPF process ID above.')
                    else:
                ...
                if getOSPFoptredist.get() == "RIP" or getOSPFoptredist.get() == "EIGRP" or getOSPFoptredist.get() == "BGP":
                    if txtospfpid.get() == "" or txtospfpid.get() == "eg. 15(MyVRF)":
                        ...
                        if ospfredistTag.get() != "" and ospfredistTag.get() != "Tag":
                            ...
                            pass
                            remote_conn.send("no " + redistcmd + "\n")
                            sleep(0.2)
                            tkMessageBox.showinfo('OSPF redistribution', 'Unlearned ' + getOSPFoptredist.get() + '.')
                else:
                    if txtospfpid.get() == "" or txtospfpid.get() == "eg. 15(MyVRF)":
                        tkMessageBox.showinfo('Error', 'Please also enter the OSPF process ID above.')
                    else:
        ...
        def eneigrp():
            ...
            if (d == '' or d == 'eg. 15(MyVRF)AS1'):
                tkMessageBox.showinfo('Error', 'Please enter minimum required information (EIGRP PID).')
            elif ("(" in d) and ("AS" not in d):
                tkMessageBox.showinfo('Error', 'Please enter both the EIGRP PID VRF and AS number.')
                ...
                if chk_state_neg.get() == False:
                    if (e == '') and (f == ''):
                        ...
                        tkMessageBox.showinfo('EIGRP ' + txteigrppid.get(), res)
                    elif (e == '') or (f == ''):
                        tkMessageBox.showinfo('Error', 'Please enter route and mask to advertise.')
                    else:
                        remote_conn.send("conf t\n")
                        sleep(0.5)
                        if "(" not in txteigrppid.get():
                    ...
                    if e == '' and f == '':
                        ...
                        if "(" not in txteigrppid.get():
                            ...
                            remote_conn.send("no " + vrfeigrpcmd)
                        sleep(0.5)
                        remote_conn.send("exit \n")
                        sleep(0.5)
                        remote_conn.send("exit \n")
        ...
        def eigrpifaceopt():
            ...
            if txteigrppid.get() == "" or txteigrppid.get() == "eg. 15(MyVRF)AS1":
                tkMessageBox.showinfo('Error', 'Please also enter the EIGRP PID above.')
                ...
                if chk_state_neg.get() == False:
                    if getEIGRPoptiface.get() == "Hello timer":
                        if eigrpopt1.get() == "" or eigrpopt1.get() == "eg. 5":
                            tkMessageBox.showinfo('Error', 'Please enter a Hello timer value.')
                        else:
                            remote_conn.send("int " + eigrpoptiface.get() + " \n")
                            sleep(0.2)                
                            remote_conn.send("ip hello-int eig " + txteigrppid.get + " " + eigrpopt1.get() + " \n")
                            tkMessageBox.showinfo('EIGRP Timer', 'Hello timer set.')
                    elif getEIGRPoptiface.get() == "Hold timer" or eigrpopt1.get() == "eg. 15":
                        if eigrpopt1.get() == "":
                            tkMessageBox.showinfo('Error', 'Please enter a Hold timer value.')
                        else:
                            remote_conn.send("int " + eigrpoptiface.get() + " \n")
                            sleep(0.2)                
                            remote_conn.send("ip hold-t eig " + txteigrppid.get + " " + eigrpopt1.get() + " \n")
                            tkMessageBox.showinfo('EIGRP Timer', 'Hold timer set.')
                    elif getEIGRPoptiface.get() == "Static neighbor":
                        if eigrpopt1.get() == "" or eigrpopt1.get() == "<neigh_IP>":
                            tkMessageBox.showinfo('Error', 'Please enter a neighbor IP address.')
                        else:
                            remote_conn.send("neighbor " + eigrpopt1.get() + " " + eigrpoptiface.get() + " \n")
                            tkMessageBox.showinfo('EIGRP', 'Static neighbor has been configured.')
                    elif getEIGRPoptiface.get() == "Passive int'face":
                        if "(" not in txteigrppid.get():
                            remote_conn.send(defeigrpcmd)
                        else:
                        ...
                        tkMessageBox.showinfo('EIGRP Passive', 'EIGRP process enabled for interface ' + eigrpoptiface.get() + '.')
                    elif getEIGRPoptiface.get() == "Bandwidth":
                        if eigrpopt1.get() == "" or eigrpopt1.get() == "eg. 10000 (Kbps)":
                            tkMessageBox.showinfo('Error', 'Please enter a bandwidth value.')
                        else:
                            remote_conn.send("int " + eigrpoptiface.get() + " \n")
                            sleep(0.2)
                            remote_conn.send("bandwidth " + eigrpopt1.get() + " \n")
                            tkMessageBox.showinfo('Interface Bandwidth', 'Interface bandwidth configured. NOTE: Will affect any applied %-based QoS policy on this interface.')                       
                    elif getEIGRPoptiface.get() == "Summary route":
                        if eigrpopt1.get() == "" or eigrpopt1.get() == "<net> <mask> [<AD>]":
                            tkMessageBox.showinfo('Error', 'Please enter a summary-address <<ip> <mask> [AD]> value.')
                        else:
                            remote_conn.send("int " + eigrpoptiface.get() + " \n")
                            sleep(0.2)
                            remote_conn.send("ip summary-address eigrp " + txteigrppid.get() + " " + eigrpopt1.get() + " \n")
                            tkMessageBox.showinfo('EIGRP summary-address', 'Configured.')
                    elif getEIGRPoptiface.get() == "Filter adv'tised":
                        if eigrpopt1.get() == "" or eigrpopt1.get() == "<acl_no.> | prefix-l <> + i/o":
                            tkMessageBox.showinfo('Error', 'Please specify the <<ACL/prefix<pfxlist>> <in/out>>.')
                        else:
                            if "(" not in txteigrppid.get():
                                remote_conn.send(defeigrpcmd)
                            else:
                            ...
                            tkMessageBox.showinfo('EIGRP Route Filter', 'EIGRP distribute list filtering configured - remember to create the ACL/pfxlist.')
                    elif getEIGRPoptiface.get() == "Filter metric FD":
                        if eigrpopt1.get() == "" or eigrpopt1.get() == "<acl_no.> + i/o + offset_val":
                            tkMessageBox.showinfo('Error', 'Please specify the <<ACL> <in/out> <metric-offset-val>>.')
                        else:
                            if "(" not in txteigrppid.get():
                                remote_conn.send(defeigrpcmd)
                            else:
                            ...
                            tkMessageBox.showinfo('EIGRP Metric Filter', 'EIGRP offset list filtering configured - remember to create the ACL/pfxlist.')
                    elif getEIGRPoptiface.get() == "Authentication":
                        if eigrpopt1.get() == "" or eigrpopt1.get() == "<keychain_name>":
                            tkMessageBox.showinfo('Error', 'Please specify a Keychain name.')
                        else:
                            remote_conn.send("int " + eigrpoptiface.get() + " \n")
                            sleep(0.2)
                            ...
                            sleep(0.2)
                            tkMessageBox.showinfo('EIGRP Authentication', 'Configured - remember to create the Key Chain !')
                    else:
                        if "(" not in txteigrppid.get():
                            remote_conn.send(defeigrpcmd)
                        else:
                        ...
                        sleep(0.2)
                        tkMessageBox.showinfo('BFD', 'BFD configured for interface.')
                    ...
                    if getEIGRPoptiface.get() == "Hello timer":                        
                        ...
                        tkMessageBox.showinfo('EIGRP Timer', 'Hello timer reset.')
                    elif getEIGRPoptiface.get() == "Hold timer":
                        remote_conn.send("int " + eigrpoptiface.get() + " \n")
                        sleep(0.2)                
                        remote_conn.send("no ip hold-t eig " + txteigrppid.get + " " + eigrpopt1.get() + " \n")
                        tkMessageBox.showinfo('EIGRP Timer', 'Hold timer reset.')
                    elif getEIGRPoptiface.get() == "Static neighbor":
                        if eigrpopt1.get() == "" or eigrpopt1.get() == "<neigh_IP>":
                            tkMessageBox.showinfo('Error', 'Please enter a neighbor IP address.')
                        else:
                            remote_conn.send("no neighbor " + eigrpopt1.get() + " " + eigrpoptiface.get() + " \n")
                            tkMessageBox.showinfo('EIGRP', 'Static neighbor has been removed.')
                    elif getEIGRPoptiface.get() == "Passive int'face":
                        if "(" not in txteigrppid.get():
                            remote_conn.send(defeigrpcmd)
                        else:
                        ...
                        tkMessageBox.showinfo('EIGRP Passive', 'EIGRP process disabled for interface ' + eigrpoptiface.get() + '.')
                    elif getEIGRPoptiface.get() == "Bandwidth":
                            remote_conn.send("int " + eigrpoptiface.get() + " \n")
                            sleep(0.2)                
                            remote_conn.send("no bandwidth \n")
                            tkMessageBox.showinfo('EIGRP Bandwidth', 'Interface bandwidth has been reset.')                     
                    elif getEIGRPoptiface.get() == "Summary route":
                        if eigrpopt1.get() == "" or eigrpopt1.get() == "<net> <mask> [<AD>]":
                            tkMessageBox.showinfo('Error', 'Please enter a summary-address <<ip> <mask> [AD]> value.')
                        else:
                            ...
                            tkMessageBox.showinfo('EIGRP summary-address', 'Reset.')
                    elif getEIGRPoptiface.get() == "Filter adv'tised":
                        if eigrpopt1.get() == "" or eigrpopt1.get() == "<acl_no.> | prefix-l <> + i/o":
                            tkMessageBox.showinfo('Error', 'Please specify the <<ACL/prefix<pfxlist>> <in/out>>.')
                        else:
                            ...
                            tkMessageBox.showinfo('EIGRP Route Filter', 'EIGRP distribute list filtering removed.')
                    elif getEIGRPoptiface.get() == "Filter metric FD":
                        if eigrpopt1.get() == "" or eigrpopt1.get() == "<acl_no.> + i/o + offset_val":
                            tkMessageBox.showinfo('Error', 'Please specify the <<ACL> <in/out>>.')
                        else:
                            if "(" not in txteigrppid.get():
                                remote_conn.send(defeigrpcmd)
                            else:
                            ...
                            tkMessageBox.showinfo('EIGRP Metric Filter', 'EIGRP offset list filtering removed.')
                    elif getEIGRPoptiface.get() == "Authentication":
                        remote_conn.send("int " + eigrpoptiface.get() + " \n")
                        sleep(0.2)
                        remote_conn.send("no ip authentication mode eigrp " + txteigrppid.get() + " md5 \n")
                        sleep(0.2)
                        tkMessageBox.showinfo('EIGRP Authentication', 'Authentication disabled.')
                    else:
                        if "(" not in txteigrppid.get():
                            remote_conn.send(defeigrpcmd)
                        else:
                ...
                remote_conn.send("exit \n")
                sleep(0.2)
        btn = Button(EIGRPframe, text="Apply", bg="orange", command=eigrpifaceopt)
                ...
                if chk_state_neg.get() == False:
                    if getEIGRPoptdevice.get() == "Router-ID":
                        if eigrpopt2.get() == "" or eigrpopt2.get() == "eg. 1.1.1.1":
                            tkMessageBox.showinfo('Error', 'Please enter Router ID (IP) value.')
                        else:
                            remote_conn.send("eigrp router-id " + eigrpopt2.get() + " \n")
                            tkMessageBox.showinfo('EIGRP', 'Router-id has been set.')
                    elif getEIGRPoptdevice.get() == "Auto Summary":
                        remote_conn.send("auto \n")
                        tkMessageBox.showinfo('EIGRP', 'Auto summarization has been enabled.')
...
above to propagate at interface level\n - ')                        
                        ...
                        if eigrpopt2.get() == "" or eigrpopt2.get() == "<1-128>":
                            tkMessageBox.showinfo('Error', 'Please enter variance (1-128) value.')
                        else:
                            remote_conn.send("variance " + eigrpopt2.get() + " \n")
                            tkMessageBox.showinfo('EIGRP Unequal Cost Load Balancing', 'Variance multiplier ' + + eigrpopt1.get() + '*FD has been set.')
                    elif getEIGRPoptdevice.get() == "Stub":
                        ...
                        tkMessageBox.showinfo('EIGRP', res)
                    elif getEIGRPoptdevice.get() == "Max paths":
                        if eigrpopt2.get() == "" or eigrpopt2.get() == "<1-16>":
                            tkMessageBox.showinfo('Error', 'Please enter a value.')
                        else:
                            remote_conn.send("maximum-pa " + eigrpopt2.get() + " \n")
                            tkMessageBox.showinfo('EIGRP', 'Max paths has been configured.')                        
                    elif getEIGRPoptdevice.get() == "AD(int ext)":
                        if eigrpopt2.get() == "" or eigrpopt2.get() == "<1-255> [<1-255>]":
                            tkMessageBox.showinfo('Error', 'Please enter AD values.')
                        else:
                            remote_conn.send("distance eigrp " + eigrpopt2.get() + " \n")
                            tkMessageBox.showinfo('EIGRP', 'Distance has been configured.')
                    elif getEIGRPoptdevice.get() == "Selective AD(int)":
                        ...
                        if eigrpopt2.get() == "" or eigrpopt2.get() == "<0-255> <0-255> <0-255> <0-255> <0-255>":
                            tkMessageBox.showinfo('Error', 'Please enter all 5 (K1-K5) weight values.')
                        else:
                            remote_conn.send("metric weights 0 " + eigrpopt2.get() + " \n")
                            tkMessageBox.showinfo('EIGRP', 'Default metric weights has been configured.')
                else:
                    if getEIGRPoptdevice.get() == "Router-ID":
                        remote_conn.send("no eigrp router-id \n")
                        tkMessageBox.showinfo('EIGRP', 'Router-id has been removed.')
                    elif getEIGRPoptdevice.get() == "Auto Summary":
                        remote_conn.send("no auto \n")
                        tkMessageBox.showinfo('EIGRP', 'Auto summarization has been disabled.')
                    elif getEIGRPoptdevice.get() == "Propagate * route":
                        tkMessageBox.showinfo('EIGRP', 'Few ways to do this:\n  - create a default static route and Learn it\n  -  Use the "Summary route"\
above to propagate at interface level\n - ')                        
                    elif getEIGRPoptdevice.get() == "Variance":
                        remote_conn.send("no variance \n")
                        tkMessageBox.showinfo('EIGRP Unequal Cost Load Balancing', 'Variance multiplier has been removed.')
                    elif getEIGRPoptdevice.get() == "Stub":
                        remote_conn.send("no eigrp stub \n")
                        tkMessageBox.showinfo('EIGRP', 'Stub has been removed.')
                    elif getEIGRPoptdevice.get() == "Max paths":
                        remote_conn.send("no maximum-path \n")
                        tkMessageBox.showinfo('EIGRP', 'Max paths has been reset.')                        
                    elif getEIGRPoptdevice.get() == "AD(int ext)":                  
                        remote_conn.send("no distance eigrp \n")
                        tkMessageBox.showinfo('EIGRP', 'Distance has been reset.')
                    elif getEIGRPoptdevice.get() == "Selective AD(int)":
                        if eigrpopt2.get() == "" or eigrpopt2.get() == "<AD> <net> <wildcard> [acl_no.]":
                            tkMessageBox.showinfo('Error', 'Please enter required values.')
                        else:
                            remote_conn.send("no distance " + eigrpopt2.get() + " \n")
                            tkMessageBox.showinfo('EIGRP', 'Distance has been removed.')
                    else:
                        remote_conn.send("no metric weights \n")
                        tkMessageBox.showinfo('EIGRP', 'Metric weights has been reset to default.')
                remote_conn.send("exit \n")
                sleep(0.2)
                remote_conn.send("exit \n")
                sleep(0.2)                        
        btn = Button(EIGRPframe, text="Apply", bg="orange", command=eigrpotheropt)
        ...
        def eigrpredistribute():
            ...
            redistcmd = "redistribute " + getEIGoptredist.get()
            redistospfvrfcmd = "redistribute " + getEIGoptredist.get() + " vrf " + osvrf
            
            if chk_state_neg.get() == False:                
                if getEIGoptredist.get() == "RIP" or getEIGoptredist.get() == "EIGRP" or getEIGoptredist.get() == "BGP":
                    if txteigrppid.get() == "" or txteigrppid.get() == "eg. 15(MyVRF)AS1":
                        tkMessageBox.showinfo('Error', 'Please also enter the EIGRP process ID above.')
                    elif "(" in txteigrppid.get() and "AS" not in txteigrppid.get():
                        tkMessageBox.showinfo('Error', 'Please enter both the EIGRP PID VRF and AS number.')
                    elif "AS" in txteigrppid.get() and "(" not in txteigrppid.get():
                        tkMessageBox.showinfo('Error', 'Please enter both the EIGRP PID VRF and AS number.')
                        ...
                        if eigrpredistFilter.get() != "" and eigrpredistFilter.get() != "r-map":
                            redistcmd = redistcmd + " route-map " + eigrpredistFilter.get()
                        else:
                            pass
                        if eigrpredistMetric.get() != "" and eigrpredistMetric.get() != "Metric":
                            redistcmd = redistcmd + " metric " + eigrpredistMetric.get()
                        else:
                            pass
                        if eigrpredistTag.get() != "" and eigrpredistTag.get() != "Tag":
                            redistcmd = redistcmd + " tag " + eigrpredistTag.get()
                        else:
                            pass
                        remote_conn.send(redistcmd + "\n")
                        sleep(0.2)
                        tkMessageBox.showinfo('EIGRP redistribution', 'Learned ' + getEIGoptredist.get() + '.')
                else:
                    if txteigrppid.get() == "" or txteigrppid.get() == "eg. 15(MyVRF)AS1":
                        tkMessageBox.showinfo('Error', 'Please also enter the EIGRP process ID above.')
                    elif "(" in txteigrppid.get() and "AS" not in txteigrppid.get():
                ...
                if getEIGoptredist.get() == "RIP" or getEIGoptredist.get() == "EIGRP" or getEIGoptredist.get() == "BGP":
                    if txteigrppid.get() == "" or txteigrppid.get() == "eg. 15(MyVRF)AS1":
                        ...
                        remote_conn.send("no " + redistcmd + "\n")
                        sleep(0.2)
                        tkMessageBox.showinfo('EIGRP redistribution', 'Unlearned ' + getEIGoptredist.get() + '.')
                else:
                    if txteigrppid.get() == "" or txteigrppid.get() == "eg. 15(MyVRF)AS1":
                        tkMessageBox.showinfo('Error', 'Please also enter the EIGRP process ID above.')
                    elif "(" in txteigrppid.get() and "AS" not in txteigrppid.get():
        ...
        def enbgp():
            ...
            if chk_state_neg.get() == False:
                if (i == '') or (i == 'eg. 15(MyVRF)'):
                    tkMessageBox.showinfo('Error' + bgpproc.get(), 'Error - Please enter a BGP PID (AS number)')
                else:
                    ...
                    if 'is "bgp' in stripp and ((("(" not in bgpproc.get()) and (i not in checkbgp)) or (("(" in bgpproc.get()) and \
                        ...
                        sleep(0.5)
                        tkMessageBox.showinfo('Error', 'BGP AS ' + checkbgp + ' already exists. Only 1 BGP AS/process can be running at any time.')
                         ...
                         ((i.split("(",1)[0]) in output))):     #if have/not_have vrf and BGP AS in output, inform
                            tkMessageBox.showinfo('BGP ' + i, 'BGP process already running')
                    else:
                        remote_conn.send("conf t\n")
                        sleep(0.5)
                        ...
                        if (l != '') and (m != '') and (m != 'eg. 255.255.255.0'):
                            ...
                            pass
                        tkMessageBox.showinfo('BGP' + bgpproc.get(), bgpcomment)
                        remote_conn.send("exit \n")
                        sleep(0.5)
                        remote_conn.send("exit \n")
                        sleep(0.5)
                ...
                if (i == '') or (i == 'eg. 15(MyVRF)'):
                    ...
                    if 'is "bgp' in stripp and ("(" not in bgpproc.get()) and (i not in checkbgp):
                        ...
                        sleep(0.5)
                        tkMessageBox.showinfo('Error', bgprunningAS + ' already exists. Please input correct AS number to remove.')
                        ...
                        if ((j == '') or (j == 'Neighbor IP')) and ((k == '') or (k == 'Neighbor AS no.')) and (l == '') and ((m == '') or \
                         (m == 'eg. 255.255.255.0')):
                            ...
                            sleep(0.5)
                            tkMessageBox.showinfo('BGP', 'BGP ' + bgpproc.get() + ' disabled')
                        else:
                            if "(" not in bgpproc.get():
                                if AFIvar.get() == 1:
                                    remote_conn.send(defbgpcmd)
        ...
        def bgpotheropt():
            ...
            if chk_state_neg.get() == False:
                if (i == '') or (i == 'eg. 15(MyVRF)') or (j == '') or (j == 'Neighbor IP'):
                    tkMessageBox.showinfo('Error' + bgpproc.get(), 'Error - Please enter a BGP PID (AS number) and Neighbor IP')
                else:
                    remote_conn.send("sh ip proto | i bgp \n")
                    sleep(0.5)
                    output = remote_conn.recv(2048).decode("utf-8")
                    ...
                    if 'is "bgp' in stripp and ((("(" not in bgpproc.get()) and (i not in checkbgp)) or (("(" in bgpproc.get()) and \
                        ...
                        if getBGPoptdevice.get() == "Router-ID":
                            ...
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "<ASPATH_acl_no.> in/out":
                                ...
                                tkMessageBox.showinfo('BGP', 'Filter list has been configured to filter updates.')
                            ...
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "<r-map-name> in/out":
                                ...
                                tkMessageBox.showinfo('BGP', 'Path control configured. NOTE: Basic ones are Weight, LocalPref, AS prepending and MED.')
...
to "match" RECEIVED communities from peer routes to set a policy. Check w/ your provider for info on those community values.')
                        elif getBGPoptdevice.get() == "Send Ext Comm.":
                                remote_conn.send("neigh " + bgpneighip.get() + " send-comm ext \n")
                                sleep(0.5)
                                tkMessageBox.showinfo('BGP', 'Extended communities (eg. route-target info) are being sent.')
                        elif getBGPoptdevice.get() == "Conditional adv":
...
when rte-map ' + bgpoptvalue2.get() + ' is not in the BGP routing table.')
                        elif getBGPoptdevice.get() == "Conditional de-agg":
...
(specific pfx) will be advertised when rte-map ' + bgpoptvalue2.get() + ' (aggregate pfx) is in the BGP routing table.')
                        elif getBGPoptdevice.get() == "Dampening":
...
routes and "set dampening ..." to dampen them.')
                        elif getBGPoptdevice.get() == "Neighbor logging":
                            remote_conn.send("bgp log-neigh \n")
                            sleep(0.5)
                            tkMessageBox.showinfo('BGP logging', 'Neighbor changes are being logged.')
                        elif getBGPoptdevice.get() == "*Shut Peer":
                            remote_conn.send("neigh " + bgpneighip.get() + " shut \n")
                            sleep(0.5)
                            tkMessageBox.showinfo('BGP', 'Peering has been shutdown.')
                        else:
                            remote_conn.send("neigh " + bgpneighip.get() + " fall-over bfd \n")
                            sleep(0.3)
                            tkMessageBox.showinfo('BFD', 'BFD monitoring enabled for neighbor.')
                    ...
                    if 'is "bgp' in stripp and ((("(" not in bgpproc.get()) and (i not in checkbgp)) or (("(" in bgpproc.get()) and \
                        ...
                        if getBGPoptdevice.get() == "Router-ID":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "eg. 1.1.1.1":
                                ...
                                tkMessageBox.showinfo('BGP', 'Router-id has been removed.')
                        elif getBGPoptdevice.get() == "Auto Summary":
                            remote_conn.send("no auto \n")
                            tkMessageBox.showinfo('BGP', 'Auto summarization has been disabled.')
                        elif getBGPoptdevice.get() == "Synchronization":
                            remote_conn.send("no sync \n")
                            tkMessageBox.showinfo('BGP', 'Synchronization has been disabled.')                  
                        elif getBGPoptdevice.get() == "*Activate":
                            tkMessageBox.showinfo('BGP', 'ERROR / WARNING: This command has been removed for safety; deactivating an AF will also\
delete all config associated along with that specific AF.')
                        elif getBGPoptdevice.get() == "*Next-hop self":
                            remote_conn.send("neighbor " + bgpneighip.get() + " next-hop-unc \n")
                            tkMessageBox.showinfo('BGP', 'Network updates toward neighbor will utilize the source IP address of the "originating" router.')
                        elif getBGPoptdevice.get() == "*Basic timers":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "<hello> <hold> (sec)":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                remote_conn.send("no neighbor " + bgpneighip.get() + " timers " + bgpoptvalue1.get() + " \n")
                                tkMessageBox.showinfo('BGP', 'Keepalive & Hold timers has been reset.')
                        elif getBGPoptdevice.get() == "Scan timer":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "<5-60> (sec)":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                remote_conn.send("no bgp scan-time " + bgpoptvalue1.get() + " \n")                            
                                tkMessageBox.showinfo('BGP', 'Scan timer has been reset.')
                        elif getBGPoptdevice.get() == "*Update Source":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "eg. lo0":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                remote_conn.send("no neighbor " + bgpneighip.get() + " update-so " + bgpoptvalue1.get() + " \n")
                                tkMessageBox.showinfo('BGP', 'All BGP updates will NOT be sent from interface ' + bgpoptvalue1.get() + '.')
                        elif getBGPoptdevice.get() == "*TTL Sec":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "<1-254 (hops)>":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                remote_conn.send("no neighbor " + bgpneighip.get() + " ttl-sec hops " + bgpoptvalue1.get() + " \n")
                                tkMessageBox.showinfo('BGP', 'TTL Security has been deactivated.')
                        elif getBGPoptdevice.get() == "*Password":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "eg. MyPassword":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                remote_conn.send("no neighbor " + bgpneighip.get() + " password " + bgpoptvalue1.get() + " \n")
                                tkMessageBox.showinfo('BGP', 'MD5 password has been removed for this peer.')
                        elif getBGPoptdevice.get() == "Create Peer Grp":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "eg. MyPeerGroup":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                remote_conn.send("no neighbor " + bgpneighip.get() + " " + bgpoptvalue1.get() + " \n")
                                tkMessageBox.showinfo('BGP', 'Peer Group has been deleted.')
                        elif getBGPoptdevice.get() == "*Enable Peer Grp":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "eg. MyPeerGroup":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                remote_conn.send("no neighbor " + bgpneighip.get() + " peer-g " + bgpoptvalue1.get() + " \n")
                                tkMessageBox.showinfo('BGP', 'Peer Group has been disabled.')                            
                        elif getBGPoptdevice.get() == "*ReflectorClient":
                            remote_conn.send("no neighbor " + bgpneighip.get() + " route-ref \n")
                            tkMessageBox.showinfo('BGP', 'Neighbor is no longer a route reflector client.')
                        elif getBGPoptdevice.get() == "*Transport mode":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "Active | Passive":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                remote_conn.send("no neighbor " + bgpneighip.get() + " transport connection-m " + bgpoptvalue1.get() + " \n")
                                tkMessageBox.showinfo('BGP', 'Transport state reset.')
                        elif getBGPoptdevice.get() == "*Soft-reconfig in":
                            remote_conn.send("no neighbor " + bgpneighip.get() + " soft-reconfig in \n")
                            tkMessageBox.showinfo('BGP', 'Soft reconfiguration disabled. You now can Reset BGP(soft) to use this feature.')
                        elif getBGPoptdevice.get() == "*Propagate * route":
                            remote_conn.send("no default-info orig \n")
                            tkMessageBox.showinfo('BGP', 'Default route is no longer propagated.')
                        elif getBGPoptdevice.get() == "*Max Prefixes":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "eg. 20":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                remote_conn.send("no neighbor " + bgpneighip.get() + " maximum-pref " + bgpoptvalue1.get() + " \n")
                                tkMessageBox.showinfo('BGP', 'Maximum prefixes able to be learnt has been removed.')
                        elif getBGPoptdevice.get() == "Max AS":
                            remote_conn.send("no bgp maxas-limit \n")
                            tkMessageBox.showinfo('BGP', 'Maximum ASes able to be learnt has been reset.')
                        elif getBGPoptdevice.get() == "Max Paths":
                            remote_conn.send("no maximum-paths " + bgpoptvalue1.get() + " \n")
                            tkMessageBox.showinfo('BGP', 'Maximum paths for BGP ECMP has been reset.')                          
                        elif getBGPoptdevice.get() == "AD(ext int loc)":
                            remote_conn.send("no distance bgp \n")
                            tkMessageBox.showinfo('BGP', 'Administrative distance for eBGP, iBGP and local routes has been reset.')
                        elif getBGPoptdevice.get() == "Selective AD(ext)":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "<1-255> <net> <wildcard> [acl_no.]":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                remote_conn.send("no distance " + bgpoptvalue1.get() + " \n")
                                tkMessageBox.showinfo('BGP', 'eBGP administrative distance for a specific network has been removed.')
                        elif getBGPoptdevice.get() == "Summary route":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "<net> <mask> [summary-only] [route-m <>]":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                remote_conn.send("no aggregate-addr " + bgpoptvalue1.get() + " \n")
                                tkMessageBox.showinfo('BGP', 'Aggregate/summarized address has been removed.')
                        elif getBGPoptdevice.get() == "*Adv filter":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "<pfxlist> in/out":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                remote_conn.send("no neighbor " + bgpneighip.get() + " prefix-l " + bgpoptvalue1.get() + " \n")
                                tkMessageBox.showinfo('BGP', 'Prefix list has been removed.')
                        elif getBGPoptdevice.get() == "*AS Path filter":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "<ASPATH_acl_no.> in/out":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                remote_conn.send("no neighbor " + bgpneighip.get() + " filter-l " + bgpoptvalue1.get() + " \n")
                                tkMessageBox.showinfo('BGP', 'Filter list has been removed.')
                        elif getBGPoptdevice.get() == "*Path Control":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "<r-map-name> in/out":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                remote_conn.send("no neighbor " + bgpneighip.get() + " route-m " + bgpoptvalue1.get() + " \n")
                                tkMessageBox.showinfo('BGP', 'Path control removed. HINT: Basic ones are Weight, LocalPref, AS prepending and MED.')
                        elif getBGPoptdevice.get() == "*Community":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "<r-map-name> in/out":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                ...
                                sleep(0.5)
                                tkMessageBox.showinfo('BGP', 'Community has been removed. NOTE: send-community will still be enabled.')
                        elif getBGPoptdevice.get() == "Send Ext Comm.":
                                remote_conn.send("no neigh " + bgpneighip.get() + " send-comm ext \n")
                                sleep(0.5)
                                tkMessageBox.showinfo('BGP', 'Extended communities (eg. route-target info) are NOT being sent.')
                        elif getBGPoptdevice.get() == "Conditional adv":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "<r-map1(to adv)> <r-map2(if nonexist)>":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                ...
                                remote_conn.send("no neigh " + bgpneighip.get() + " advertise-map " + rtemap1 + " non-exist-map "\
                                                 + rtemap2 + " \n")
                                tkMessageBox.showinfo('BGP', 'Conditional advertisement removed.')
                        elif getBGPoptdevice.get() == "Conditional de-agg":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "<r-map1(to adv)> <r-map2(if exist)>":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                ...
                                remote_conn.send("no neigh " + bgpneighip.get() + " inject-map " + rtemap1 + " exist-map "\
                                                 + rtemap2 + " \n")
                                tkMessageBox.showinfo('BGP', 'Conditional de-aggregate advertisement removed.')
                        elif getBGPoptdevice.get() == "Dampening":
                            if bgpoptvalue1.get() == "" or bgpoptvalue1.get() == "<half-life><reuse><suppress><max-suppr>":
                                tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                            else:
                                remote_conn.send("no bgp dampening " + bgpoptvalue1.get() + " \n")
                                tkMessageBox.showinfo('BGP', 'Route dampening has been disabled.')
                        elif getBGPoptdevice.get() == "Neighbor logging":
                            remote_conn.send("no bgp log-neigh \n")
                            sleep(0.5)
                            tkMessageBox.showinfo('BGP logging', 'Neighbor changes are NOT being logged.')
                        elif getBGPoptdevice.get() == "*Shut Peer":
                            remote_conn.send("no neigh " + bgpneighip.get() + " shut \n")
                            sleep(0.5)
                            tkMessageBox.showinfo('BGP', 'Peering has been re-enabled.')
                        else:
                            remote_conn.send("no neigh " + bgpneighip.get() + " fall-over bfd \n")
                            sleep(0.3)
                            tkMessageBox.showinfo('BFD', 'BFD monitoring disabled for neighbor.')                            
            remote_conn.send("exit \n")
            sleep(0.5)
            remote_conn.send("exit \n")
            sleep(0.5)
        btn = Button(BGPframe, text="Apply", bg="orange", command=bgpotheropt)
        btn.grid(column=5, row=9)
        ...
        def bgpredistribute():
            ...
            redistcmd = "redistribute " + getBGPoptredist.get()
            redistospfvrfcmd = "redistribute " + getBGPoptredist.get() + " vrf " + bgvrf2
            ...
            if chk_state_neg.get() == False:                
                if getBGPoptredist.get() == "RIP" or getBGPoptredist.get() == "EIGRP" or getBGPoptredist.get() == "BGP":
                    if bgpproc.get() == "" or bgpproc.get() == "eg. 15(MyVRF)":
                        tkMessageBox.showinfo('Error', 'Please also enter the BGP process ID above.')
                    else:
                        remote_conn.send("conf t \n")
                        sleep(0.2)                        
                        if "(" not in bgpproc.get():
                        ...
                        if bgpredistFilter.get() != "" and bgpredistFilter.get() != "r-map":
                            redistcmd = redistcmd + " route-map " + bgpredistFilter.get()
                        else:
                            pass
                        if bgpredistMetric.get() != "" and bgpredistMetric.get() != "Metric":
                            redistcmd = redistcmd + " metric " + bgpredistMetric.get()
                        else:
                            pass
                        if bgpredistTag.get() != "" and bgpredistTag.get() != "Tag":
                            redistcmd = redistcmd + " tag " + bgpredistTag.get()
                        else:
                            pass
                        remote_conn.send(redistcmd + "\n")
                        sleep(0.2)
                        tkMessageBox.showinfo('BGP redistribution', 'Learned ' + getBGPoptredist.get() + '.')
                else:
                    if bgpproc.get() == "" or bgpproc.get() == "eg. 15(MyVRF)":
                        tkMessageBox.showinfo('Error', 'Please also enter the BGP process ID above.')
                    else:
                ...
                if getBGPoptredist.get() == "RIP" or getBGPoptredist.get() == "EIGRP" or getBGPoptredist.get() == "BGP":
                    if bgpproc.get() == "" or bgpproc.get() == "eg. 15(MyVRF)":
                        ...
                        remote_conn.send("no " + redistcmd + "\n")
                        sleep(0.2)
                        tkMessageBox.showinfo('BGP redistribution', 'Unlearned ' + getBGPoptredist.get() + '.')
                else:
                    if bgpproc.get() == "" or bgpproc.get() == "eg. 15(MyVRF)":
                        tkMessageBox.showinfo('Error', 'Please also enter the BGP process ID above.')
                    else:
        ...
        def createvrf():
            if chk_state_neg.get() == False:
                if getVRF.get() == '' :
                    tkMessageBox.showinfo('Error', 'Please enter a VRF name.')
                    ...
                    tkMessageBox.showinfo('VRF', 'VRF created.')
                elif getVRF.get() != '' and (getVRFrd.get() != '' or getVRFrd.get() != 'eg. 100:200') and (getVRFrtarget.get() == ''\
                     or getVRFrtarget.get() == 'eg. 100:200'):
                    remote_conn.send("conf t\n")
                    sleep(0.5)
                    ...
                    sleep(0.5)
                    tkMessageBox.showinfo('VRF' + getVRF.get(), 'Route distinguisher created.')
                elif getVRF.get() != '' and (getVRFrd.get() == '' or getVRFrd.get() == 'eg. 100:200') and (getVRFrtarget.get() != '' \
                    or getVRFrtarget.get() != 'eg. 100:200'):
                    remote_conn.send("conf t\n")
                    sleep(0.5)
                    ...
                    sleep(0.5)
                    tkMessageBox.showinfo('VRF' + getVRF.get(), 'Route target created.')                        
                else:
                    remote_conn.send("conf t\n")
                    sleep(0.5)
                    remote_conn.send("ip vrf " + getVRF.get() + "\n")
                    ...
                    remote_conn.send("route-target " + getVRFrtargetdir.get() + " " + getVRFrtarget.get() + "\n")
                    sleep(0.5)                        
                    tkMessageBox.showinfo('VRF' + getVRF.get(), 'Route distinguisher and route-target created.')
            else:
                if getVRF.get() == '':
                    tkMessageBox.showinfo('Error', 'Please enter a VRF name.')
                else:
                    ...
                    if getVRFrd.get() != '' and getVRFrtarget.get() != '':
                        ...
                        sleep(0.5)
                        tkMessageBox.showinfo('VRF' + getVRF.get(), 'Route distinguisher and route target removed.')
                    elif getVRFrd.get() != '' and getVRFrtarget.get() == '':
                        remote_conn.send("ip vrf " + getVRF.get() + "\n")
                        sleep(0.5)                    
                        remote_conn.send("no rd " + getVRFrd.get() + "\n")
                        sleep(0.5)
                        tkMessageBox.showinfo('VRF' + getVRF.get(), 'Route distinguisher removed.')
                    elif getVRFrtarget.get() != '' and getVRFrd.get() == '':
                        remote_conn.send("ip vrf " + getVRF.get() + "\n")
                        sleep(0.5)                    
                        remote_conn.send("no route-target " + getVRFrtargetdir.get() + " " + getVRFrtarget.get() + "\n")
                        sleep(0.5)
                        tkMessageBox.showinfo('VRF' + getVRF.get(), 'Route target removed.')
                    else:
                        remote_conn.send("no vrf " + getVRF.get() + "\n")
                        sleep(0.5)
                        tkMessageBox.showinfo('VRF' + getVRF.get(), 'VRF removed.')
            sleep(0.5)
            remote_conn.send("exit \n")
            sleep(0.5)
            remote_conn.send("exit \n")                                                
        btn = Button(basicVRFframe, text="Apply", bg="orange", command=createvrf)
...
This is used to share routes (connected routes, static routes or routes from another routing protocol) to a routing protocol. You can share specific routes with the "route-map" option.')
        ...
        def bgpusagehelp():
            ...
            tkMessageBox.showinfo('BGP usage help', res)
...
OSPF default Metric Calculation:\n\
 ...
 - Best route = Route which has the lowest Cumulative cost')
 ...
 ')
        ...
        def showroute():
            if showrouteopt.get() == "Active routes":
                ...
                tkMessageBox.showinfo('Active routes', output)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Static routes', output)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Route summary', output)
            elif showrouteopt.get() == "Active protocols":
                buff_size = 16384
                sleep(0.5)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Active protocols', output)
            elif showrouteopt.get() == "Protocol detail:":
                if showopt.get() == "" or showopt.get() == "eg. eigrp, ospf 2":
                    tkMessageBox.showinfo('Error', 'Please enter a routing protocol.')
                else:
                    buff_size = 16384
                    sleep(0.5)
                    ...
                    while not remote_conn.recv_ready():
                        ...
                        sleep(0.5)
                    output = remote_conn.recv(buff_size).decode("utf-8")
                    tkMessageBox.showinfo('Protocol detail', output)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('VRF information', output)
            elif showrouteopt.get() == "Clear route(s)":
                if showopt.get() == "" or showopt.get() == "[vrf <>] * | x.x.x.x":
                    remote_conn.send("clear ip route * \n")
                    sleep(0.5)
                    tkMessageBox.showinfo('Clear routes', 'All routes cleared.')
                else:
                    buff_size = 16384
                    sleep(0.5)
                    remote_conn.send("clear ip route " + showopt.get() + " \n")
                    sleep(0.5)         
                    tkMessageBox.showinfo('Clear routes', 'Route cleared.')
            else:
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Route protocol', output)
        ...
        def showproto():
            if showprotopt.get() == "RIP":
                if showopt2.get() == "" or showopt2.get() == "[database | neigh [<>]]":
                    tkMessageBox.showinfo('Error', 'Please enter an option.')
                else:
                    buff_size = 16384
                    sleep(0.5)
                    ...
                    while not remote_conn.recv_ready():
                        ...
                        sleep(0.5)
                    output = remote_conn.recv(buff_size).decode("utf-8")
                    tkMessageBox.showinfo('RIP', output)
            elif showprotopt.get() == "EIGRP" or showprotopt.get() == "OSPF":
                if showopt2.get() == "" or showopt2.get() == "[database | neigh [<>] | interface]":
                    ...
                    while not remote_conn.recv_ready():
                        ...
                        sleep(0.5)
                    output = remote_conn.recv(buff_size).decode("utf-8")
                    tkMessageBox.showinfo(chosenproto, output)
            elif showprotopt.get() == "EIGRP/OSPF reset":
                sleep(0.5)
                remote_conn.send("clear ip " + chosenproto + " " + showopt2.get() + " \n")
                sleep(0.5)
                tkMessageBox.showinfo(chosenproto, "Protocol has been reset.")                   
            elif showprotopt.get() == "BGP":
                if showopt2.get() == "" or showopt2.get() == "[neigh [<>] | summary]":
                    ...
                    while not remote_conn.recv_ready():
                        ...
                        sleep(0.5)
                    output = remote_conn.recv(buff_size).decode("utf-8")
                    tkMessageBox.showinfo('BGP', output)
            elif showprotopt.get() == "BGP Reset":
                remote_conn.send("clear ip bgp " + showopt2.get() + " \n")
                sleep(0.5)         
                tkMessageBox.showinfo('Clear BGP', 'BGP process has been reset.')
            elif showprotopt.get() == "BGP adv(filtered) rtes:":
                if showopt2.get() == "":
                    tkMessageBox.showinfo("Error", "Please enter BGP neighbor's IP address to view (filtered) routes advertised to it.")
                else:
                    buff_size = 16384
                    sleep(0.5)
                    ...
                    while not remote_conn.recv_ready():
                        ...
                        sleep(0.5)
                    output = remote_conn.recv(buff_size).decode("utf-8")
                    tkMessageBox.showinfo('BGP advertised (filtered) routes', output)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('BGP advertised (unfiltered) routes', output)   
            elif showprotopt.get() == "BGP rcv(filtered) rtes:":
                if showopt2.get() == "":
                    tkMessageBox.showinfo("Error", "Please enter BGP neighbor's IP address to view (before filtering) routes advertised to it.")
                else:
                    buff_size = 16384
                    sleep(0.5)
                    ...
                    while not remote_conn.recv_ready():
                        ...
                        sleep(0.5)
                    output = remote_conn.recv(buff_size).decode("utf-8")
                    tkMessageBox.showinfo('BGP advertised routes', output)
            elif showprotopt.get() == "BGP rcv(raw) rtes:":
                if showopt2.get() == "":
                    tkMessageBox.showinfo("Error", "Please enter BGP neighbor's IP address to view routes received (before filtering) from it.")
                else:
                    buff_size = 16384
                    sleep(0.5)
                    ...
                    while not remote_conn.recv_ready():
                        ...
                        sleep(0.5)
                    output = remote_conn.recv(buff_size).decode("utf-8")
                    tkMessageBox.showinfo('BGP received routes', output)
                    ...
                    while not remote_conn.recv_ready():
                        ...
                        sleep(0.5)
                    output = remote_conn.recv(buff_size).decode("utf-8")
                    tkMessageBox.showinfo('BGP dampening', output)
    ...
    def switch():
        ...
        def createvlan():
            if createv.get() == "" or createv.get() == "e.g. 1, 4094, 3-15":
                tkMessageBox.showinfo('Error', 'Please enter VLAN ID.')
            else:
                if chk_state_neg.get() == False:
                    remote_conn.send("conf t\n")
                    sleep(0.2)
                    ...
                    sleep(0.2)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('VLAN ' + createv.get(), 'VLAN has been created.')
                else:
                    remote_conn.send("conf t\n")
                    sleep(0.2)
                    ...
                    sleep(0.2)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('VLAN ' + createv.get(), 'VLAN has been removed.')                
        btn = Button(VLANframe, text="Apply", bg="orange", command=createvlan)
        ...
        lbl = Label(Switchframe, text="Apply VLAN id to interface:").grid(column=0, row=3)
        getvlan = Entry(Switchframe, bg='white', width=38, fg='grey')
        getvlan.grid(column=1, row=3)
        getvlan.insert(0, "e.g. 20, 3-15 (only apply range to TRUNKS)")
        def handle_focus_in(_):
        ...
        def setvlan():
            if getportmode.get() == "Mode" or getvlan.get() == "" or getvlan.get() == "e.g. 20, 3-15 (only apply range to TRUNKS)"\
            or getiface.get() == "" or getiface.get() == "e.g. Eth0/0":
                    tkMessageBox.showinfo('Error', 'Please enter VLAN ID, interface, and choose switchport mode.')
            else:
                if chk_state_neg.get() == False:
                    if getportmode.get() == "Access":                    
                        ...
                        tkMessageBox.showinfo('VLAN id' + createvlan.get(), res)
                        ...
                        tkMessageBox.showinfo('VLAN id', res)
                else:
                    if getportmode.get() == "Access":                    
                        remote_conn.send("conf t\n")
                        sleep(0.2)
                        ...
                        tkMessageBox.showinfo('VLAN id', res)                    
        btn = Button(Switchframe, text="Apply", bg="orange", command=setvlan)
        btn.grid(column=1, row=4)
        ...
        def settrunk():
            if gettrkmode.get() == "Mode" or getiface1.get() == "" or getiface1.get() == "e.g. Eth0/0":
                    tkMessageBox.showinfo('Error', 'Please enter interface and choose switchport mode.')
                ...
                sleep(0.2)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('Switchport Mode', 'Port set to Access mode')    
                ...
                sleep(0.2)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('Switchport Mode', 'Port set to enforced Trunking')
                ...
                sleep(0.2)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('Switchport Mode', 'Port set to Dynamic Auto Trunking')
            else:
                remote_conn.send("conf t\n")
                sleep(0.2)
                remote_conn.send("int " + getiface1.get() + "\n")
                ...
                sleep(0.2)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('Switchport Mode', 'Port set to Dynamic Desirable Trunking')                                
        btn = Button(Switchframe, text="Apply", bg="orange", command=settrunk)
        btn.grid(column=1, row=6)
        ...
        def STPclick():
            if chk_state_neg.get() == False:
                if STPopt.get() == "Enable STP":
                    ...
                    sleep(0.2)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('Spanning Tree Configuration', 'STP enabled with selected mode.') 
                elif STPopt.get() == "STP fwd_time":
                    if createv.get() == "" or createv.get() == "e.g. 1, 4094, 3-15":
                        tkMessageBox.showinfo('ERROR', 'Please enter a VLAN ID above.')
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP forward-time interval configured.')
                elif STPopt.get() == "STP hello_time":
                    if createv.get() == "" or createv.get() == "e.g. 1, 4094, 3-15":
                        tkMessageBox.showinfo('ERROR', 'Please enter a VLAN ID above.')
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP hello-time interval configured.')
                elif STPopt.get() == "STP max_age":
                    if createv.get() == "" or createv.get() == "e.g. 1, 4094, 3-15":
                        tkMessageBox.showinfo('ERROR', 'Please enter a VLAN ID above.')
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP max-age configured.')
                elif STPopt.get() == "STP priority":
                    if createv.get() == "" or createv.get() == "e.g. 1, 4094, 3-15":
                        tkMessageBox.showinfo('ERROR', 'Please enter a VLAN ID above.')
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP bridge priority configured.')
                elif STPopt.get() == "STP root":
                    if createv.get() == "" or createv.get() == "e.g. 1, 4094, 3-15":
                        tkMessageBox.showinfo('ERROR', 'Please enter a VLAN ID above.')
                    elif STPinput.get() == "" or STPinput.get() == "pri|sec [dia <2-7> [hello <1-10>]]":
                        tkMessageBox.showinfo('ERROR', 'Please enter required value(s).')
                    else:
                        remote_conn.send("conf t\n")
                        sleep(0.2)
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP root bridge configured.')
                else:
                    remote_conn.send("conf t\n")
                    sleep(0.2)
                    ...
                    sleep(0.2)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('Spanning Tree Configuration', 'STP logging enabled.')
            else:
                if STPopt.get() == "Enable STP":
                    if createv.get() == "" or createv.get() == "e.g. 1, 4094, 3-15":
                        cmd = "no spanning-t \n"
                    ...
                    sleep(0.2)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('Spanning Tree Configuration', res) 
                elif STPopt.get() == "STP fwd_time":
                    if createv.get() == "" or createv.get() == "e.g. 1, 4094, 3-15":
                        tkMessageBox.showinfo('ERROR', 'Please enter a VLAN ID above.')
                    else:
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP forward-time reset.')
                elif STPopt.get() == "STP hello_time":
                    if createv.get() == "" or createv.get() == "e.g. 1, 4094, 3-15":
                        tkMessageBox.showinfo('ERROR', 'Please enter a VLAN ID above.')
                    else:
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP hello-time reset.')
                elif STPopt.get() == "STP max_age":
                    if createv.get() == "" or createv.get() == "e.g. 1, 4094, 3-15":
                        tkMessageBox.showinfo('ERROR', 'Please enter a VLAN ID above.')
                    else:
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP max-age reset.')
                elif STPopt.get() == "STP priority":
                    if createv.get() == "" or createv.get() == "e.g. 1, 4094, 3-15":
                        tkMessageBox.showinfo('ERROR', 'Please enter a VLAN ID above.')
                    else:
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP bridge priority reset.')
                elif STPopt.get() == "STP root":
                    if createv.get() == "" or createv.get() == "e.g. 1, 4094, 3-15":
                        tkMessageBox.showinfo('ERROR', 'Please enter a VLAN ID above.')
                    else:
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP root bridge reset.')
                else:
                    remote_conn.send("conf t\n")
                    sleep(0.2)
                    ...
                    sleep(0.2)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('Spanning Tree Configuration', 'STP logging disabled.')                
        btn = Button(STPframe, text="Apply", bg="orange", command=STPclick)
        btn.place(x=400, y=0)
        ...
        def STPfeatclick():
            if STPfeatopt.get() == "Features":
                tkMessageBox.showinfo('ERROR', 'Please choose an option.')
            else:
                if chk_state_neg.get() == False:
                    if STPfeatopt.get() == "STP portfast" or STPfeatopt.get() == "STP rootguard" or STPfeatopt.get() == "STP loopguard" or STPfeatopt.get() == "STP BPDUguard" or \
                       STPfeatopt.get() == "STP BPDUfilter":
                        if STPfeatinput.get() == "" or STPfeatinput.get() == "eg. e0/0":
                            tkMessageBox.showinfo('ERROR', 'Please enter an interface.')
                        else:
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP backbonefast enabled globally.')
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP uplinkfast enabled globally.')
                    else:
                        remote_conn.send("conf t\n")
                        sleep(0.2)
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP Etherchannel misconfiguration guard enabled globally.')
                else:
                    if STPfeatopt.get() == "STP portfast" or STPfeatopt.get() == "STP rootguard" or STPfeatopt.get() == "STP loopguard" or STPfeatopt.get() == "STP BPDUguard" or \
                       STPfeatopt.get() == "STP BPDUfilter":
                        if STPfeatinput.get() == "" or STPfeatinput.get() == "eg. e0/0":
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP backbonefast disabled globally.')
                    elif STPopt.get() == "STP uplinkfast":
                        remote_conn.send("conf t\n")
                        sleep(0.2)
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP uplinkfast disabled globally.')
                    else:
                        remote_conn.send("conf t\n")
                        sleep(0.2)
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Spanning Tree Configuration', 'STP Etherchannel misconfiguration guard disabled globally.')                    
        btn = Button(STPframe, text="Apply", bg="orange", command=STPfeatclick)
        btn.place(x=400, y=30)
        ...
        def showvlan():
            if showVLANopt.get() == "VLAN (id)":
                if shvlanid.get() == '' or shvlanid.get() == '<1-4094>':
                    tkMessageBox.showinfo('Error', 'Please enter a VLAN ID.')
                else:
                    buff_size = 16384
                    sleep(0.5)
                    ...
                    while not remote_conn.recv_ready():
                        ...
                        sleep(0.5)
                    output = remote_conn.recv(buff_size).decode("utf-8")
                    tkMessageBox.showinfo('VLAN info', output)
            else:
        ...
        def showportdtpvtp():
            if showportopt.get() == "SwitchPort":
                if shport.get() == '' or shport.get() == 'eg. fa0/0':
                    tkMessageBox.showinfo('Error', 'Please enter an interface (eg. fa0/0).')
                else:
                    buff_size = 16384
                    sleep(0.5)
                    ...
                    while not remote_conn.recv_ready():
                        ...
                        sleep(0.5)
                    output = remote_conn.recv(buff_size).decode("utf-8")
                    tkMessageBox.showinfo('Switchport info', output)
                ...
                if shport.get() == '' or shport.get() == 'eg. fa0/0':
                    ...
                    while not remote_conn.recv_ready():
                        ...
                        sleep(0.5)
                    output = remote_conn.recv(buff_size).decode("utf-8")
                    tkMessageBox.showinfo('DTP info', output)
            elif showportopt.get() == "VTP":
                if shport.get() == '' or shport.get() == 'status | counters | password':
                    tkMessageBox.showinfo('Error', 'Please enter an option (eg. status).')
                else:
                    buff_size = 16384
                    sleep(0.5)
                    ...
                    while not remote_conn.recv_ready():
                        ...
                        sleep(0.5)
                    output = remote_conn.recv(buff_size).decode("utf-8")
                    tkMessageBox.showinfo('VTP info', output)
            else:
                buff_size = 16384
                sleep(0.5)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Trunk info', output)
        ...
        def showSTP():
            if showSTPopt.get() == "STP interface":
                if shstp.get() == '' or shstp.get() == 'eg. fa0/0, vlan 1':
                    tkMessageBox.showinfo('Error', 'Please enter an interface or VLAN interface (eg. fa0/0, vlan 1).')
                else:
                    buff_size = 16384
                    sleep(0.5)
                    ...
                    while not remote_conn.recv_ready():
                        ...
                        sleep(0.5)
                    output = remote_conn.recv(buff_size).decode("utf-8")
                    tkMessageBox.showinfo('Spanning Tree Info', output)
            elif showSTPopt.get() == "STP detail":
                if shstp.get() == '' or shstp.get() == 'eg. Ethernet0/0, FastEthernet0/0':
                    tkMessageBox.showinfo('Error', 'Please enter an interface (eg. Ethernet0/0, FastEthernet0/0).')
                else:
                    buff_size = 16384
                    sleep(0.5)
    ...
    def DHCP():
        ...
        def dhcpserverlease():
            if chk_state_neg.get() == False:
                if poolname.get() == "" or leasesubnet.get() == "" or leasesubnet.get() == "e.g. 192.168.1.0" or leasemask.get() == "" or\
                    ...
                    tkMessageBox.showinfo('Error', 'Minimal requirement is to enter a Pool Name, Lease Subnet and Lease Subnet Mask.')
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.2)
                    ...
                    tkMessageBox.showinfo('DHCP', res)
            else:
                remote_conn.send("conf t \n")
                sleep(0.2)
                ...
                and (leasemask.get() != "" or leasemask.get() != "e.g. 255.255.255.0"):
                    ...
                    remote_conn.send("exit \n")
                    sleep(0.2)
                    tkMessageBox.showinfo('DHCP', 'Network removed')                     
                    ...
                    remote_conn.send("exit \n")
                    sleep(0.2)
                    tkMessageBox.showinfo('DHCP', 'Default router configured.')                      
                    ...
                    remote_conn.send("exit \n")
                    sleep(0.2)
                    tkMessageBox.showinfo('DHCP', 'Lease time configured.')                     
                    ...
                    remote_conn.send("exit \n")
                    sleep(0.2)
                    tkMessageBox.showinfo('DHCP', 'DNS servers configured for pool.')
                ...
                defaultgateway.get() != "e.g. 192.168.1.254") and (leasetime.get() != "" and leasetime.get() != "e.g. 2 5 == 2 days 5 hrs"):
                    ...
                    remote_conn.send("exit \n")
                    sleep(0.2)
                    tkMessageBox.showinfo('DHCP', 'DHCP pool ' + poolname.get() + ' deleted.')
                else:
                    tkMessageBox.showinfo('Error', 'To negate, please fill up required fields: Poolname + network/default-router/lease time/DNS.\
                                                    Or, just enter poolname to delete.')                    
        btn = Button(dhcpframe, text="Apply DHCP server", bg="orange", command=dhcpserverlease)
        btn.grid(column=1, row=6)
        ...
        def dhcpserverexc():
            if chk_state_neg.get() == False:            
                ...
                sleep(0.2)               
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('DHCP excluded', 'DCHP range has been excluded from leasing to clients.')
            else:
                remote_conn.send("conf t \n")
                sleep(0.2)             
                ...
                sleep(0.2)               
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('DHCP excluded', 'DCHP excluded range has been removed.')                
        btn = Button(dhcpframe, text="Apply excluded", bg="orange", command=dhcpserverexc)
...
#        shDHCPopt.trace("w", option_changed_shDHCPopt)
        ...
        def cleardhcp():
            ...
            output = remote_conn.recv(buff_size).decode("utf-8")
            sleep(0.2)
            tkMessageBox.showinfo('DHCP', output)
    ...
    def ACL():
        ...
        def stdaclclicked():
            if chk_state_neg.get() == True:
                ...
                if (permitoptn1.get() == "Allow") and (chk_state_logacl.get() == True):
                    ...
                    tkMessageBox.showinfo('ACL', res)                    
        btn = Button(aclframe, text="Apply Std ACL", bg="orange", command=stdaclclicked)
        btn.grid(column=2, row=2)
        ...
        def extaclclicked():
            if chk_state_neg.get() == True:
                ...
                if (permitoptn2.get() == "Allow") and (chk_state_logacl.get() == True):
                    ...
                    tkMessageBox.showinfo('ACL', res)            
        btn = Button(aclframe, text="Apply Ext ACL", bg="orange", command=extaclclicked)
        ...
        def macaclclicked():
            if chk_state_neg.get() == True:
                ...
                if (permitoptn3.get() == "Allow") and (chk_state_logacl.get() == True):
                    ...
                    tkMessageBox.showinfo('ACL', res)                    
        btn = Button(aclframe, text="Apply MAC ACL", bg="orange", command=macaclclicked)
        ...
        setaclframe=LabelFrame(window,text=" Apply ACL to interface or VTY ",font=('verdana', 8, 'bold'),padx=70,pady=5,width=100,height=100)
        ...
        def setaclclick():
            ...
            sleep(0.5)
            if chk_state_neg.get() == False:            
                remote_conn.send("ip access-group " + getsetacl.get() + " " + getdir.get() + "\n")
                sleep(0.5)
                remote_conn.send("exit \n")
                sleep(0.5)
                remote_conn.send("exit \n")
                res = "ACL " + getsetacl.get() + " has been applied to interface " + getiface.get()
                tkMessageBox.showinfo('ACL', res)
            else:
                remote_conn.send("no ip access-group " + getsetacl.get() + " " + getdir.get() + "\n")
                sleep(0.5)
                remote_conn.send("exit \n")
                sleep(0.5)
                remote_conn.send("exit \n")
                res = "ACL " + getsetacl.get() + " has been removed from interface " + getiface.get()
                tkMessageBox.showinfo('ACL', res)                    
        btn = Button(setaclframe, text="Apply ACL", bg="orange", command=setaclclick)
        btn.grid(column=3, row=15)

        def showaclintconf():
            if getiface.get() == '' or getiface.get() == 'eg. fa0/0':
                tkMessageBox.showinfo('Error', 'Please choose interface.')            
            else:                
                buff_size = 16384
                sleep(0.5)
                remote_conn.send("sh ip int " + getiface.get() + " | i access list \n")
                sleep(0.5)        
                while not remote_conn.recv_ready():
                    remote_conn.recv(0)
                    buff_size += 2048
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Current ACL configuration', output) 
            ...
            if chk_state_neg.get() == False:
                if PLRMvar == 1:
                    if listname.get() == "" or listname.get() == "eg. MyACL" or listseq.get() == "" or listseq.get() == "seq no.":
                        tkMessageBox.showinfo('ERROR', 'Error - please enter both the list name AND the sequence number.')
                        ...
                        if ('Insertion failed' in output):
                            ...
                            tkMessageBox.showinfo('Prefix List', 'List created.')
                    else:
                        tkMessageBox.showinfo('ERROR', 'Please enter required input values to create a Prefix List.')
                else:
                    if listname.get() == "" or listname.get() == "eg. MyACL" or listseq.get() == "" or listseq.get() == "seq no.":
                        tkMessageBox.showinfo('ERROR', 'Error - please enter both the list name AND the sequence number.')
                    elif rtemapval.get() == "":
                        ...
                        sleep(0.2)
                        tkMessageBox.showinfo('Route-Map', 'Route-Map (+ sequence) created.')
                    else:
                        remote_conn.send("route-m " + listname.get() + " " + permpfxrtedropopt.get() + " " + listseq.get() + " \n")
                        sleep(0.2)
                        if rtemapopt.get() == "Match":
                            if (rtemapopt2.get() == "*weight" or rtemapopt2.get() == "*origin" or rtemapopt2.get() == "*dampening" or rtemapopt2.get() == "*vrf"):
                                tkMessageBox.showinfo('ERROR', 'These values can ONLY be Set, not Matched: weight, origin, dampening, vrf.')
                            elif rtemapopt2.get() == "ACL":
                                remote_conn.send("match ip address " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'ACL match clause created.')
                            elif rtemapopt2.get() == "v6ACL":
                                remote_conn.send("match ipv6 address " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'IPv6 ACL match clause created.')
                            elif rtemapopt2.get() == "ACL(nexthop)":
                                remote_conn.send("match ip next-hop " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'IP nexthop ACL match clause created.')
                            elif rtemapopt2.get() == "v6ACL(nexthop)":
                                remote_conn.send("match ipv6 next-hop " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'IPv6 nexthop ACL match clause created.')
                            else:
                                remote_conn.send("match " + rtemapopt2.get() + " " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'Match clause created.')
                        else:
                            if rtemapopt2.get() == "ACL":
                                remote_conn.send("set ip address " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'ACL set clause created.')
                            elif rtemapopt2.get() == "v6ACL":
                                remote_conn.send("set ipv6 address " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'IPv6 ACL set clause created.')
                            elif rtemapopt2.get() == "ACL(nexthop)":
                                remote_conn.send("set ip next-hop " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'IP nexthop ACL set clause created.')
                            elif rtemapopt2.get() == "v6ACL(nexthop)":
                                remote_conn.send("set ipv6 next-hop " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'IPv6 nexthop ACL set clause created.')
                                ...
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', rtemapoptnew + ' set clause created.')
                            else:
                                remote_conn.send("set " + rtemapopt2.get() + " " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', rtemapopt2.get() + ' set clause created.')
            else:
                if PLRMvar == 1:
                    if listname.get() == "" or listname.get() == "eg. MyACL":
                        tkMessageBox.showinfo('ERROR', 'Error - please enter both the list name.')
                        ...
                        sleep(0.2)
                        tkMessageBox.showinfo('Prefix List', 'Prefix List removed.')
                    elif (listseq.get() != "" or listseq.get() != "seq no.") and (listnetandmask.get() != "" or listnetandmask.get()\
                            != "eg. 1.1.1.0/24 le 24 ge 30"):
                        remote_conn.send("no ip prefix-l " + listname.get() + " seq " + listseq.get() + " " + permpfxrtedropopt.get() + " " + \
                                         listnetandmask.get() + " \n")
                        sleep(0.2)
                        tkMessageBox.showinfo('Prefix List', 'Prefix List sequence removed.')
                    else:
                        tkMessageBox.showinfo('ERROR', 'Please enter required input values to remove a Prefix List or a sequence within a Prefix List.')
                else:
                    if listname.get() == "" or listname.get() == "eg. MyACL":
                        tkMessageBox.showinfo('ERROR', 'Error - please enter both the list name.')
                        ...
                        sleep(0.2)
                        tkMessageBox.showinfo('Route-Map', 'Route-Map removed.')
                    elif (listseq.get() != "" or listseq.get() != "seq no.") and rtemapval.get() == "":
                        remote_conn.send("no route-m " + listname.get() + " " + permpfxrtedropopt.get() + " " + listseq.get() + " \n")
                        sleep(0.2)
                        tkMessageBox.showinfo('Route-Map', 'Route-Map sequence removed.')
                    elif (listseq.get() != "" or listseq.get() != "seq no.") and rtemapval.get() != "":
                        if rtemapopt.get() == "Match":
                            if (rtemapopt2.get() == "*weight" or rtemapopt2.get() == "*origin" or rtemapopt2.get() == "*dampening" or rtemapopt2.get() == "*vrf"):
                                tkMessageBox.showinfo('ERROR', 'These values can ONLY be Set, not Matched: weight, origin, dampening, vrf.')
                                ...
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'ACL match clause removed.')
                            elif rtemapopt2.get() == "v6ACL":
                                remote_conn.send("route-m " + listname.get() + " " + permpfxrtedropopt.get() + " " + listseq.get() + " \n")
                                sleep(0.2)
                                remote_conn.send("no match ipv6 address " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'IPv6 ACL match clause removed.')
                            elif rtemapopt2.get() == "ACL(nexthop)":
                                remote_conn.send("route-m " + listname.get() + " " + permpfxrtedropopt.get() + " " + listseq.get() + " \n")
                                sleep(0.2)
                                remote_conn.send("no match ip next-hop " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'ACL nexthop match clause removed.')
                            elif rtemapopt2.get() == "v6ACL(nexthop)":
                                remote_conn.send("route-m " + listname.get() + " " + permpfxrtedropopt.get() + " " + listseq.get() + " \n")
                                sleep(0.2)
                                remote_conn.send("no match ipv6 next-hop " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'IPv6 ACL nexthop match clause removed.')
                            else:
                                remote_conn.send("route-m " + listname.get() + " " + permpfxrtedropopt.get() + " " + listseq.get() + " \n")
                                sleep(0.2)
                                remote_conn.send("no match " + rtemapopt2.get() + " " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', rtemapopt2.get() + ' match clause removed.')
                        else:
                            if rtemapopt2.get() == "ACL":
                                remote_conn.send("route-m " + listname.get() + " " + permpfxrtedropopt.get() + " " + listseq.get() + " \n")
                                sleep(0.2)
                                ...
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'ACL set clause removed.')
                            elif rtemapopt2.get() == "v6ACL":
                                remote_conn.send("route-m " + listname.get() + " " + permpfxrtedropopt.get() + " " + listseq.get() + " \n")
                                sleep(0.2)
                                remote_conn.send("no set ipv6 address " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'IPv6 ACL set clause removed.')
                            elif rtemapopt2.get() == "ACL(nexthop)":
                                remote_conn.send("route-m " + listname.get() + " " + permpfxrtedropopt.get() + " " + listseq.get() + " \n")
                                sleep(0.2)
                                remote_conn.send("no set ip next-hop " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'ACL nexthop set clause removed.')
                            elif rtemapopt2.get() == "v6ACL(nexthop)":
                                remote_conn.send("route-m " + listname.get() + " " + permpfxrtedropopt.get() + " " + listseq.get() + " \n")
                                sleep(0.2)
                                remote_conn.send("no set ipv6 next-hop " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', 'IPv6 ACL nexthop set clause removed.')
                            elif rtemapopt2.get() == "*weight" or rtemapopt2.get() == "*origin" or rtemapopt2.get() == "*dampening" or rtemapopt2.get() == "*vrf":
                                rtemapoptnew = str(rtemapopt2.get())[1:]
                                remote_conn.send("route-m " + listname.get() + " " + permpfxrtedropopt.get() + " " + listseq.get() + " \n")
                                sleep(0.2)
                                ...
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', rtemapoptnew + ' set clause removed.')
                            else:
                                remote_conn.send("route-m " + listname.get() + " " + permpfxrtedropopt.get() + " " + listseq.get() + " \n")
                                sleep(0.2)
                                remote_conn.send("no set " + rtemapopt2.get() + " " + rtemapval.get() + " \n")
                                sleep(0.2)
                                tkMessageBox.showinfo('Route-Map', rtemapopt2.get() + ' set clause removed.')
                    else:
                        tkMessageBox.showinfo('ERROR', 'Please enter required input values to remove a Route-Map, a sequence within a Route-map or \
a match/set clause within a Route-Map sequence.')
            sleep(0.2)
            remote_conn.send("exit \n")
            sleep(0.2)
            remote_conn.send("exit \n")
        btn = Button(pfxlistrtemapframe, text="Apply", bg="orange", command=setpfxrteconf)
        ...
        def setspeciallistconf():
            if speciallistnum.get() == "" or speciallistnum.get() == "ListNo." or speciallistval.get() == "" or \
               speciallistval.get() == "Regex for AS-ACL, <10:20> for comm list":
                tkMessageBox.showinfo('ERROR', 'Error - please enter both the list number AND the value.')
                ...
                sleep(0.5)
                tkMessageBox.showinfo('AS-Path ACL', 'List created.')
            else:
                remote_conn.send("ip community-l " + speciallistnum.get() + " " + speciallistdropopt.get() + " " + speciallistval.get() + " \n")
                sleep(0.5)
                tkMessageBox.showinfo('Community List', 'List created.')
        btn = Button(speciallistframe, text="Apply", bg="orange", command=setspeciallistconf)
        ...
        def showaclconf():
            ...
            while not remote_conn.recv_ready():
                ...
                sleep(0.5)
            output = remote_conn.recv(buff_size).decode("utf-8")
            tkMessageBox.showinfo('Existing List', output)
        ...
        def aclhelp():
            ...
            tkMessageBox.showinfo('ACL Help', res)
...
TO NEGATE: \n\
  ...
  - if input <ListName> == Deletes PrefixList"
            tkMessageBox.showinfo('Prefix List Help', res)
...
TO NEGATE: \n\
  ...
  - if input <ListName> == Deletes Route-Map "
            ...
            tkMessageBox.showinfo('Route Map Help', res)
    ...
    def NAT():
        ...
        def natclicked():
            if chk_state_neg.get() == True:                
                ...
                if chk_state_overload.get() == True:
                    ...
                    res = "NAT added. Ensure ACL " + getacl.get() + " is created or will not work."
                    tkMessageBox.showinfo('NAT', res)                    
        btn = Button(natframe, text="Apply", bg="orange", command=natclicked)
        ...
        btn = Button(portfwdframe, text="Apply", bg="orange", command=portforwardclicked)
        ...
        def shownatconf():
            ...
            while not remote_conn.recv_ready():
                ...
                sleep(0.5)
            output = remote_conn.recv(buff_size).decode("utf-8")
            tkMessageBox.showinfo('NAT translations', output)          
        ...
        def clearnat():
            ...
            sleep(0.5)
            tkMessageBox.showinfo('NAT', 'All NAT translations has been cleared. All TCP connections will drop.')
    ...
    def monitoring():
        ...
        CDPLLDPframe=LabelFrame(window,text=" L2 Device monitoring ",font=('verdana', 8, 'bold'),padx=10,pady=5,width=100,height=100)
        ...
        def cdplldp():
            if cdpopt.get() == "Choose":
                ...
                if (getcdpiface.get() != "" and getcdpiface.get() != "eg. fa0/0"):
                    ...
                    sleep(0.5)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('L2 Device monitoring', 'CDP monitoring enabled')
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.5)
                    remote_conn.send("cdp run \n")
                    sleep(0.5)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('L2 Device monitoring', 'CDP monitoring enabled globally')
            else:
                if (getcdpiface.get() != "" and getcdpiface.get() != "eg. fa0/0"):
                    remote_conn.send("conf t \n")
                    sleep(0.5)
                    ...
                    sleep(0.5)
                    remote_conn.send("exit \n")                    
                    tkMessageBox.showinfo('L2 Device monitoring', 'CDP monitoring disabled')
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.5)
                    ...
                    sleep(0.5)
                    remote_conn.send("exit \n")                    
                    tkMessageBox.showinfo('L2 Device monitoring', 'CDP monitoring disabled globally')
            ...
            if cdpopt.get() == "Choose":
                ...
                if (getlldpiface.get() != "" and getlldpiface.get() != "eg. fa0/0"):
                    ...
                    if LLDPvar.get() == 1:
                        ...
                        sleep(0.3)                                           
                        tkMessageBox.showinfo('L2 Device monitoring', 'LLDP monitoring enabled to transmit and receive.')
                    elif LLDPvar.get() == 2:
                        remote_conn.send("lldp transmit \n")
                        sleep(0.3)                                          
                        tkMessageBox.showinfo('L2 Device monitoring', 'LLDP monitoring enabled to transmit only.')
                    else:
                        remote_conn.send("lldp receive \n")
                        sleep(0.3)                                         
                        tkMessageBox.showinfo('L2 Device monitoring', 'LLDP monitoring enabled to receive only.')
                    remote_conn.send("exit \n")
                    sleep(0.3)
                    remote_conn.send("exit \n")
                else:
                    ...
                    sleep(0.5)
                    remote_conn.send("exit \n")                    
                    tkMessageBox.showinfo('L2 Device monitoring', 'LLDP monitoring enabled globally')
                ...
                if (getlldpiface.get() != "" and getlldpiface.get() != "eg. fa0/0"):
                    ...
                    if LLDPvar.get() == 1:
                        ...
                        sleep(0.3)                                           
                        tkMessageBox.showinfo('L2 Device monitoring', 'LLDP monitoring - transmit and receive disabled.')
                    elif LLDPvar.get() == 2:
                        remote_conn.send("no lldp transmit \n")
                        sleep(0.3)                                          
                        tkMessageBox.showinfo('L2 Device monitoring', 'LLDP monitoring - transmit disabled.')
                    else:
                        remote_conn.send("no lldp receive \n")
                        sleep(0.3)                                         
                        tkMessageBox.showinfo('L2 Device monitoring', 'LLDP monitoring - receive disabled.')
                    remote_conn.send("exit \n")
                    sleep(0.3)
                    remote_conn.send("exit \n") 
                else:
                    ...
                    sleep(0.5)
                    remote_conn.send("exit \n")                    
                    tkMessageBox.showinfo('L2 Device monitoring', 'LLDP monitoring disabled globally')

            if othercdplldpopt.get() == "Choose":
                pass
                ...
                if chk_state_neg.get() == False:
                    ...
                    if othercdplldpopt.get() == "CDP hello":
                        ...
                        sleep(0.3)                                           
                        tkMessageBox.showinfo('L2 Device monitoring', 'CDP hello timer modified.')
                    elif othercdplldpopt.get() == "CDP hold":
                        remote_conn.send("cdp hold " + getcdplldpother.get() + " \n")
                        sleep(0.3)                                          
                        tkMessageBox.showinfo('L2 Device monitoring', 'CDP hold timer modified.')
                    elif othercdplldpopt.get() == "LLDP hello":
                        remote_conn.send("lldp timer " + getcdplldpother.get() + " \n")
                        sleep(0.3)                                         
                        tkMessageBox.showinfo('L2 Device monitoring', 'LLDP hello timer modified.')
                    else:
                        remote_conn.send("lldp hold " + getcdplldpother.get() + " \n")
                        sleep(0.3)                                         
                        tkMessageBox.showinfo('L2 Device monitoring', 'LLDP hold timer modified.')
                    remote_conn.send("exit \n")                        
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    if othercdplldpopt.get() == "CDP hello":
                        ...
                        sleep(0.3)                                           
                        tkMessageBox.showinfo('L2 Device monitoring', 'CDP hello timer reset.')
                    elif othercdplldpopt.get() == "CDP hold":
                        remote_conn.send("no cdp hold \n")
                        sleep(0.3)                                          
                        tkMessageBox.showinfo('L2 Device monitoring', 'CDP hold timer reset.')
                    elif othercdplldpopt.get() == "LLDP hello":
                        remote_conn.send("no lldp timer \n")
                        sleep(0.3)                                         
                        tkMessageBox.showinfo('L2 Device monitoring', 'LLDP hello timer reset.')
                    else:
                        remote_conn.send("no lldp hold \n")
                        sleep(0.3)                                         
                        tkMessageBox.showinfo('L2 Device monitoring', 'LLDP hold timer reset.')
                    remote_conn.send("exit \n")                     
 
        btn = Button(CDPLLDPframe, text="Apply", bg="orange", command=cdplldp)
        btn.grid(column=5, row=0, rowspan=2)


        def CDPLLDPHelp():
            res = ""
            tkMessageBox.showinfo('CDP & LLDP Help', res)
        btn = Button(CDPLLDPframe, text="Help", bg="yellow", command=CDPLLDPHelp)
        btn.grid(row=3,column=5)
        

            
        UDLDframe=LabelFrame(window,text=" L1/2 Link monitoring ",font=('verdana', 8, 'bold'),padx=10,pady=5,width=100,height=100)
        ...
        getudldother = Entry(UDLDframe, bg='white', width=15, fg='grey')
        getudldother.grid(column=2, row=1)
        getudldother.insert(0, "eg. 5")
        def handle_focus_in(_):
        ...
        def udld():
            if UDLDopt.get() == "Choose":
                ...
                if (getudldiface.get() != "" and getudldiface.get() != "eg. fa0/0"):
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('UDLD', 'UDLD monitoring enabled')
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    remote_conn.send("udld enable \n")
                    tkMessageBox.showinfo('UDLD', 'UDLD globally enabled')
                sleep(0.3)
                remote_conn.send("exit \n")
            else:
                if (getudldiface.get() != "" and getudldiface.get() != "eg. fa0/0"):
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('UDLD', 'UDLD monitoring disabled')
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    remote_conn.send("no udld enable \n")
                    tkMessageBox.showinfo('UDLD', 'UDLD globally disabled')                        
                sleep(0.3)
                remote_conn.send("exit \n")


            if otherudldpopt.get() == "Choose":
                pass
            else:
                if chk_state_neg.get() == False:
                    if otherudldpopt.get() == "Hello":
                        if (getudldother.get() == "" and getudldother.get() == "eg. 5"):
                            ...
                            sleep(0.3)
                            remote_conn.send("exit \n")
                            tkMessageBox.showinfo('UDLD', 'UDLD hello timer modified.')
                        ...
                        if (getudldother.get() == "" and getudldother.get() == "eg. 5"):
                            ...
                            sleep(0.3)
                            remote_conn.send("exit \n")
                            tkMessageBox.showinfo('UDLD', 'UDLD will auto recover from UDLD-triggered disables (default 20sec).')
                        else:
                            remote_conn.send("conf t \n")
                            sleep(0.3)                        
                            ...
                            sleep(0.3)
                            remote_conn.send("exit \n")
                            tkMessageBox.showinfo('UDLD', 'UDLD will auto recover from UDLD-triggered disables after specified time.')
                    else:
                        if (getudldother.get() == "" and getudldother.get() == "eg. 5"):
                            tkMessageBox.showinfo('Error', 'Please enter a value.')
                        else:
                            ...
                            sleep(0.3)                           
                            tkMessageBox.showinfo('UDLD', 'All UDLD-triggered interface disables has been recovered.')                      
                else:
                    if otherudldpopt.get() == "Hello":
                        remote_conn.send("conf t \n")
                        sleep(0.3)
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('UDLD', 'UDLD hello timer reset.')
                    elif otherudldpopt.get() == "Auto-recovery":
                        remote_conn.send("conf t \n")
                        sleep(0.3)
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('UDLD', 'UDLD auto-recovery disabled.')
                    else:
                        pass
        btn = Button(UDLDframe, text="Apply", bg="orange", command=udld)
        btn.grid(column=5, row=0)
        blanklbl = Label(UDLDframe, text="      ").grid(column=4, row=0)

        def UDLDHelp():
            res = ""
            tkMessageBox.showinfo('UDLD Help', res)
        ...
        BFDframe=LabelFrame(window,text=" L3 Link monitoring ",font=('verdana', 8, 'bold'),padx=10,pady=5,width=100,height=100)
            ...
            if BFDopt.get() == "Choose":
                ...
                if (getbfdiface.get() == "" or getbfdiface.get() == "eg. fa0/0") and (getbfdintv.get() == "" or getbfdintv.get() == "interval") and \
                   (getbfdrx.get() == "" or getbfdrx.get() == "min_rx") and (getbfdmult.get() == "" or getbfdmult.get() == "multiplier"):
                    tkMessageBox.showinfo('ERROR', 'Please enter all required information.')
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")                    
                    tkMessageBox.showinfo('BFD', 'BFD monitoring enabled on interface. NOTE: Remember to also enable it for the desired routing protocol(s) (in Route page) to take effect.')
            else:
                if (getudldiface.get() == "" or getudldiface.get() == "eg. fa0/0"):
                    tkMessageBox.showinfo('ERROR', 'Please enter an interface at least.')
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    remote_conn.send("int " + getbfdiface.get() + " \n")
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('BFD', 'BFD monitoring disabled on interface')

                    
        btn = Button(BFDframe, text="Apply", bg="orange", command=bfd)
        btn.grid(column=6, row=0, padx=6)

        def BFDHelp():
            res = ""
            tkMessageBox.showinfo('BFD Help', res)
            ...
            if SNMPopt.get() == "Choose":
                ...
                if chk_state_neg.get() == False:
                    if (getsnmp.get() == "" or getsnmp.get() == "eg. public"):
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")                   
                        tkMessageBox.showinfo('SNMP', 'SNMP monitoring configured. NOTE: Remember to use the same community value on your SNMP manager.')
                else:
                    if (getsnmp.get() == "" or getsnmp.get() == "eg. public"):
                        tkMessageBox.showinfo('ERROR', 'Please enter all required information.')
                    else:
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")                   
                        tkMessageBox.showinfo('SNMP', 'SNMP community deleted.')                    
            else:
                if chk_state_neg.get() == False:
                    if (getsnmp.get() == "" or getsnmp.get() == "eg. public"):
                        tkMessageBox.showinfo('ERROR', 'Please enter all required information.')
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")                   
                        tkMessageBox.showinfo('SNMP', 'SNMP contact configured.')
                else:
                    if (getsnmp.get() == "" or getsnmp.get() == "eg. public"):
                        tkMessageBox.showinfo('ERROR', 'Please enter all required information.')
                    else:
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")                   
                        tkMessageBox.showinfo('SNMP', 'SNMP contact deleted.') 
        btn = Button(SNMPframe, text="Apply", bg="orange", command=snmp)
        btn.place(x=340, y=0)
            ...
            if NFopt.get() == "Choose":
                ...
                if chk_state_neg == False:
                    if (getnfiface.get() == "" or getnfiface.get() == "eg. fa0/0"):
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")                    
                        tkMessageBox.showinfo('Netflow', 'Netflow monitoring enabled on interface.')
                else:
                    if (getnfiface.get() == "" or getnfiface.get() == "eg. fa0/0"):
                        tkMessageBox.showinfo('ERROR', 'Please enter an interface at least.')
                    else:
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n") 
                        tkMessageBox.showinfo('Netflow', 'Netflow monitoring disabled on interface')
            ...
            if chk_top_talker.get() == False:
                ...
                if chk_state_neg == False:
                    if NFSortopt.get() == "Sort by":
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Netflow', 'Toptalker enabled. ')
                    else:
                        remote_conn.send("conf t \n")
                        sleep(0.3)
                        remote_conn.send("ip flow-top-t \n")
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Netflow', 'Toptalker enabled, results sorted. ' + top + match)
                else:
                    if NFSortopt.get() == "Sort by":
                        if (getnfentries.get() == "" or getnfentries.get() == "no. of entries") and (getnfmatch.get() == "" or getnfmatch.get() == "eg IP addr"):
                            ...
                            sleep(0.3)
                            remote_conn.send("exit \n")
                            tkMessageBox.showinfo('Netflow', 'Toptalker disabled.')
                        else:
                            if getnfentries.get() != "" or getnfentries.get() != "no. of entries":
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Netflow', 'Toptalker enabled, results sorting reset. ' + top + match)
        btn = Button(NFframe, text="Apply", bg="orange", command=netflow)
        btn.place(x=340, y=0)

        def NetFlowHelp():
            res = ""
            tkMessageBox.showinfo('NetFlow Help', res)
...
#        blanklbl = Label(Mirrorframe, text="").grid(column=0, row=3)
        ...
        def spanport():
            if (getSessID.get() == "" or getSessID.get() == "<1-60>"):
                tkMessageBox.showinfo('Error', 'Please enter session ID. ')
            else:
                ...
                if chk_state_neg == False:
                    if SPANvar.get() == 1:
                        if ("vlan" in getSessdstiface.get()) or ("VLAN" in getSessdstiface.get()):
                            tkMessageBox.showinfo('Error', 'Destination for SPAN can only be an interface, not a VLAN. ')
                        else:
...
destination device also. ')
                        elif ("vlan" in getSessdstiface.get()) or ("VLAN" in getSessdstiface.get()):
                            tkMessageBox.showinfo('Error', 'Destination for the remote RSPAN can only be an interface, not a VLAN. ')
                        else:
                            if (getSessiface.get() != "" and getSessiface.get() != "eg. fa0/0, VLAN 2"):
                                remote_conn.send("conf t \n")
                                sleep(0.3)
                    ...
                    tkMessageBox.showinfo('SPAN/RSPAN', spansrccomment + spandstcomment + spanfiltercomment)
                    ...
                    if (getSessiface.get() == "" or getSessiface.get() == "eg. fa0/0, VLAN 2") and (getSessdstiface.get() == "" or getSessdstiface.get() == "eg. fa0/0, VLAN 2")\
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('SPAN/RSPAN', 'Session deleted.')
                    else:
                        if SPANvar.get() == 1:
                            if ("vlan" in getSessdstiface.get()) or ("VLAN" in getSessdstiface.get()):
                                tkMessageBox.showinfo('Error', 'Destination for SPAN can only be an interface, not a VLAN. ')
    ...
    destination device also. ')
        ...
        btn = Button(Mirrorframe, text="Apply", bg="orange", command=spanport)
        btn.grid(column=5, row=0, padx=3)

        def MirrorHelp():
            res = " "
            tkMessageBox.showinfo('Port Mirroring (aka SPAN) Help', res)
        ...
        def slog():
            if chk_state_neg == False:
                if getSlog.get() == "":
                    tkMessageBox.showinfo('Error', 'Please enter the required information.')
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('Syslog', 'Logs from this router will be sent to your specified IP address.')
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('Syslog', 'Logs for your specified level will be sent to a Syslog server (if the Syslog server IP is configured).')
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('Syslog', 'Logs from this router will be sent to a Syslog server sourced from the IP address of the configured interface.')
            else:
                if Slogopt.get() == "Syslog server IP:":
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('Syslog', 'Syslog server removed.')
                elif Slogopt.get() == "Log msg level:":
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('Syslog', 'Logs level reset.')
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('Syslog', 'Syslog source interface reset.')
        btn = Button(Syslogframe, text="Apply", bg="orange", command=slog)
        btn.place(x=340, y=0)
        ...
        def showmonclick():
            ...
            while not remote_conn.recv_ready():
                ...
                sleep(0.5)
            output = remote_conn.recv(buff_size).decode("utf-8")
            tkMessageBox.showinfo('Monitoring Statistics', output)            
    ...
    def admin():
            ...
            if chk_state_neg.get() == False:
                if getusername.get() != "" and getpasswd.get() != "":
                    ...
                    if getenpasswd.get() != "":
                        ...
                        pass
                    tkMessageBox.showinfo('Login credential', 'Username and password has been configured.')
                else:
                    tkMessageBox.showinfo('ERROR', 'Please enter both the username and password.')
                ...
                if getusername.get() != "" and getpasswd.get() == "":
                    ...
                    if getenpasswd.get() != "":
                        ...
                        pass
                    tkMessageBox.showinfo('Login credential', 'Username deleted.')
                elif getpasswd.get() != "" and getusername.get() == "":
                    tkMessageBox.showinfo('ERROR', 'Please enter either username only, or both username and password to negate.')
                else:
                    remote_conn.send("conf t\n")
                    sleep(0.3)
                    remote_conn.send("no " + cmd)
                    if getenpasswd.get() != "":
                        ...
                        pass
                    sleep(0.3)
                    tkMessageBox.showinfo('Login credential', 'Username and password deleted.') 
            sleep(0.5)
            remote_conn.send("exit \n")
        btn = Button(AdminFrame, text="Apply", bg="orange", command=adduserpass)
        btn.grid(column=1, row=3)
        ...
        def addpriv():
            if chk_state_neg.get() == False:
                if getpriv.get() == "":
                    tkMessageBox.showinfo('ERROR', 'Please enter command to add to Read-Only user.')
                else:
                    remote_conn.send("conf t\n")
                    sleep(0.3)
                    remote_conn.send("privilege exec level 2 " + getpriv.get() + "\n")
                    tkMessageBox.showinfo('Privilege level', 'Command added to RO users privilege.')
            else:
                if getpriv.get() == "":
                    tkMessageBox.showinfo('ERROR', 'Please enter command to remove from Read-Only user.')
                else:
                    remote_conn.send("conf t\n")
                    sleep(0.3)
                    remote_conn.send("privilege exec level 9 " + getpriv.get() + "\n")
                    tkMessageBox.showinfo('Privilege level', 'Command removed from RO users privilege.')
            sleep(0.3)
            remote_conn.send("exit \n")
        btn = Button(AdminFrame, text="Apply", bg="orange", command=addpriv)
        btn.grid(column=1, row=6)
        ...
        def relo():
            if  reloadmins.get() == "" or reloadmins.get() == "e.g. (in) 15, (at) 02:00 apr 21":
                tkMessageBox.showinfo('ERROR', 'Please enter a number of seconds till/when the reload command initiates.')
            elif chk_state_neg.get() == False:
                if relodatetime.get() == "in":
                    remote_conn.send("reload in " + reloadmins.get() + "\n")
                    sleep(0.3)
                    tkMessageBox.showinfo('Reload', 'This device will reload in ' + reloadmins.get() + ' minutes.')
                elif relodatetime.get() == "in":
                    remote_conn.send("reload at " + reloadmins.get() + "\n")
                    sleep(0.3)
                    tkMessageBox.showinfo('Reload', 'This device will reload at ' + reloadmins.get() + '.')
                else:
                    ...
                    if reloadconfirmation in output:
                        ...
                        pass
                    tkMessageBox.showinfo('Reload', 'Reload command sent.')
            else:
                remote_conn.send("reload cancel \n")
                sleep(0.3)
                tkMessageBox.showinfo('Reload', 'Reload command canceled.')
        ...
        def banner():
            if bannerinput.get() == "":
                tkMessageBox.showinfo('ERROR', 'Please enter banner text.')
            else:
                remote_conn.send("conf t\n")
                sleep(0.3)                    
                ...
                sleep(0.3)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('Banner', 'Banner configured.')
            ...
            if chk_state_neg() == False:
                if dhnameopt.get() == "DomainName":
                    if dhinput.get() == "":
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Configuration', 'Domain name configured.')
                    ...
                    if dhinput.get() == "":
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Configuration', 'Host name configured.')
                    ...
                    if dhinput.get() == "":
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")                        
                        tkMessageBox.showinfo('Configuration', 'Name server configured.')
                    ...
                    if dhinput.get() == "":
                        ...
                        sleep(0.3)
                        tkMessageBox.showinfo('Configuration', 'Clock time has been updated.')                        
                elif dhnameopt.get() == "UpdateClock:SWtoHW":
                    remote_conn.send("clock update-calendar \n")
                    sleep(0.3)
                    tkMessageBox.showinfo('Configuration', 'Hardware clock updated from the Software clock.')
                elif dhnameopt.get() == "UpdateClock:HWtoSW":
                    remote_conn.send("clock read-calendar \n")
                    sleep(0.3)                    
                    tkMessageBox.showinfo('Configuration', 'Software clock updated from the Hardware clock. (NOTE: Hardware clock runs even if the device is powered off or rebooted)')                        
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('Configuration', 'NTP master configured.')
                    ...
                    if dhinput.get() == "":
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Configuration', 'NTP source configured.')
                else:
                    if dhinput.get() == "":
                        tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                    else:
                ...
                if dhnameopt.get() == "DomainName":
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('Configuration', 'Domain name removed.')
                elif dhnameopt.get() == "HostName":
                    remote_conn.send("conf t\n")
                    sleep(0.3)                    
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('Configuration', 'Host name removed.')
                elif dhnameopt.get() == "NameServer":
                    if dhinput.get() == "":
                        tkMessageBox.showinfo('ERROR', 'Please enter a value.')
                    else:
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")                        
                        tkMessageBox.showinfo('Configuration', 'Name server removed.')
                elif dhnameopt.get() == "Set Clock":
                    tkMessageBox.showinfo('Configuration', 'Nothing to negate.')                        
                elif dhnameopt.get() == "UpdateClock:SWtoHW":
                    tkMessageBox.showinfo('Configuration', 'Nothing to negate.')
                elif dhnameopt.get() == "UpdateClock:HWtoSW":
                    tkMessageBox.showinfo('Configuration', 'Nothing to negate.')
                    ...
                    remote_conn.send("exit \n")                        
                    tkMessageBox.showinfo('Configuration', 'Name server configured.')
        btn = Button(AdminFrame2, text="Apply", bg="orange", command=dhostname)
        ...
        def shadmin():
            if showitem.get() == "Scheduled reloads":
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Reloads scheduled', output)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('User accounts', output)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Domain Name', output)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Hostname', output)               
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Time (SW clock)', output)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Time (HW clock)', output)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Network Time Protocol status', output)
            else:
                buff_size = 16384
                sleep(0.5)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Network Time Protocol associations', output)
    ...
    def HAvail():
        ...
        def LAG():
            ...
            if chk_state_neg.get() == False:
                if LAGgrp.get() == "" or (LAGports.get() == "" or LAGports.get() == "eg. +fa0/0+fa0/1.."):
                    tkMessageBox.showinfo('ERROR', 'Please enter both a bundle ID AND the ports/interfaces to be added to that bundle.')
                else:
                    remote_conn.send("conf t\n")
                    sleep(0.3)                    
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")                        
                    tkMessageBox.showinfo('LAG', 'LAG bundle created, and ports added to LAG bundle.')
            else:
                if LAGgrp.get() == "":
                    tkMessageBox.showinfo('ERROR', 'Minimum information required is to enter a bundle ID (to be deleted).')
                else:
                    if LAGports.get() == "" or LAGports.get() == "eg. +fa0/0+fa0/1..":
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('LAG', 'LAG bundle deleted.')
                    else:
                        for p in ports:
                            remote_conn.send("int " + str(p[1:]) + "\n")
                            sleep(0.3)
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n") 
                        tkMessageBox.showinfo('LAG', 'Port removed from LAG bundle.')
        btn = Button(LAGframe, text="Apply", bg="orange", command=LAG)
            ...
            if LAGother.get() == "" or LAGother.get() == "value":
                ...
                if chk_state_neg() == False:
                    if LAGotheropt.get() == "LACP system-priority":
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('LAG', 'LACP system-priority configured.')
                    elif LAGotheropt.get() == "LACP port-priority":
                        if LAGother2.get() == "" or LAGother2.get() == "eg. fa0/0":
                            tkMessageBox.showinfo('ERROR', 'Please enter a port(interface).')
                        else:
                            remote_conn.send("conf t\n")
                            sleep(0.3)
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('LAG', 'LACP port-priority configured.')
                        ...
                        if LAGother2.get() == "" or LAGother2.get() == "eg. fa0/0":
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('LAG', 'PAGP port-priority configured.')                        
                    else:
                        if LAGother2.get() == "" or LAGother2.get() == "eg. fa0/0":
                            tkMessageBox.showinfo('ERROR', 'Please enter a port(interface).')
                        else:
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('LAG', 'PAGP learn-method configured.')
                else:
                    if LAGotheropt.get() == "LACP system-priority":
                        remote_conn.send("conf t\n")
                        sleep(0.3)                    
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('LAG', 'LACP system-priority reset to default.')
                    elif LAGotheropt.get() == "LACP port-priority":
                        if LAGother2.get() == "" or LAGother2.get() == "eg. fa0/0":
                            tkMessageBox.showinfo('ERROR', 'Please enter a port(interface).')
                        else:
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('LAG', 'LACP port-priority reset to default.')
                    elif LAGotheropt.get() == "PAGP port-priority":
                        if LAGother2.get() == "" or LAGother2.get() == "eg. fa0/0":
                            tkMessageBox.showinfo('ERROR', 'Please enter a port(interface).')
                        else:
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('LAG', 'PAGP port-priority reset to default.')                        
                    else:
                        if LAGother2.get() == "" or LAGother2.get() == "eg. fa0/0":
                            tkMessageBox.showinfo('ERROR', 'Please enter a port(interface).')
                        else:
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('LAG', 'PAGP learn-method reset to default.')
        btn = Button(LAGframe, text="Apply", bg="orange", command=LAGoptional)
        ...
        def LAGoptionalbalance():
            if chk_state_neg.get() == False:
                ...
                sleep(0.3)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('LAG', 'LAG load-distribution method among the ports in the Etherchannel bundle configured.')
            else:
                remote_conn.send("conf t\n")
                sleep(0.3)                    
                ...
                sleep(0.3)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('LAG', 'LAG load-distribution method among the ports in the Etherchannel bundle reset to default (src-mac).') 
        btn = Button(LAGframe, text="Apply", bg="orange", command=LAGoptionalbalance)
        ...
        def RGR():
            ...
            if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                tkMessageBox.showinfo('ERROR', 'Please enter an interface and Protocol ID.')
            else:
                if chk_state_neg.get() == False:
                    if (RGRvip.get() == "" or RGRvip.get() == "x.x.x.x"):
                        tkMessageBox.showinfo('ERROR', 'Please enter a VirtualIP to act as the gateway.')
                    else:
                        remote_conn.send("conf t\n")
                        sleep(0.3)
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Gateway Redundancy', proto + ' configured for interface ' + RGRiface.get() + '.')
                else:
                    remote_conn.send("conf t\n")
                    sleep(0.3)
                    remote_conn.send("int " + RGRiface.get() + "\n")
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('Gateway Redundancy', proto + ' deleted.')
        btn = Button(RGRframe, text="Apply", bg="orange", command=RGR)
            ...
            if RGRother.get() == "" or RGRother.get() == "value":
                ...
                if chk_state_neg.get() == False:
                    if RGRotheropt == "Preempt":
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            tkMessageBox.showinfo('ERROR', 'Please also enter the Protocol ID and the interface it is enabled on.')
                        else:
                            remote_conn.send("conf t\n")
                            sleep(0.3)
                            remote_conn.send("int " + RGRiface.get() + "\n")
                            ...
                            sleep(0.3)
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'Preempt configured.')
                        ...
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            ...
                            sleep(0.3)
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'Priority configured.')
                        ...
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            ...
                            sleep(0.3)
                            remote_conn.send("exit \n")                  
                            tkMessageBox.showinfo('Gateway Redundancy', 'Interface tracking (and priority decrementing) configured.')
                    elif RGRotheropt == "Version(HSRP)":
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0"):
                            tkMessageBox.showinfo('ERROR', 'Please also enter the interface it is enabled on.')
                        else:
                            remote_conn.send("conf t\n")
                            sleep(0.3)
                            remote_conn.send("int " + RGRiface.get() + "\n")
                            ...
                            sleep(0.3)        
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'Version configured.')
                        ...
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'Timers configured.')
                        ...
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'Authentication configured.')
                        ...
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'Group name configured.')
                        ...
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'Configured to follow group name ' + RGRother.get() + '.')
                        ...
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0"):
                            ...
                            sleep(0.3)        
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'GLBP weighting configured.')
                        ...
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'GLBP weight tracking configured.')
                        ...
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            ...
                            sleep(0.3)
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'GLBP forwarder preempt.')
                    else:
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            tkMessageBox.showinfo('ERROR', 'Please also enter the Protocol ID and the interface it is enabled on.')
                        else:
                            ...
                            sleep(0.3)
                            remote_conn.send("exit \n")
                            tkMessageBox.showinfo('Gateway Redundancy', 'GLBP load-balancing algorithm configured.')
                    ...
                    if RGRotheropt == "Preempt":
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            ...
                            sleep(0.3)
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'Preempt removed.')
                    elif RGRotheropt == "Priority":
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            tkMessageBox.showinfo('ERROR', 'Please also enter the Protocol ID and the interface it is enabled on.')
                        else:
                            ...
                            sleep(0.3)
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'Priority deleted.')
                    elif RGRotheropt == "Track interface":
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            tkMessageBox.showinfo('ERROR', 'Please also enter the Protocol ID and the interface it is enabled on.')
                        else:
                            ...
                            sleep(0.3)
                            remote_conn.send("exit \n")                  
                            tkMessageBox.showinfo('Gateway Redundancy', 'Interface tracking deleted.')
                    elif RGRotheropt == "Version(HSRP)":
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0"):
                            tkMessageBox.showinfo('ERROR', 'Please also enter the interface it is enabled on.')
                        else:
                            ...
                            sleep(0.3)        
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'Version reset to default (HSRPv1).')
                    elif RGRotheropt == "Timers":
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            tkMessageBox.showinfo('ERROR', 'Please also enter the Protocol ID and the interface it is enabled on.')
                        else:
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'Timers removed.')
                    elif RGRotheropt == "Authentication":
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            tkMessageBox.showinfo('ERROR', 'Please also enter the Protocol ID and the interface it is enabled on.')
                        else:
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'Authentication deleted.')
                    elif RGRotheropt == "Group name":
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            tkMessageBox.showinfo('ERROR', 'Please also enter the Protocol ID and the interface it is enabled on.')
                        else:
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'Group name deleted.')
                    elif RGRotheropt == "Follow group(HSRP)":
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            tkMessageBox.showinfo('ERROR', 'Please also enter the Protocol ID and the interface it is enabled on.')
                        else:
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'Follow group name deleted.')
                    elif RGRotheropt == "Weighting(GLBP)":
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0"):
                            tkMessageBox.showinfo('ERROR', 'Please also enter the interface it is enabled on.')
                        else:
                            ...
                            sleep(0.3)        
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'GLBP weighting reset.')
                    elif RGRotheropt == "Weighting track(GLBP)":
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            tkMessageBox.showinfo('ERROR', 'Please also enter the Protocol ID and the interface it is enabled on.')
                        else:
                            ...
                            sleep(0.3)                            
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'GLBP weight tracking reset.')
                    elif RGRotheropt == "Forwarder preempt(GLBP)":
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            tkMessageBox.showinfo('ERROR', 'Please also enter the Protocol ID and the interface it is enabled on.')
                        else:
                            ...
                            sleep(0.3)
                            remote_conn.send("exit \n")                            
                            tkMessageBox.showinfo('Gateway Redundancy', 'GLBP forwarder preempt disabled.')
                    else:
                        if (RGRiface.get() == "" or RGRiface.get() == "eg. fa0/0") or (RGRID.get() == "" or RGRID.get() == "v1: <0-255>, v2: <0-4095>"):
                            tkMessageBox.showinfo('ERROR', 'Please also enter the Protocol ID and the interface it is enabled on.')
                        else:
                            ...
                            sleep(0.3)
                            remote_conn.send("exit \n")
                            tkMessageBox.showinfo('Gateway Redundancy', 'GLBP load-balancing algorithm reset to default (round robin).')
        btn = Button(RGRframe, text="Apply", bg="orange", command=RGRoptional)
        ...
        def shHA():
            if showHAitem.get() == "Etherchannel":
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('High Availability', output)
    ...
    def QoS():
        ...
        def ratelimitclicked():
            if chk_state_neg.get() == False:
                ...
                tkMessageBox.showinfo('Rate Limit', res)
            else:
                remote_conn.send("conf t\n")
                sleep(0.5)
                remote_conn.send("int " + getiface.get() + "\n")
                ...
                tkMessageBox.showinfo('Rate Limit', res)                
        btn = Button(basicqosframe, text="Apply", bg="orange", command=ratelimitclicked)
        btn.grid(column=1, row=4)
        ...
        def CBWFQclicked():
            ...
            tkMessageBox.showinfo('CBWFQ', res)
        btn = Button(Advancedqosframe, text="Apply", bg="orange", command=CBWFQclicked)
        btn.grid(column=1, row=6)
        ...
        def LLQclicked():
            ...
            tkMessageBox.showinfo('LLQ', res)
        btn = Button(Advancedqosframe, text="Apply", bg="orange", command=LLQclicked)
        btn.grid(column=1, row=9)
    ...
    def security():
            ...
            if chk_state_neg.get() == False:
                if PolicyID.get() == "" or PolicyID.get() == "eg. 1" or pskentry.get() == "" or pskentry.get() == "password" or PeerIDentry.get() == "" or \
                   PeerIDentry.get() == "eg. 0.0.0.0, MyPeerID":
                    ...
                    tkMessageBox.showinfo('Error', 'Please choose Encryption, Hash snd DH Group option.')
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.2)
                    ...
                    sleep(0.2)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('IPSEC Phase 1', 'Phase 1 ISAKMP policy has been configured.')

            else:
                if PolicyID.get() == "" or PolicyID.get() == "eg. 1":
                    tkMessageBox.showinfo('Error', 'Please enter a PolicyID to delete it.')
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.2)
                    ...
                    sleep(0.2)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('IPSEC Phase 1', 'Phase 1 ISAKMP policy has been deleted.')
        btn = Button(ipsecframe, text="Apply", bg="orange", command=IPSECp1)
        ...
        def IPSECp2():
            if chk_state_neg.get() == False:
                if ipsecProfileName.get() == "" or ipsecProfileName.get():
                    tkMessageBox.showinfo('Error', 'Please enter an IPSEC Profile Name.')
                elif ipsec_transform_set.get() == "Transform-Set" or ipsec_mode.get() == "Mode":
                    tkMessageBox.showinfo('Error', 'Please choose Transform-Set snd Mode.')
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.2)
                    ...
                    sleep(0.2)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('IPSEC Phase 2', 'Phase 2 IPSEC policy has been configured. ' + res)

            else:
                if ipsecProfileName.get() == "" or ipsecProfileName.get() == "eg. 1":
                    tkMessageBox.showinfo('Error', 'Please enter a Profile Name.')
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.2)
                    if ipsec_transform_set.get() == "Transform-Set" and idlep2.get() == "" and idlep2.get() == "eg. 3600" and PFSp2.get() == "" and PFSp2.get() == "eg. group14" and \
                       lifep2.get() == "" and lifep2.get() == "eg. 3600s, 3days, 3MB":
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('IPSEC Phase 2', 'Phase 2 IPSEC policy has been deleted.')
                    else:
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('IPSEC Phase 2', res)
        btn = Button(ipsecframe, text="Apply", bg="orange", command=IPSECp2)
        ...
        def dmvpnclick():
            if dmvpntuniface.get() == "" or dmvpntuniface.get() == "eg. tun0":
                tkMessageBox.showinfo('Error', 'Please enter a tunnel interface to apply DMVPN configuration on.')
            else:
                if chk_state_neg.get() == False:
                    res = ""
                    remote_conn.send("conf t \n")
                    ...
                    sleep(0.2)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('DMVPN', 'DMVPN configured. ' + res)
                else:
                    res = ""
                    remote_conn.send("conf t \n")
                    sleep(0.2)
                    ...
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('DMVPN', 'DMVPN configured. ' + res)
        btn = Button(dmvpnframe, text="Apply", bg="orange", command=dmvpnclick)
        btn.place(x=417, y=0)
        ...
        def generatekey():
            if chk_state_neg.get() == False:
                ...
                sleep(0.2)
                remote_conn.send("exit \n")
                tkMessageBox.showinfo('Key Import/Export', 'Crypto key.')
        btn = Button(KeyMGMTframe, text="Apply", bg="orange", command=generatekey)
        btn.place(x=417, y=0)
        ...
        def createkchain():
            if keychainname.get() == "" or keychainname.get() == "keychain_name":
                tkMessageBox.showinfo('Error', 'Please enter keychain name.')
            else:
                res = ""
                if chk_state_neg.get() == False:
                    remote_conn.send("conf t \n")
                    ...
                    if (keynumber.get() == "" or keynumber.get() == "keynumber") and (keyvalue.get() == "" or keyvalue.get() == "eg. 00:00:00 Jun 13 2008 23:59:59 Sep 12 2008" or \
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Crypto key chain', 'Crypto keychain deleted.')
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Crypto key chain', 'Crypto keyID deleted from keychain.')
                    else:
                        remote_conn.send("conf t \n")
                        sleep(0.2)
                        remote_conn.send("key chain" + keychainname.get() + "\n")
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('Crypto key chain', 'Crypto keychain configured. ' + res)
        btn = Button(KeyMGMTframe, text="Apply", bg="orange", command=createkchain)
        ...
        def shcryptoclicked():
            if showcryptocmd.get() == "IPSEC SA (Phase2)":
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Crypto Phase2 SA', output)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('IPSEC policy', output) 
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('IPSEC profile', output) 
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('IPSEC traffic', output)                
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Crypto Phase1 SA', output)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Crypto ISAKMP policy', output)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Crypto ISAKMP profile', output)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Crypto session status', output)                
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('RSA keys', output)                
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Opened ports', output)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('DMVPN', output)
            else:
                buff_size = 16384
                sleep(0.5)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('NHRP', output)
        ...
        def helpipsec():
            res = '-- IPSEC --\n ' +\
                  ' EDIT.'
            tkMessageBox.showinfo('IPSEC help', res)
        ...
        def helpdmvpn():
            res = '-- DMVPN --\n ' +\
                  ' EDIT.'
            tkMessageBox.showinfo('DMVPN help', res)
    ...
    def CLI():
        ...
        def CLIclick():
            if getCLIinput.get() == "":
                tkMessageBox.showinfo('ERROR', 'Please enter command.')
            else:
                cmd = getCLIinput.get()
                buff_size = 16384
                sleep(0.5)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('CLI', output) 
        btn = Button(CLIframe, text="Apply", bg="orange", command=CLIclick)
    ...
    def debugg():
        ...
        def showdebug():
            if remote_conn.recv_ready():
                tkMessageBox.showinfo('Debug enabled', 'Debugging enabled. Syslog enabled locally. CTRL+C to stop.')
                remote_conn.send("conf t \n")
                sleep(0.2)
...
def defaultpage():
    ...
    Negateanyframe=LabelFrame(window,text=" Negate ",font=('verdana', 8, 'bold'),padx=30,pady=7,width=100,height=100)
    ...
    bifacemain=LabelFrame(window,text=" Interface (required for *, optional for **) ",font=('verdana', 8, 'bold'),padx=122,pady=10,width=100,height=100)
    ...
    biface=LabelFrame(window,text=" Interface Config ",font=('verdana', 8, 'bold'),padx=17,pady=0,width=100,height=100)
    biface.grid(row=1,column=0, sticky=("nsew"))


    chk_state_sec = BooleanVar()
    chk_state_sec.set(False)
    chk = Checkbutton(biface, text='Secondary IP', variable=chk_state_sec)
    chk.grid(column=2, row=2)

    chk_state_nosh = BooleanVar()
    chk_state_nosh.set(True)
    chk1 = Checkbutton(biface, text='Enable', variable=chk_state_nosh)
    chk1.grid(column=3, row=2)




    lbl = Label(biface, text="Set IP and mask:")
    lbl.grid(column=0, row=3)
    ipaddr = Entry(biface, bg='white', width=17, fg='grey')
    ipaddr.grid(column=1, row=3)
    ipaddr.insert(0, "IP. 'del' to delete.")
    def handle_focus_in(_):
    ...
    ipmask.insert(0, "Mask. 'del' to delete.")
    def handle_focus_in(_):
    ...
    tundst.insert(0, "Dst IP. 'del' to delete.")
    def handle_focus_in(_):
    ...
    def setinterfaceipclick():
        ...
        if getiface.get() == "" or getiface.get() == "e.g. fa0/0, fa0/0.2, vlan1, tun0, bvi1, po1 ..":
            tkMessageBox.showinfo('Error', 'Please choose an interface.')
        else:
            if ((ipaddr.get() != "" and ipaddr.get() != "IP. 'del' to delete.") and (ipmask.get() == "" or ipmask.get() == "Mask. 'del' to delete."))\
               or ((ipaddr.get() == "" or ipaddr.get() == "IP. 'del' to delete.") and (ipmask.get() != "" and ipmask.get() != "Mask. 'del' to delete.")):
                tkMessageBox.showinfo('IP configuration error', 'Please enter both IP and Mask to configure IP.')
            elif chk_state_neg.get() == False and (getiface.get()[:2] == "tu") and ((tunsrc.get() != "" and tunsrc.get() != "Src IP. 'del' to delete.") or\
                 (tundst.get() != "" and tundst.get() != "Dst IP. 'del' to delete.")) and tunmode.get() == 'Mode':
                tkMessageBox.showinfo('Error', 'Please select a tunnel mode before adding tunnel IP.')
            elif chk_state_neg.get() == False and (ipaddr.get() == "del" or ipmask.get() == "del" or tunsrc.get() == "del" or tundst.get() == "del"):
                tkMessageBox.showinfo('Error', 'Select Negate to specify "del" for deletion of IP addresses.')
            else:
                if chk_state_neg.get() == False:
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    if "bvi" in getiface.get():
                        ...
                        bridgetxt = "An IRB Bridge has been created - with spanning tree enabled and routing capability. "      
                    else:
                        pass
                    remote_conn.send("int " + getiface.get() + "\n")
                    sleep(0.3)
                    tuntxt = ""
                    if (getiface.get()[:2] == "tu") and ((tunsrc.get() != "" and tunsrc.get() != "Src IP. 'del' to delete.") or\
                                                         (tundst.get() != "" and tundst.get() != "Dst IP. 'del' to delete.")):
                        ...
                        sleep(0.3)
                        tuntxt = "Tunnel IP configured - do not forget to add a route to push traffic through this tunnel. "                           
                    else:
                        pass
                    ...
                    if chk_state_sec.get() == True:
                        ...
                        if (ipaddr.get() != "" and ipaddr.get() != "IP. 'del' to delete.") and (ipmask.get() != "" and \
                            ipmask.get() != "Mask. 'del' to delete."):
                    ...
                    sleep(0.2)
                    remote_conn.send("exit \n") 
                    tkMessageBox.showinfo('IP configuration', IPtxt + sectxt + Shutstatetxt + tuntxt + bridgetxt)


                else:
                    if getiface.get()[:2] == "tu" and (ipaddr.get() == "" or ipaddr.get() == "IP. 'del' to delete.") and (ipmask.get() == "" or ipmask.get() == "Mask. 'del' to delete.") \
                       and (tunsrc.get() == "" or tunsrc.get() == "Src IP. 'del' to delete.") and (tundst.get() == "" or tundst.get() == "Dst IP. 'del' to delete."):
                        remote_conn.send("conf t \n")
                        sleep(0.3)
                        remote_conn.send("no int " + getiface.get() + "\n")
                        sleep(0.3)
                        tkMessageBox.showinfo('IP configuration', 'Tunnel deleted.')
                    else:
                        remote_conn.send("conf t \n")
                        sleep(0.3)
                        remote_conn.send("int " + getiface.get() + "\n")
                        ...
                        if (getiface.get()[:2] == "tu") and ((tunsrc.get() != "" and tunsrc.get() != "Src IP. 'del' to delete.") or\
                            ...
                            if tunsrc.get() == "del":
                                ...
                                sleep(0.3)
                                tuntxt = tuntxt + "Tunnel source IP removed. "
                            else:
                                pass
                            if tundst.get() == "del":
                                remote_conn.send("no tun dest \n")
                                sleep(0.3)
                                tuntxt = tuntxt + "Tunnel destination IP removed. "
                            else:
                                pass
                        ...
                        if ipaddr.get() == "del" and ipmask.get() == "del":
                            remote_conn.send("no " + ipaddrcmd + "\n")
                            IPtxt = "IP address removed. "
                        else:
                            pass
                        ...
                        sleep(0.2)
                        remote_conn.send("exit \n") 
                        tkMessageBox.showinfo('IP configuration', IPtxt + sectxt + Shutstatetxt + tuntxt)
            
    btn = Button(biface, text="*Apply", bg="orange", command=setinterfaceipclick)
    ...
    lbl = Label(biface, text="Speed & duplex:").grid(column=0, row=6)
    OPTIONS = [
    "auto",        
    "10",        
    "100",
    ...
    def setspeedduplex():
        if getiface.get() == "" or getiface.get() == "e.g. fa0/0, fa0/0.2, vlan1, tun0, bvi1, po1 ..":
            ...
            sleep(0.5)
            remote_conn.send("exit \n")
            res = "Speed set to " + spd.get() + " and duplex " + dup.get() + " on " + getiface.get()
            tkMessageBox.showinfo('Speed & Duplex', res)
    btn = Button(biface, text="*Apply", bg="orange", command=setspeedduplex)
    btn.grid(column=3, row=6)        

    blankdivider = Label(biface, text="").grid(column=0, row=8)
    
    lbl = Label(biface, text="Other settings:").grid(column=0, row=9)
            ...
            if chk_state_neg.get() == False:
                ...
                if otheroptn.get() == 'MAC address':
                    if otherinput.get() != "" and otherinput.get() != "xxxx.xxxx.xxxx":
                        ...
                        sleep(0.5)       
                        tkMessageBox.showinfo('Other interface settings', 'Interface MAC address configured.')
                    else:
                        tkMessageBox.showinfo('Error', 'Error - Please enter a MAC address to configure on the interface.')
                elif otheroptn.get() == 'dot1q':
                    if "." not in getiface.get():
                        tkMessageBox.showinfo('Error', 'Error - Dot1q encapsulation can only be applied to a Subinterface.')
                    elif otherinput.get() == "":
                        tkMessageBox.showinfo('Error', 'Error - Please enter a VLAN ID to apply on the Subinterface.')
                    else:
                        sleep(0.5)
                        remote_conn.send("encap dot1Q " + otherinput.get() + "\n")
                        sleep(0.5)
                        tkMessageBox.showinfo('Other interface settings', 'Dot1q configured.')
                elif otheroptn.get() == 'VRF':
                    buff_size = 16384
                    sleep(0.5)
                    remote_conn.send("show ip vrf \n")
                    sleep(3)        
                    while not remote_conn.recv_ready():
                        remote_conn.recv(0)
                        buff_size += 2048
                    ...
                    output = remote_conn.recv(buff_size).decode("utf-8")
                    if otherinput.get() == "":
                        tkMessageBox.showinfo('Error', 'Error - Please enter a VRF to apply on the interface.')
                    elif otherinput.get() not in output:
                        tkMessageBox.showinfo('Error', 'Error - Please create the VRF first (in Route page) before applying it.')
                    else:
                        sleep(0.5)
                        remote_conn.send("ip vrf forwarding " + otherinput.get() + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('Other interface settings', 'VRF configured if it has already been created.')
                elif otheroptn.get() == 'DHCP Client':
                    sleep(0.5)
                    remote_conn.send("ip addr dhcp \n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('Other interface settings', 'Configured as DHCP client. ANY EXISTING IP ADDRESS HAS BEEN REMOVED.')
                elif otheroptn.get() == 'IP MTU(L3)':
                    if otherinput.get() != "" and otherinput.get() != "eg. 1400" and (68 <= int(otherinput.get()) <= 1500):
                        sleep(0.5)
                        remote_conn.send("ip mtu " + otherinput.get() + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('Other interface settings', 'Configured interface packet MTU.')
                    else:
                        tkMessageBox.showinfo('Error', 'Error - Please enter an MTU (68-1500) value to apply on the interface.')
                elif otheroptn.get() == 'MTU(L2)':
                    if otherinput.get() != "" and otherinput.get() != "eg. 1500" and (68 <= int(otherinput.get()) <= 1500):
                        sleep(0.5)
                        remote_conn.send("mtu " + otherinput.get() + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('Other interface settings', 'Configured interface frame MTU.')
                    else:
                        tkMessageBox.showinfo('Error', 'Error - Please enter an MTU (1500-1530) value to apply on the interface.')                    
                elif otheroptn.get() == 'TCP MSS(L4)':
                    if otherinput.get() != "" and otherinput.get() != "eg. 1360" and (500 <= int(otherinput.get()) <= 1460):
                        ...
                        sleep(0.5)       
                        tkMessageBox.showinfo('Other interface settings', 'Configured MSS.')
                    else:
                        tkMessageBox.showinfo('Error', 'Error - Please enter an MSS value (500-1460) to apply on the interface.')
                elif otheroptn.get() == 'VFR':
                    sleep(0.5)
                    remote_conn.send("ip virtual-reassembly \n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('Other interface settings', 'Enabled IP Virtual Reassembly for fragmented packets.')
                elif otheroptn.get() == 'Add to bridge':
                    sleep(0.5)
                    remote_conn.send("int " + getiface.get() + " \n")
                    sleep(0.5)
                    remote_conn.send("bridge-group " + otherinput.get() + "\n")
                    tkMessageBox.showinfo('Other interface settings', getiface.get() + ' has been added to bridge group ' + otherinput.get())
                elif otheroptn.get() == 'tun key':
                    if getiface.get()[:2] != 'tu': 
                        tkMessageBox.showinfo('Error', 'Error - Tunnel key can only be applied to tunnel interfaces (e.g. tun0).')
                    elif otherinput.get() == "" or otherinput.get() == "eg. 1":
                        tkMessageBox.showinfo('Error', 'Error - Please enter a tunnel key value to apply on the interface.')
                    else:
                        remote_conn.send("tun key " + otherinput.get() + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('Other interface settings', 'Tunnel key configured.')                
                elif otheroptn.get() == 'tun kpalive':
                    if getiface.get()[:2] != 'tu':
                        tkMessageBox.showinfo('Error', 'Error - keepalives are only applicable for tunnel interfaces (e.g. tun0).')
                    elif otherinput.get() == "" or otherinput.get() == "<secs> [<retries>]":
                        tkMessageBox.showinfo('Error', 'Error - Please enter a tunnel keepalive value to apply on the interface.')
                    else:                    
                        remote_conn.send("keepalive " + otherinput.get() + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('Other interface settings', 'Tunnel keepalive configured.')
                elif otheroptn.get() == 'IPSEC profile':
                    if getiface.get()[:2] != 'tu':
                        tkMessageBox.showinfo('Error', 'Error - please apply IPSEC profile to a tunnel interface (e.g. tun0).')
                    elif otherinput.get() == "" or otherinput.get() == "<IPSec_prof_name>":
                        tkMessageBox.showinfo('Error', 'Error - Please enter an IPSEC profile to apply on the interface.')
                    else:                    
                        remote_conn.send("tunnel protection ipsec profile " + otherinput.get() + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('Other interface settings', 'Tunnel IPSEC profile configured.')                    
                else:
                    remote_conn.send(otheroptn.get() + " " + otherinput.get() + "\n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('Other interface settings', 'ARP timeout configured.')
            else:
                remote_conn.send("conf t \n")
                sleep(0.5)
                remote_conn.send("int " + getiface.get() + "\n")            
                if otheroptn.get() == 'MAC address':
                    ...
                    sleep(0.5)
                    tkMessageBox.showinfo('Other interface settings', 'Interface MAC address reset to BIA.')
                elif otheroptn.get() == 'dot1q':
                    if "." not in getiface.get():
                        tkMessageBox.showinfo('Error', 'Error - Not a subinterface.')
                    else:
                        sleep(0.5)
                        remote_conn.send("no encap dot1Q \n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('Other interface settings', 'Dot1q removed.')
                elif otheroptn.get() == 'VRF':
                    sleep(0.5)
                    remote_conn.send("no ip vrf forwarding \n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('Other interface settings', 'VRF removed.')
                elif otheroptn.get() == 'DHCP Client':
                    sleep(0.5)
                    remote_conn.send("no ip addr dhcp \n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('Other interface settings', 'Deconfigured as DHCP client.')
                elif otheroptn.get() == 'IP MTU(L3)':
                    sleep(0.5)
                    remote_conn.send("no ip mtu \n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('Other interface settings', 'Interface packet MTU reset to default max (1500B).')
                elif otheroptn.get() == 'MTU(L2)':
                    sleep(0.5)
                    remote_conn.send("no mtu \n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('Other interface settings', 'Interface frame MTU reset to default max (1500B).')                
                elif otheroptn.get() == 'TCP MSS(L4)':
                    sleep(0.5)
                    remote_conn.send("no ip tcp adjust-mss \n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('Other interface settings', 'Interface MSS reset to default max (1460B).')
                elif otheroptn.get() == 'VFR':
                    sleep(0.5)
                    remote_conn.send("no ip virtual-reassembly \n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('Other interface settings', 'Disabled IP Virtual Reassembly for fragmented packets.')
                elif otheroptn.get() == 'Add to bridge':
                    sleep(0.5)
                    remote_conn.send("int " + getiface.get() + " \n")
                    sleep(0.5)
                    remote_conn.send("no bridge-group " + otherinput.get() + "\n")
                    tkMessageBox.showinfo('Other interface settings', getiface.get() + ' has been removed from bridge group ' + otherinput.get())
                elif otheroptn.get() == 'tun key':
                    if getiface.get()[:2] != 'tu': 
                        tkMessageBox.showinfo('Error', 'Error - Not a tunnel interface.')
                    else:
                        remote_conn.send("no tun key \n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('Other interface settings', 'Tunnel key removed.')                
                elif otheroptn.get() == 'tun kpalive':
                    if getiface.get()[:2] != 'tu':
                        tkMessageBox.showinfo('Error', 'Error - Not a tunnel interface.')
                    else:                    
                        ...
                        sleep(0.5)       
                        tkMessageBox.showinfo('Other interface settings', 'Tunnel keepalive removed.')
                elif otheroptn.get() == 'IPSEC profile':
                    if getiface.get()[:2] != 'tu':
                        tkMessageBox.showinfo('Error', 'Error - please specify a tunnel interface (e.g. tun0).')
                    elif otherinput.get() == "":
                        tkMessageBox.showinfo('Error', 'Error - Please enter an IPSEC profile to remove from the interface.')
                    else:                    
                        remote_conn.send("no tunnel protection ipsec profile " + otherinput.get() + "\n")
                        sleep(0.5)       
                        tkMessageBox.showinfo('Other interface settings', 'Tunnel IPSEC profile removed.') 
                else:
                    sleep(0.5)
                    remote_conn.send("no " + otheroptn.get() + " " + otherinput.get() + "\n")
                    sleep(0.5)       
                    tkMessageBox.showinfo('Other interface settings', 'ARP timeout reset to default (4 hour).')
            remote_conn.send("exit \n")
            sleep(0.5)
            remote_conn.send("exit \n")                
    btn = Button(biface, text="*Apply", bg="orange", command=setotherconf)
    ...
    def helpotherconf():
        res = 'VFR (Virtual Fragmentation Reassembly) - Able' +\
              ' to detect and prevent a range of fragment attacks. \n\nDot1q - An encapsulation used for Trunking, Router on a Stick, etc.' +\
              ' Valid values: 1-4094. Only configure it on subinterfaces. Any packets destined to the physical interface IP address (if any configured)' +\
              ' will be blackholed.' +\
              '\n\nVRF - works like a layer 3 VLAN. It MUST be created (in Route tab) first before it can be applied.\n\n' +\
              'Secondary IP - You can configure multiple secondary IPs on an interface. If there is no primary IP configured, the secondary IP will ' +\
              'remain inactive and hidden only until a primary IP has been configured.' +\
              '\n\nTo bridge router ports, \n 1. Create Bridge Group,\n 2. Create bvi interface\n 3. Other settings > "Add to bridge"'
        tkMessageBox.showinfo('Other interface settings help', res)
    btn = Button(biface, text="Help", bg="yellow", command=helpotherconf)
    ...
    deviceconfframe=LabelFrame(window,text=" Device Config ",font=('verdana', 8, 'bold'),padx=10,pady=8,width=100,height=100)
    deviceconfframe.grid(row=4,column=0, sticky=("nsew"))

    label = Label(deviceconfframe, text="Create static ARP entry: ").grid(column=0, row=1)
    ...
    btn = Button(deviceconfframe, text="Apply", font=('helvetica', 8), bg="orange", command=setarp)
    btn.grid(column=3, row=1, padx=13)

    label = Label(deviceconfframe, text="Create static MAC entry: ").grid(column=0, row=2)
    ...
    getstvlan.insert(0, "optional VLAN")
    def handle_focus_in(_):
    ...
    def setmac():
        if getiface.get() == '' or getiface.get() == 'e.g. fa0/0, fa0/0.2, vlan1, tun0, bvi1, po1 ..':
            ...
            sleep(0.5)
            if chk_state_neg.get() == False:
                if getstvlan.get() == '' or getstvlan.get() == 'optional VLAN no.':
                    remote_conn.send("mac-address-table static " + getstmac.get() + " interface " + getiface.get() + " \n")
                    sleep(0.5)
                    remote_conn.send("exit \n")
                    sleep(0.5)
                    tkMessageBox.showinfo('MAC', 'Static MAC configured. Packets toward dst ' + getstmac.get() + ' will be forwarded to ' + getiface.get())
                else:
                    remote_conn.send("mac-address-table static " + getstmac.get() + " interface " + getiface.get() + " vlan " + getstvlan.get() + " \n")
                    sleep(0.5)
                    remote_conn.send("exit \n")
                    sleep(0.5)
                    tkMessageBox.showinfo('MAC', 'Static MAC configured. Packets in VLAN ' + getstvlan.get() +  ' toward dst ' + getstmac.get() + \
                                          ' will be forwarded to ' + getiface.get())
            else:
                if getstvlan.get() == '' or getstvlan.get() == 'optional VLAN no.':
                    ...
                    remote_conn.send("exit \n")
                    sleep(0.5)
                    tkMessageBox.showinfo('MAC', 'Static MAC removed.')
                else:
                    ...
                    sleep(0.5)
                    tkMessageBox.showinfo('MAC', 'Static MAC removed.')        
    btn = Button(deviceconfframe, text="*Apply", font=('helvetica', 8), bg="orange", command=setmac)
    btn.grid(column=3, row=2, padx=13, pady=2) 


    def option_changed_arpmacopt(*args):
        if arpmacopt.get() == "Clear ARP (all)" or arpmacopt.get() == "Clear MAC (all)":
            text = 'NoInputRequired'
        ...
        elif arpmacopt.get() == "Clear ARP (int)" or arpmacopt.get() == "Clear MAC (int)":
            text = 'eg. fa0/0'
            getmacarp.delete(0, END)
            getmacarp.config(fg='grey')
            getmacarp.insert(0, text)
            ...
            getmacarp.bind("<FocusOut>", handle_focus_out)
            getmacarp.bind("<FocusIn>", handle_focus_in)
        elif arpmacopt.get() == "Clear ARP (ip)":
            text = 'eg. 1.2.3.4'
            getmacarp.delete(0, END)
            getmacarp.config(fg='grey')
            getmacarp.insert(0, text)
            ...
            getmacarp.bind("<FocusOut>", handle_focus_out)
            getmacarp.bind("<FocusIn>", handle_focus_in)
        elif arpmacopt.get() == "Clear MAC (addr)":
            text = 'xxxx.xxxx.xxxx'
            getmacarp.delete(0, END)
            getmacarp.config(fg='grey')
            getmacarp.insert(0, text)
            ...
            getmacarp.bind("<FocusOut>", handle_focus_out)
            getmacarp.bind("<FocusIn>", handle_focus_in)
        elif arpmacopt.get() == "Clear MAC (vlan)":
            text = '<1-4094>'
            getmacarp.delete(0, END)
            getmacarp.config(fg='grey')
            getmacarp.insert(0, text)
    ...
    getmacarp = Entry(deviceconfframe, bg='white', width=15, fg='grey')
    getmacarp.grid(column=1, row=4, columnspan=2)
    getmacarp.insert(0, "NoInputRequired")
    def handle_focus_in(_):
        if getmacarp.cget('fg') != 'black':
            getmacarp.delete(0, END)
            getmacarp.config(fg='black')
    ...
    def arpmacclearset():
        if arpmacopt.get() == "Clear ARP (all)":
            remote_conn.send("clear arp \n")
            sleep(0.5)
            tkMessageBox.showinfo('ARP Table', 'All ARP table entries has been cleared.')
        elif arpmacopt.get() == "Clear ARP (ip)":
            if getmacarp.get() != "" and ("." in getmacarp.get()):
                remote_conn.send("clear ip arp " + getmacarp.get() + "\n")
                sleep(0.5)
                tkMessageBox.showinfo('ARP Table', 'ARP table entries has been cleared with IP attribute specified.')
            else:
                tkMessageBox.showinfo('Error', 'Error - Please enter an IP address to clear the associated ARP entry.')
        elif arpmacopt.get() == "Clear ARP (int)":
            ...
            ("tun" in getmacarp.get()) or ("lo" in getmacarp.get())):
                ...
                sleep(0.5)
                tkMessageBox.showinfo('ARP Table', 'ARP table entries has been cleared with interface attribute specified.')
            else:
                tkMessageBox.showinfo('Error', 'Error - Please enter an interface (ONLY fa/gi/te/tun/lo/bvi) to clear the associated ARP entry.')
        elif arpmacopt.get() == "Clear MAC (all)":
                remote_conn.send("clear mac-address-table \n")
                sleep(0.5)
                tkMessageBox.showinfo('MAC Table', 'All MAC address table entries has been cleared.')
        elif arpmacopt.get() == "Clear MAC (vlan)":
            if getmacarp.get() != "" and getmacarp.get().isdigit() == True:
                remote_conn.send("clear mac-address-table vlan " + getmacarp.get() + " \n")
                sleep(0.5)
                tkMessageBox.showinfo('MAC Table', 'All MAC address table entries has been cleared for VLAN ' + getmacarp.get() + '.')
            else:
                tkMessageBox.showinfo('Error', 'Error - Please enter a VLAN ID to clear the associated MAC address entry.')
        elif arpmacopt.get() == "Clear MAC (addr)":
            if getmacarp.get() != "" and ("." in getmacarp.get()):
                remote_conn.send("clear mac-address-table address " + getmacarp.get() + " \n")
                sleep(0.5)
                tkMessageBox.showinfo('MAC Table', 'MAC address table entry has been cleared.')
            else:
                tkMessageBox.showinfo('Error', 'Error - Please enter a MAC Address (XXXX.XXXX.XXXX) to clear the associated MAC address entry.')
        elif arpmacopt.get() == "Clear MAC (int)":
            if getmacarp.get() != "":
                remote_conn.send("clear mac-address-table int " + getmacarp.get() + " \n")
                sleep(0.5)
                tkMessageBox.showinfo('MAC Table', 'MAC address table entries has been cleared for interface ' + getmacarp.get() + '.')
            else:
                tkMessageBox.showinfo('Error', 'Error - Please enter an interface (ONLY fa/gi/te/tun/lo/bvi) to clear the associated MAC address entry.')
        else:
            if chk_state_neg.get() == False:
                if getmacarp.get() != "" and getmacarp.get().isdigit() == True and (getmacarp.get() <= 1000000):
                    ...
                    tkMessageBox.showinfo('MAC Table', 'MAC address table aging time has been configured.')
                else:
                    tkMessageBox.showinfo('Error', 'Error - Please enter a valid numeric MAC address aging time.')
            else:
                remote_conn.send("no mac-address-table aging \n")
                sleep(0.5)
                tkMessageBox.showinfo('MAC Table', 'MAC address table aging time has been reset.')
    btn = Button(deviceconfframe, text="Apply", font=('helvetica', 8), bg="orange", command=arpmacclearset)
    ...
    def option_changed_TCPtune(*args):
        if TCPtuneopt.get() == "PMTUD":
            ...
            getTCPtune.bind("<FocusOut>", handle_focus_out)
            getTCPtune.bind("<FocusIn>", handle_focus_in) 
        elif TCPtuneopt.get() == "Enable ECN" or TCPtuneopt.get() == "Enable Selective-ACK" or TCPtuneopt.get() == "Enable TCP timestamp":
            text = 'NoInputRequired'
            getTCPtune.delete(0, END)
            getTCPtune.config(fg='grey')
            getTCPtune.insert(0, text)
    ...
    getTCPtune = Entry(deviceconfframe, width=15)
    getTCPtune.grid(column=1, row=5, pady=5, columnspan=2)


    def TCPtune():
        if TCPtuneopt.get() == "TCP Tuning":
            tkMessageBox.showinfo('Error', 'Error - Please choose an option.')
        else:
            if chk_state_neg.get() == False:
                if TCPtuneopt.get() == "PMTUD":
                    remote_conn.send("conf t \n")
                    ...
                    if getTCPtune.get() != "" and getTCPtune.get() != "[<2-20> (mins)]":
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('TCP', 'PMTUD configured with MTU recalibration every ' + getTCPtune.get() + ' mins.')
                    else:
                        remote_conn.send("ip tcp path-mtu-discovery \n")
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('TCP', 'PMTUD configured.')                 
                elif TCPtuneopt.get() == "TCP egress queue":
                    if getTCPtune.get() != "" and getTCPtune.get() != "eg. 5 (segments)":
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('TCP', 'TCP egress queue configured.')
                    else:
                        tkMessageBox.showinfo('Error', 'Error - Please enter a value.')                    
                elif TCPtuneopt.get() == "SYNWAIT-time":
                    if getTCPtune.get() != "" and getTCPtune.get() != "eg. 30 (secs)":
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('TCP', 'TCP SYNWAIT-time configured.')
                    else:
                        tkMessageBox.showinfo('Error', 'Error - Please enter a value.') 
                elif TCPtuneopt.get() == "TCP window-size":
                    if getTCPtune.get() != "" and getTCPtune.get() != "eg. 65535": 
                        ...
                        sleep(0.3)
                        remote_conn.send("exit \n")
                        tkMessageBox.showinfo('TCP', 'TCP window-size configured.')
                    else:
                        tkMessageBox.showinfo('Error', 'Error - Please enter a value.') 
                elif TCPtuneopt.get() == "Enable ECN":
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                ...
                elif TCPtuneopt.get() == "Enable Selective-ACK":
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    remote_conn.send("ip tcp selective-ack \n")
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('TCP', 'TCP Selective-ACK(SACK) configured.')
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('TCP', 'TCP timestamp configured.')
            else:
                if TCPtuneopt.get() == "PMTUD":
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('TCP', 'TCP PMTUD disabled.') 
                elif TCPtuneopt.get() == "TCP egress queue":
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('TCP', 'TCP egress-queue-max reset to default.') 
                elif TCPtuneopt.get() == "SYNWAIT-time":
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('TCP', 'TCP SYNWAIT-time reset to default.') 
                elif TCPtuneopt.get() == "TCP window-size":
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('TCP', 'TCP window-size reset to default.') 
                elif TCPtuneopt.get() == "Enable ECN":
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('TCP', 'TCP Explicit Congestion Notification feature disabled.') 
                elif TCPtuneopt.get() == "Enable Selective-ACK":
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    ...
                    sleep(0.3)
                    remote_conn.send("exit \n")
                    tkMessageBox.showinfo('TCP', 'TCP Selective-ACK feature disabled.')
                else:
                    remote_conn.send("conf t \n")
                    sleep(0.3)
                    remote_conn.send("ip tcp timestamp \n")
                    sleep(0.3)
                    remote_conn.send("exit \n")                
                tkMessageBox.showinfo('TCP', 'TCP timestamp feature disabled.')
    btn = Button(deviceconfframe, text="Apply", font=('helvetica', 8), bg="orange", command=TCPtune)
    ...
    chk = Checkbutton(deviceconfframe, text="MAC learning", font=("TkDefaultFont", 8), variable=chk_MAClearn)
    chk.grid(column=1, row=6, sticky='e', columnspan=2, pady=(15,0))
    


    def option_changed_bridgefilter(*args):
        if bridgefilter.get() == "Optional":
            text = ''
    ...
    def createbridgeG():
        if createbridge.get() == "" or createbridge.get() == "eg. 5":
            tkMessageBox.showinfo('ERROR', 'Please enter bridge group number.')
        else:
            if chk_state_neg.get() == False: 
                remote_conn.send("conf t \n")
                sleep(0.3)
                ...
                if chk_MAClearn.get() == False:
                    ...
                    res = 'MAC learning is disabled. '
                else:
                    remote_conn.send("bridge " + createbridge.get() + " acquire \n")
                    res = 'MAC learning is enabled. '
                sleep(0.3)
                tkMessageBox.showinfo('Bridge config', 'Bridge has been created. ' + res)
            else:
                remote_conn.send("conf t \n")
                sleep(0.3)
    ...
    btn = Button(deviceconfframe, text="Apply", font=('helvetica', 8), bg="orange", command=createbridgeG)
    btn.grid(row=6, column=3, pady=(15,0)) 

    def bridgeGOpt():
        if createbridge.get() == "" or createbridge.get() == "eg. 5":
            tkMessageBox.showinfo('ERROR', 'Please enter bridge group number.')
        elif bridgefilter.get() == "Optional":
            tkMessageBox.showinfo('ERROR', 'Please choose an option.')
        else:
            if chk_state_neg.get() == False:
                remote_conn.send("conf t \n")
    ...
    showconfframe=LabelFrame(window,text=" Show Config ",font=('verdana', 8, 'bold'),padx=50,pady=8,width=100,height=100)
    ...
    def showintconf():
        if showintopt.get() == "Interface stats":
            if getiface.get() == '' or getiface.get() == 'e.g. fa0/0, fa0/0.2, vlan1, tun0, bvi1, po1 ..':
                tkMessageBox.showinfo('Error', 'Enter an interface above first.')
            else:
                buff_size = 16384
                sleep(0.5)
                ...
                while not remote_conn.recv_ready():
                    ...
                    sleep(0.5)
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Current interface configuration', output)
        elif showintopt.get() == "Interface config":
            if getiface.get() == '' or getiface.get() == 'e.g. fa0/0, fa0/0.2, vlan1, tun0, bvi1, po1 ..':
                tkMessageBox.showinfo('Error', 'Enter an interface above first.')
            else:
                rep = getiface.get()
                ...
                output = remote_conn.recv(buff_size).decode("utf-8")
                tkMessageBox.showinfo('Current interface configuration', output)
        elif showintopt.get() == "L3 Interface stats":
            if getiface.get() == '' or getiface.get() == 'e.g. fa0/0, fa0/0.2, vlan1, tun0, bvi1, po1 ..':
                tkMessageBox.showinfo('Error', 'Enter an interface above first.')
            else:
                buff_size = 16384
            ...
            output = remote_conn.recv(buff_size).decode("utf-8")
            tkMessageBox.showinfo('Current interface configuration', output)        
    btn = Button(showconfframe, text="Show", bg="orange", command=showintconf)
    btn.place(x=300, y=0)
    ...
    def showintconf2():
        if showintopt2.get() == "MAC table":
            ...
            output = remote_conn.recv(buff_size).decode("utf-8")
            tkMessageBox.showinfo('Current interface configuration', output)
        elif showintopt2.get() == "MAC table (totals)":
            buff_size = 16384
            sleep(0.5)
            ...
            output = remote_conn.recv(buff_size).decode("utf-8")
            tkMessageBox.showinfo('Current interface configuration', output)
        elif showintopt2.get() == "ARP table":
            buff_size = 16384
            sleep(0.5)
            ...
            if showintopt2.get() == "Hardware Status":
                cmd = "show env \n"
            elif showintopt2.get() == "Hardware Status (detail)":
                cmd = "show env all \n"                
            elif showintopt2.get() == "Hardware Info":
                cmd = "show inv \n"
            elif showintopt2.get() == "Buffer Status":
                cmd = "show buff \n"
            elif showintopt2.get() == "Time":
                cmd = "show clock \n"
            elif showintopt2.get() == "Uptime":
                cmd = "show ver | i uptime | returned | restarted \n"
            elif showintopt2.get() == "Version":
                cmd = "show ver | s IOS \n"
            elif showintopt2.get() == "CPU":
                cmd = "show proc cpu hist \n"
            elif showintopt2.get() == "Memory":
                cmd = "show proc mem \n"
            elif showintopt2.get() == "Dup/Spd (Configured)":
                cmd = "show run | i interface | duplex | speed \n"
            elif showintopt2.get() == "Dup/Spd (Effective)":
                cmd = "show int | i dup| up \n"                
            elif showintopt2.get() == "TCP connections":
                cmd = "show tcp brief nume \n"
            elif showintopt2.get() == "TCP stats":
                cmd = "show tcp stat \n"
            elif showintopt2.get() == "Listening ports":
                cmd = "show control-plane host open-p \n"
            elif showintopt2.get() == "Bridge":
                cmd = "show bridge \n"
            else:
                cmd = "show udp \n"
            buff_size = 16384
            ...
            output = remote_conn.recv(buff_size).decode("utf-8")
            tkMessageBox.showinfo('Current interface configuration', output)      
    btn = Button(showconfframe, text="Show", bg="orange", command=showintconf2)
